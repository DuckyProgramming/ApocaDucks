class wall{
        ...
        switch(this.type){
            case 1: case 2:
                switch(game.level){
                    ...
                    break
                    case 108: case 109: case 112:
                        this.balls=[[],[]]
                        for(let a=0,la=(this.width-10)*(this.height-10)/600;a<la;a++){
                            this.balls[0].push([-this.width/2+(a*0.205%1)*(this.width-10)+5,random(-this.height/2+5,this.height/2-5),random(15,45),random(0,1),random(0,360),5])
                        }
                    break
                }
            ...
            case 77: case 79: case 80: case 81: case 123:
                ...
                }else if(this.type==50||this.type==61||this.type==69||this.type==72||this.type==81){
            ...
            case 17: case 44:
                switch(game.level){
                    ...
                    case 108: case 109: case 112:
                        ...
                        for(let a=0,la=(this.width-10)*(this.height-10)/1200;a<la;a++){
                            let pos=(a*0.205%1)
                            this.balls[0].push([-this.width/2+pos*(this.width-10)+5,random(-this.height/2+5+(this.height-10)*pos,this.height/2-5),random(15,45),random(0,1),random(0,360),5])
                        }
                    break
                }
            break
            case 18: case 45:
                switch(game.level){
                    ...
                    case 108: case 109: case 112:
                        ...
                        for(let a=0,la=(this.width-10)*(this.height-10)/1200;a<la;a++){
                            let pos=(a*0.205%1)
                            this.balls[0].push([-this.width/2+pos*(this.width-10)+5,random(-this.height/2+5+(this.height-10)*(1-pos),this.height/2-5),random(15,45),random(0,1),random(0,360),5])
                        }
                    break
                }
            break
            case 20: case 46:
                switch(game.level){
                    ...
                    case 108: case 109: case 112:
                        ...
                        for(let a=0,la=(this.width-10)*(this.height-10)/1200;a<la;a++){
                            let pos=(a*0.205%1)
                            this.balls[0].push([-this.width/2+pos*(this.width-10)+5,random(-this.height/2+5,-this.height/2+5+(this.height-10)*(1-pos)),random(15,45),random(0,1),random(0,360),5])
                        }
                    break
                }
            break
            case 21: case 47:
                switch(game.level){
                    ...
                    case 108: case 109: case 112:
                        ...
                        for(let a=0,la=(this.width-10)*(this.height-10)/1200;a<la;a++){
                            let pos=(a*0.205%1)
                            this.balls[0].push([-this.width/2+pos*(this.width-10)+5,random(-this.height/2+5,-this.height/2+5+(this.height-10)*pos),random(15,45),random(0,1),random(0,360),5])
                        }
                    break
                }
            break
            case 24:
                switch(game.level){
                    ...
                    case 72: case 81:
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*6+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    this.balls.push([
                                        ...
                                        random(8,12),random(0,1),random(0,360),floor(random(5,11))])
                                }
                            }
                        }
                    break
            ...
            case 25:
                switch(game.level){
                    case 104: case 105: case 110:
                        this.balls=[]
                        list=[1,4,5]
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                for(let d=0,ld=2;d<ld;d++){
                                    let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*4+random(-0.5,0.5)
                                    for(let c=0,lc=round(len)-d;c<lc;c++){
                                        let pos=(random(0.225,0.75)+c+d/2)/lc
                                        this.balls.push([
                                            map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-4,0):list[a]==3?random(0,4):0),
                                            map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y-(list[a]!=2&&list[a]!=3?random(0,6):0),
                                            random(8,10),random(0,1),random(-30,30),random(1,2)])
                                    }
                                }
                            }
                        }
            ...
            case 28:
                switch(game.level){
                    ...
                    break
                    case 114:
                        this.pause=random(0,360)
                    break
                }
            break
            case 31:
                this.owner=game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:
                    game.level==27&&game.pvp?[1,1,2,2][this.pos]:
                    (game.level==22||game.level==23||game.level==35||game.level==86||game.level==103)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):
                    -1
                ...
                switch(game.level){
                    ...
                    break
                    case 22:
                        entities.players[entities.players.length-1].multLife(10)
                    break
                    case 76:
                        this.timers=[0,0]
                    break
            ...
            break
            case 33:
                this.owner=game.level==94&&game.pvp?[1,2,3,-1,-1,-1,-1][this.pos]:
                    game.level==89&&game.pvp?[1,2,3,-1,-1,-1][this.pos]:
                    game.level==77||game.level==98||game.level==99?[1,1,1,-1,2,2,2][this.pos]:
                    game.level==44||game.level==65&&game.pvp?[1,1,-1,2,2][this.pos]:
                    game.level==43?game.point[this.pos]:
                    game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:
                    game.level==29||game.level==37?0:
                    game.level==27&&game.pvp?[1,1,2,2][this.pos]:
                    (
                        game.level==22||game.level==23||game.level==25||game.level==26||game.level==32||game.level==35||game.level==40||game.level==47||game.level==49||game.level==55||
                        game.level==58||game.level==59||game.level==68||game.level==70||game.level==79||game.level==82||game.level==83||game.level==86||game.level==87||game.level==89||
                        game.level==94||game.level==96||game.level==97||game.level==100||game.level==101||game.level==103||game.level==104||game.level==105||game.level==108||game.level==109
                    )&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):
                    -1
                ...
                switch(game.level){
                    ...
                    case 23: case 101:
                        ...
                        this.raidTick=0
                    break
                    case 26: case 28: case 33: case 49: case 63: case 69: case 84: case 85: case 105: case 109:
                        this.timers=[]
                        for(let a=0,la=game.players;a<la;a++){
                            this.timers.push(0)
                        }
                    ...
                    case 110: case 111: case 112: case 113: case 114: case 117: case 118: case 119: case 120: case 121:
                    case 122: case 123:
                        this.timers=[]
                        for(let a=0,la=game.players;a<la;a++){
            ...
            break
            case 36:
                this.owner=(game.level==22||game.level==23||game.level==25||game.level==26||game.level==35||game.level==104||game.level==105)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):-1
            ...
            case 42:
                switch(game.level){
                    ...
                    break
                    case 67: case 78: case 95:
                        this.timers=[0,0]
                    break
                    case 72: case 81:
                        this.timers=[]
                        for(let a=0,la=game.level==81?2:game.players;a<la;a++){
                            this.timers.push([0,0])
                        }
                        this.endTime=0
                        this.owner=-1
                        entities.players.push(new player(graphics.main[1],this.position.x,this.position.y-50,this.owner,0,[],false,findName('Payload',types.player),game.index))
                        game.index++
                    ...
                    break
                    default:
                        this.owner=game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:game.level==32||game.level==58||game.level==70?0:(game.level==22||game.level==23||game.level==25||game.level==26||game.level==35||game.level==101||game.level==105)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):-1
                ...
                switch(game.level){
                            ...
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    this.balls.push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-4,0):list[a]==3?random(0,4):0),
                                        map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y-(list[a]!=2&&list[a]!=3?random(0,4):0),
                                        random(12,20),random(0,1),random(0,360),floor(random(5,11))])
                                }
                            }
                        }
                    break
                    ...
                    case 76: case 86:
                        ...
                        if(this.type!=20&&this.type!=21){
                            list=[1,4,5]
                            for(let a=0,la=list.length;a<la;a++){
                                for(let b=0,lb=this.base.boundary[list[a]].length;b<lb;b++){
                                    let len=dist(this.base.boundary[list[a]][b][0].x,this.base.boundary[list[a]][b][0].y,this.base.boundary[list[a]][b][1].x,this.base.boundary[list[a]][b][1].y)/game.tileset[1]*0.9+random(-0.5,0.5)
                                    for(let c=0,lc=round(len);c<lc;c++){
                                        let pos=(random(0,1)+c)/lc
                                        for(let d=0,ld=[1,1,1,2,2,2,3,3,4,4,5,6][floor(random(0,this.redundant[8]?6:12))];d<ld;d++){
                                            this.balls.push([
                                                map(pos,0,1,this.base.boundary[list[a]][b][0].x,this.base.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,6):0)+(d>0?random(-18,18):0),
                                                map(pos,0,1,this.base.boundary[list[a]][b][0].y,this.base.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(0,4):0)+d*20-d**2*0.4,
                                                random(12,16)-d*0.4,random(0,1),random(0,360),floor(random(4,7))])
                                        }
                                    }
                                }
                            }
                    ...
                    case 87: case 113:
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*1.5+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let pos=(random(0,1)+c)/lc
                                    this.balls[0].push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,6):0),
                                        map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(-1,4):0),
                                        random(10,16),random(0,1),random(0,360),floor(random(5,10))])
                                }
                            }
                        }
                        list=[1,4,5]
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*1.35+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let pos=(random(0,1)+c)/lc
                                    let dev=random(-2,2)
                                    for(let d=0,ld=floor(random(0,9))+2;d<ld;d++){
                                        this.balls[1].push([
                                            map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,6):0)+(d>0?random(-9,9):0)+d*dev,
                                            map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(0,4):0)+d*3+d**2*0.15,
                                            random(6,8)-d*0.5,random(0,1),random(0,360),floor(random(5,10))])
                                    }
                                }
                            }
                        }
                    break
                    case 88: case 91: case 104: case 105: case 110:
                        this.balls=[]
                        list=[1,4,5]
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                            ...
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    this.balls[0].push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,6):0),
                                        map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(0,4):0),
                                        random(12,24),random(0,1),random(0,360),floor(random(5,10))])
                                }
                            }
                        }
                        list=[1,4,5]
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let pos=(random(0,1)+c)/lc
                                    let dev=random(-2,2)
                                    for(let d=0,ld=floor(random(0,5))+4;d<ld;d++){
                                        this.balls[1].push([
                                            map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,6):0)+(d>0?random(-9,9):0)+d*dev,
                                            map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(0,4):0)+d*4+d**2*0.2,
                                            random(6,8)-d*0.4,random(0,1),random(0,360),floor(random(5,10))])
                                    }
                                }
                            }
                        }
                    ...
                    case 93: case 106:
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*1.6+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    if(floor(random(0,3))!=0){
                                        let pos=(random(0.225,0.775)+c)/lc
                                        this.balls.push([
                                            map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-4,0):list[a]==3?random(0,4):0),
                                            map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(-1,3):0),
                                            random(12,20),random(0,1),random(0,360),floor(random(4,10)),random(0,1),random(0,1),random(0,1)])
                                    }
                                }
                            }
                        }
                    ...
                    case 107: case 111:
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*0.9+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let offset=random(-0.2,0.2)
                                    for(let d=0,ld=floor(random(1,4));d<ld;d++){
                                        if(floor(random(0,3))!=0){
                                            let pos=(random(0.2,0.8)+offset+c)/lc
                                            this.balls.push([
                                                map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-4,0):list[a]==3?random(0,4):0),
                                                map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(-1,5):0),
                                                random(10,20),random(0,1),random(0,360),floor(random(5,8)),random(0,1),random(0,1),random(0,1)])
                                        }
                                    }
                                }
                            }
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let pos=(random(0,1)+c)/lc
                                    this.balls[1].push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-10,0):list[a]==3?random(0,6):0),
                                        map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+((list[a]==1||list[a]==4||list[a]==5)?random(0,6):0)-((list[a]==0||list[a]==6||list[a]==7)?random(0,6):0),
                                        random(12,18),random(0,1),random(0,360),floor(random(3,5))*2,random(0,1)])
                                }
                            }
                        }
                    break
                            ...
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    this.balls[0].push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-10,0):list[a]==3?random(0,6):0),
                                        map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+((list[a]==1||list[a]==4||list[a]==5)?random(0,6):0)-((list[a]==0||list[a]==6||list[a]==7)?random(0,6):0),
                                        random(10,15),random(0,1),random(0,360),floor(random(3,5))*2,random(0,1)])
                                }
                            }
                        }
                        list=[1,2,3,4,5]
            ...
            case 43: case 44: case 45: case 46: case 47:
                switch(game.level){
                    case 75:
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                let len=dist(this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].x,this.boundary[list[a]][b][1].y)/game.tileset[1]*0.5+random(-0.5,0.5)
                                for(let c=0,lc=round(len);c<lc;c++){
                                    let pos=(random(0,1)+c)/lc
                                    for(let d=0,ld=floor(random(1,5));d<ld;d++){
                                        this.balls.push([
                ...
                for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                    ...
                    if(c.type==this.type&&!c.exempt&&!c.vv&&(c.position.x!=this.position.x||c.position.y!=this.position.y)&&!c.remove&&!(game.level==54&&abs(this.position.x+this.width/2-game.tileset[0]*149)<1&&this.position.y>game.edge[1]*0.9)){
                        if(abs(this.height-c.height)<1&&abs(c.position.x-(this.position.x+this.width/2+c.width/2))<1&&abs(c.position.y-this.position.y)<1&&!c.remove){
                            ...
                            if(this.type==24&&(game.level==30||game.level==56||game.level==88||game.level==104||game.level==105||game.level==110)){
    ...
    formBoundary(){
        switch(this.type){
            ...
            break
            case 24:
                if(game.level==59||game.level==60||game.level==122){
                    this.boundary=[
                        [],
                        [[{x:this.position.x-this.width/2,y:this.position.y-this.height/2},{x:this.position.x+this.width/2,y:this.position.y-this.height/2}]],
                        [],
        ...
        for(let a=0,la=this.boundary.length;a<la;a++){
            this.base.boundary.push([])
            for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                this.base.boundary[a].push([{x:this.boundary[a][b][0].x,y:this.boundary[a][b][0].y},{x:this.boundary[a][b][1].x,y:this.boundary[a][b][1].y}])
            }
        }
    ...
    checkRedundancy(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if(c.standard&&(this.type!=37||game.level==41||game.level==76||game.level==86||game.level==89||game.level==90||game.level==94||game.level==121)&&(c.type!=37||game.level==69)&&!(c.type==24&&(game.level==59||game.level==60||game.level==79||game.level==122))&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47&&game.level!=49&&game.level!=88&&game.level!=100&&game.level!=101&&game.level!=108&&game.level!=109)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&(game.level==30||game.level==56))&&this.type!=74&&c.type!=74){
                    ...
                    if(c.position.x!=this.position.x||c.position.y!=this.position.y){
                        if(c.type==17||c.type==18||c.type==20||c.type==21){
                            ...
                            if(
                                ...
                                this.redundant[0]=true
                                this.boundary[0]=[]
                                if(game.level==86&&c.type==43&&this.height<game.tileset[1]*2.5){
                        ...
                        if(game.level!=86&&abs(c.position.y-(this.position.y-this.height/2-c.height/2-15))<50&&c.position.y!=this.position.y&&c.position.x-c.width/2<=this.position.x-this.width/2+1&&c.position.x+c.width/2>=this.position.x+this.width/2-1){
                            this.redundant[8]=true
                        }
                    }
                }
    ...
    checkOverlay(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if(c.standard&&this.type!=37&&(c.type!=37||game.level==67||game.level==68||game.level==70||game.level==77||game.level==78||game.level==84||game.level==89||game.level==94||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99||game.level==104||game.level==105||game.level==110)&&!(c.type==24&&(game.level==59||game.level==60||game.level==79||game.level==122))&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47&&game.level!=49&&game.level!=88&&game.level!=100&&game.level!=101&&game.level!=108&&game.level!=109)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&(game.level==30||game.level==56))&&!(this.type==35||c.type==35&&game.level==29)&&this.type!=74&&c.type!=74){
                ...
                }else if((c.type==59||c.type==60)&&(game.level==58||game.level==63||game.level==66||game.level==74||game.level==89||game.level==90||game.level==93||game.level==94||game.level==95||game.level==97||game.level==99||game.level==106||game.level==122)){
                    for(let d=0,ld=this.boundary[2].length;d<ld;d++){
                        if(abs(c.position.x-(this.position.x+this.width/2+c.width/2))<1&&c.position.y-c.height/2<this.boundary[2][d][0].y+1&&c.position.y+c.height/2>this.boundary[2][d][1].y-1){
        ...
        switch(this.type){
            case 1:
                switch(game.level){
                    ...
                    break
                    case 34: case 76: case 86: case 88:
                    ...
                    case 72:
                        if(this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    180+this.balls[a][3]*30,
                                    184+this.balls[a][3]*30,
                                    193+this.balls[a][3]*30
                                )
                                regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.5,this.balls[a][2]*0.5,this.balls[a][4])
                            }
                        }
                    ...
                    case 89: case 94:
                        for(let a=0,la=this.balls[0].length;a<la;a++){
                            layer.fill(
                                84+this.balls[0][a][3]*40,
                                65+this.balls[0][a][3]*40,
                                74+this.balls[0][a][3]*40
                            )
                            regPoly(layer,this.balls[0][a][0],this.balls[0][a][1],this.balls[0][a][5],this.balls[0][a][2]*0.35,this.balls[0][a][2]*0.35,this.balls[0][a][4])
                        }
                    break
                    ...
                    case 93:
                        if(this.position.y<game.tileset[1]*10){
                            ...
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    85+this.balls[a][3]*20+this.balls[a][6]*20,
                                    79+this.balls[a][3]*20+this.balls[a][7]*20,
                                    65+this.balls[a][3]*20+this.balls[a][8]*20
                                )
                                regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.35,this.balls[a][2]*0.35,this.balls[a][4])
                            }
                        }
                    break
                    case 104: case 105:
                        if(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*150){
                            layer.fill(140,135,135)
                            layer.rect(0,0,this.width+1,this.height+1)
                        }else{
                            layer.translate(-this.position.x,-this.position.y)
                    ...
                    case 107: case 111:
                        for(let a=0,la=this.balls.length;a<la;a++){
                            layer.fill(
                                55+this.balls[a][3]*20+this.balls[a][6]*10,
                                72+this.balls[a][3]*20+this.balls[a][7]*10,
                                61+this.balls[a][3]*20+this.balls[a][8]*10
                            )
                            regStar(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.35,this.balls[a][2]*0.35,this.balls[a][2]*0.25,this.balls[a][2]*0.25,this.balls[a][4])
                        }
                    break
                    case 108: case 109: case 112:
                        for(let a=0,la=this.balls[1].length;a<la;a++){
                            layer.fill(
                                45+this.balls[1][a][3]*20,
                                60+this.balls[1][a][3]*20+this.balls[1][a][6]*40,
                                220+this.balls[1][a][3]*20-this.balls[1][a][6]*40
                            )
                            regPoly(layer,this.balls[1][a][0],this.balls[1][a][1],this.balls[1][a][5],this.balls[1][a][2]*0.5,this.balls[1][a][2]*0.5,this.balls[1][a][4])
                            layer.fill(
                                25+this.balls[1][a][3]*20,
                                40+this.balls[1][a][3]*20+this.balls[1][a][6]*40,
                                200+this.balls[1][a][3]*20-this.balls[1][a][6]*40
                            )
                            regGem(layer,this.balls[1][a][0],this.balls[1][a][1],this.balls[1][a][5],this.balls[1][a][2]*0.5,this.balls[1][a][2]*0.5,this.balls[1][a][4])
                        }
                    break
                    case 110:
                        if(this.position.y<game.tileset[1]*10){
                            ...
                            if(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*70){
                                layer.fill(140,135,135)
                                layer.rect(0,0,this.width+1,this.height+1)
                            }else{
                                layer.translate(-this.position.x,-this.position.y)
                    ...
                    case 114:
                        if(this.position.y<game.tileset[1]*10){
                            ...
                            for(let a=0,la=this.balls[0].length;a<la;a++){
                                layer.fill(
                                    50+this.balls[0][a][3]*20,
                                    45+this.balls[0][a][3]*20,
                                    45+this.balls[0][a][3]*20
                                )
                                regPoly(layer,this.balls[0][a][0],this.balls[0][a][1],this.balls[0][a][5],this.balls[0][a][2]*0.35,this.balls[0][a][2]*0.35,this.balls[0][a][4])
                            }
            ...
            case 2: case 34:
                ...
                switch(game.level){
                    ...
                    break
                    case 22: case 100: case 101: case 103:
                    ...
                    break
                    case 59: case 60: case 69: case 79: case 122:
                    ...
                    break
                    case 67: case 68: case 77: case 78: case 95: case 96: case 97: case 98: case 99:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
                    break
            ...
            case 3:
                switch(game.level){
                    ...
                    break
                    case 71:
                        layer.fill(30,44,47,0.5)
                        layer.rect(0,0,this.width,this.height)
                    break
                    case 88: case 91:
                        layer.fill(51,93,141,0.5)
                        layer.rect(this.width/2,this.height/2,this.width,this.height)
                    break
                    case 89: case 90: case 94:
                        layer.fill(82,86,100,0.75)
                        layer.rect(this.width/2,this.height/2,this.width,this.height)
                    break
                    case 104: case 105:
                        layer.fill(51,93,141,0.5)
            ...
            case 4:
                ...
                switch(game.level){
                    ...
                    break
                    case 55: case 59: case 60: case 65: case 75: case 79: case 92: case 119: case 122:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
            ...
            case 7:
                ...
                switch(game.level){
                    ...
                    case 55: case 65: case 92: case 119:
                        let shift=(
                            this.position.x<game.tileset[0]*60&&this.position.x>game.tileset[0]*12&&game.level==55||
                            (this.position.x<game.tileset[0]*66+game.edge[0]*0.5&&this.position.x>game.tileset[0]*12+game.edge[0]*0.5||this.position.x>game.tileset[0]*-66+game.edge[0]*0.5&&this.position.x<game.tileset[0]*-12+game.edge[0]*0.5)&&game.level==65||
                            this.position.x<game.tileset[0]*50&&game.level==92||
                            this.position.x<game.tileset[0]*27&&game.level==119
                        )?60:0
                    ...
                    break
                    case 71:
                        layer.stroke(99,82,66)
                        layer.strokeWeight(4)
                        for(let a=0,la=round(this.height/game.tileset[1])*2;a<la;a++){
                            layer.line(-this.width*0.6,this.height*(-0.5+(a+[0.5,0.3,0.5,0.7][a%4])/la),this.width*0.6,this.height*(-0.5+(a+[0.5,0.7,0.5,0.3][a%4])/la))
                        }
                        layer.noStroke()
                        layer.fill(132,101,83)
                        layer.rect(-this.width*0.6,0,this.width*0.6,this.height+0.5)
                        layer.rect(this.width*0.6,0,this.width*0.6,this.height+0.5)
                    break
                    case 72: case 81:
                        layer.fill(84,80,81)
                    ...
                    break
                    case 74:
                        layer.fill(121,107,94)
                        layer.rect(0,0,this.width,this.height)
                        layer.fill(96,84,78)
                        for(let a=0,la=this.height/game.tileset[1]*2;a<la;a++){
                            layer.rect(this.width*(-0.3+a%2*0.6),this.height*(-0.5+(a+0.5)/la),this.width*0.6,game.tileset[0]*0.3)
                        }
                    break
                    case 75:
                        layer.fill(84,76,65)
                        layer.rect(0,0,this.width,this.height)
                        layer.stroke(44,40,40)
                        layer.strokeWeight(2)
                        layer.line(-this.width*0.5,-this.width*2,this.width*0.5,this.width*2)
                        layer.noStroke()
                        layer.fill(70,52,49)
                        layer.ellipse(-this.width*0.5,-this.width*2,this.width*0.8)
                        layer.ellipse(this.width*0.5,this.width*2,this.width*0.8)
                    break
                    case 76: case 86:
                        layer.fill(149,132,142)
                        for(let a=0,la=round(this.height/game.tileset[1]/2);a<la;a++){
                            layer.quad(
                                -this.width*0.4,(a+0.25-la/2)*game.tileset[1]*2-8,
                                -this.width*0.4,(a+0.25-la/2)*game.tileset[1]*2+8,
                                this.width*0.4,(a+0.75-la/2)*game.tileset[1]*2+8,
                                this.width*0.4,(a+0.75-la/2)*game.tileset[1]*2-8
                            )
                            layer.quad(
                                this.width*0.4,(a+0.25-la/2)*game.tileset[1]*2-8,
                        ...
                        layer.fill(159,142,152)
                        layer.rect(-this.width*0.6,0,this.width*0.6,this.height)
                        layer.rect(this.width*0.6,0,this.width*0.6,this.height)
                    break
                    case 82: case 83: case 85:
                        layer.fill(117,99,110)
                        layer.rect(0,0,this.width*0.9,this.height)
                        layer.fill(95,77,93)
                        layer.rect(0,0,this.width*1.2,this.width*1.2)
                    ...
                    case 87: case 113:
                        ...
                        layer.rect(-this.width*0.3,0,this.width*0.4,this.height)
                        layer.rect(this.width*0.3,0,this.width*0.4,this.height)
                        layer.rect(0,-this.height*0.5+6,this.width,12)
                        layer.rect(0,this.height*0.5-6,this.width,12)
                    break
                    case 88: case 91:
                        if(this.position.x>game.tileset[0]*38&&this.position.x<game.edge[0]-game.tileset[0]*38){
                            layer.fill(76,74,70)
                            layer.rect(0,0,this.width*1.4,this.height)
                            layer.fill(120,115,108)
                            layer.rect(0,0,this.width*0.8,this.height)
                        }else{
                            layer.fill(140,106,90)
                            layer.rect(0,0,this.width+1,this.height)
                            layer.fill(88,69,60)
                            for(let a=0,la=floor(this.height/game.tileset[1]*2.25);a<la;a++){
                                layer.rect(0,(a-la*0.5+0.5)*4/9*game.tileset[1],this.width,game.tileset[1]/15)
                    ...
                    break
                    case 89: case 90: case 94:
                        layer.fill(117,107,109)
                        layer.beginShape()
                        layer.vertex(this.width*0.8,this.height*0.5)
                        layer.vertex(this.width*0.6,0)
                        layer.vertex(this.width*0.8,-this.height*0.5)
                        layer.vertex(-this.width*0.8,-this.height*0.5)
                        layer.vertex(-this.width*0.6,0)
                        layer.vertex(-this.width*0.8,this.height*0.5)
                    ...
                    break
                    case 93: case 106:
                        layer.fill(130,91,62)
                        layer.beginShape()
                        layer.vertex(this.width*0.6,this.height*0.5)
                        layer.vertex(this.width*0.4,0)
                        layer.vertex(this.width*0.6,-this.height*0.5)
                        layer.vertex(-this.width*0.6,-this.height*0.5)
                        layer.vertex(-this.width*0.4,0)
                        layer.vertex(-this.width*0.6,this.height*0.5)
                        layer.endShape()
                        layer.quad(-this.width*1.2,-this.height*0.5,this.width*1.2,-this.height*0.5,this.width,-this.height*0.5+6,-this.width,-this.height*0.5+6)
                        layer.quad(-this.width*1.2,this.height*0.5,this.width*1.2,this.height*0.5,this.width,this.height*0.5-6,-this.width,this.height*0.5-6)
                    break
                    case 104: case 105: case 110:
                        if(this.position.y<game.tileset[1]*40&&abs(this.position.x-game.tileset[0]*126.5)>1&&abs(this.position.x-game.tileset[0]*130.5)>1){
                            layer.fill(140,106,90)
                            layer.rect(0,0,this.width+1,this.height)
                            layer.fill(88,69,60)
                            for(let a=0,la=floor(this.height/game.tileset[1]*2.25);a<la;a++){
                    ...
                    case 107: case 111:
                        layer.fill(65,78,64)
                        layer.rect(-this.width*0.75,0,this.width*0.6,this.height+1)
                        layer.rect(this.width*0.75,0,this.width*0.6,this.height+1)
                        layer.rect(-this.width*0.75,-this.height*0.5+2,this.width,5)
                        layer.rect(-this.width*0.75,this.height*0.5-2,this.width,5)
                        layer.rect(this.width*0.75,-this.height*0.5+2,this.width,5)
                        layer.rect(this.width*0.75,this.height*0.5-2,this.width,5)
                        layer.fill(55,68,54)
                        layer.rect(-this.width*0.75,-4,this.width*0.8,4)
                        layer.rect(-this.width*0.75,4,this.width*0.8,4)
                        layer.rect(this.width*0.75,-4,this.width*0.8,4)
                        layer.rect(this.width*0.75,4,this.width*0.8,4)
                    break
                    case 108: case 109: case 112:
                        layer.fill(65,65,80)
                        layer.rect(-this.width*0.3-1,0,this.width*0.4,this.height+1)
                        layer.rect(this.width*0.3+1,0,this.width*0.4,this.height+1)
                        layer.fill(90,90,120)
                        for(let a=0,la=this.height/game.tileset[1];a<la;a++){
                            layer.rect(0,-this.height/2+(a+0.5)*game.tileset[1]-5,this.width+4,3)
                            layer.rect(0,-this.height/2+(a+0.5)*game.tileset[1],this.width+4,3)
                            layer.rect(0,-this.height/2+(a+0.5)*game.tileset[1]+5,this.width+4,3)
                        }
                    break
                    case 114:
                        layer.fill(70,62,72)
                        layer.rect(-this.width*0.8,0,this.width*0.6,this.height)
                        layer.rect(-this.width*0.8,0,this.width,this.width*1.6,3)
                        layer.rect(this.width*0.8,0,this.width*0.6,this.height)
                        layer.rect(this.width*0.8,0,this.width,this.width*1.6,3)
                    break
                    case 120:
            ...
            case 11:
                ...
                switch(game.level){
                    ...
                    break
                    case 40: case 52: case 120:
                        if(this.position.y>game.tileset[1]*45||game.level==120&&this.position.y>game.tileset[1]*40){
                    ...
                    break
                    case 55: case 65: case 92: case 119:
                        let shift=(this.position.x<game.tileset[0]*60&&this.position.x>game.tileset[0]*12&&game.level==55||(this.position.x<game.tileset[0]*66+game.edge[0]*0.5&&this.position.x>game.tileset[0]*-66+game.edge[0]*0.5)&&game.level==65||this.position.x<game.tileset[0]*50&&game.level==92||this.position.x<game.tileset[0]*40&&game.level==119)?60:0
                    ...
                    break
                    case 71:
                        layer.fill(104,88,65)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect(-this.width/2+(0.5+a)/la*this.width,this.height/4+0.5,this.width/la-1,this.height/2-1,2)
                        }
                        for(let a=0,la=this.width/game.tileset[0]*2-1;a<la;a++){
                            layer.rect(-this.width/2+(1+a)/(la+1)*this.width,-this.height/4+0.5,this.width/(la+1)-1,this.height/2-1,2)
                        }
                        layer.fill(114,98,70)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect(-this.width/2+(0.5+a)/la*this.width,this.height/4+0.5,this.width/la-6,this.height/2-6,2)
                        }
                        for(let a=0,la=this.width/game.tileset[0]*2-1;a<la;a++){
                            layer.rect(-this.width/2+(1+a)/(la+1)*this.width,-this.height/4+0.5,this.width/(la+1)-6,this.height/2-6,2)
                        }
                    break
                    case 72: case 81:
                        layer.fill(168,167,163)
                        layer.rect(0,this.height*0.05,this.width,this.height*0.9,4)
                        layer.fill(96,94,99)
                        for(let a=0,la=15;a<la;a++){
                            layer.quad(
                    ...
                    break
                    case 75:
                        layer.fill(107,95,55)
                        layer.rect(0,this.height*0.1,this.width,this.height,4)
                        layer.fill(57,41,26)
                        for(let a=0,la=18;a<la;a++){
                            layer.quad(
                                this.width*(-0.5+(a+1)/(la+1))+3,-this.height*0.125-3*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))+0.6,-this.height*0.125+0.6*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))-3,-this.height*0.125+3*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))-0.6,-this.height*0.125-0.6*(a%2*-2+1)+a%2*this.height*0.275
                            )
                            layer.quad(
                                this.width*(-0.5+(a+1)/(la+1))+3,this.height*0.425-3*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))+0.6,this.height*0.425+0.6*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))-3,this.height*0.425+3*(a%2*-2+1)+a%2*this.height*0.275,
                                this.width*(-0.5+(a+1)/(la+1))-0.6,this.height*0.425-0.6*(a%2*-2+1)+a%2*this.height*0.275
                            )
                        }
                    break
                    case 76: case 86:
                        layer.stroke(148,124,120)
                        layer.strokeWeight(1)
                        for(let a=0,la=20;a<la;a++){
                            layer.line(-this.width*(-0.5+a/la),-this.height*0.1,-this.width*(-0.5+(a+0.5)/la),-this.height*0.3)
                            layer.line(-this.width*(-0.5+(a+1)/la),-this.height*0.1,-this.width*(-0.5+(a+0.5)/la),-this.height*0.3)
                            layer.line(-this.width*(-0.5+a/la),this.height*0.3,-this.width*(-0.5+(a+0.5)/la),this.height*0.5)
                            layer.line(-this.width*(-0.5+(a+1)/la),this.height*0.3,-this.width*(-0.5+(a+0.5)/la),this.height*0.5)
                            layer.line(-this.width*(-0.5+a/la),-this.height*0.1,-this.width*(-0.5+(a+1)/la),this.height*0.3)
                            layer.line(-this.width*(-0.5+a/la),this.height*0.3,-this.width*(-0.5+(a+1)/la),-this.height*0.1)
                        }
                        layer.noStroke()
                        layer.fill(208,165,131)
                        layer.rect(-this.width*0.5-2.5,this.height*0.05,5,this.height*0.9)
                        layer.rect(this.width*0.5+2.5,this.height*0.05,5,this.height*0.9)
                    break
                    case 82: case 83: case 85:
                        layer.fill(161,117,152)
                        layer.rect(-this.width*0.5,0,1.8,this.height)
                        layer.rect(this.width*0.5,0,1.8,this.height)
                        layer.rect(0,-this.height*0.5+1,this.width,1.8)
                    ...
                    case 87: case 113:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*3;a<la;a++){
                            layer.quad(
                                this.width*(-0.5+(a+0.15)/la),this.height*0.5,
                                this.width*(-0.5+(a+0.85)/la),this.height*0.5,
                                this.width*(-0.5+(a+0.75)/la),this.height*-0.1,
                                this.width*(-0.5+(a+0.25)/la),this.height*-0.1
                            )
                        }
                    break
                    case 88: case 91:
                        layer.fill(108,104,98)
                        layer.quad(
                            -this.width*0.4-10,this.height*0.5,
                            this.width*0.4+10,this.height*0.5,
                            this.width*0.4,-this.height*0.5,
                            -this.width*0.4,-this.height*0.5
                        )
                        layer.fill(126,121,112)
                        layer.quad(
                        ...
                        layer.fill(63,91,120)
                        for(let a=0,la=this.width/game.tileset[0]*3;a<la;a++){
                            layer.quad(
                                this.width*(-0.5+(a+0.3)/la),this.height*0.5,
                                this.width*(-0.5+(a+0.7)/la),this.height*0.5,
                                this.width*(-0.5+(a+0.65)/la),this.height*0.2,
                                this.width*(-0.5+(a+0.35)/la),this.height*0.2
                            )
                        }
                    break
                    case 89: case 90: case 94:
                        layer.fill(110,94,103)
                        layer.rect(0,this.height*0.1,this.width,this.height,4)
                        layer.fill(61,50,53)
                        for(let a=0,la=12;a<la;a++){
                            layer.quad(
                                this.width*(-0.5+(a+1)/(la+1))+4*(a%2*2-1),this.height*0.05-4+(a%2*4-2),
                                this.width*(-0.5+(a+1)/(la+1))+0.8*(a%2*2-1),this.height*0.05+0.8+(a%2*4-2),
                                this.width*(-0.5+(a+1)/(la+1))-4*(a%2*2-1),this.height*0.05+4+(a%2*4-2),
                                this.width*(-0.5+(a+1)/(la+1))-0.8*(a%2*2-1),this.height*0.05-0.8+(a%2*4-2)
                            )
                        }
                    break
                    case 93: case 106:
                        layer.fill(161,119,79)
                        for(let a=0,la=this.width/game.tileset[0]*3;a<la;a++){
                            layer.beginShape()
                            layer.vertex(this.width*(-0.5+(a+0.1)/la),0)
                            layer.vertex(this.width*(-0.5+(a-0.1)/la),this.height/2)
                            layer.vertex(this.width*(-0.5+(a+1.1)/la),this.height/2)
                            layer.vertex(this.width*(-0.5+(a+0.9)/la),0)
                            layer.vertex(this.width*(-0.5+(a+0.7)/la),-this.height/4)
                            layer.vertex(this.width*(-0.5+(a+0.3)/la),-this.height/4)
                            layer.endShape()
                        }
                    break
                    case 104: case 105: case 110:
                        if(this.position.y<game.tileset[1]*38){
                            layer.fill(131,95,77)
                            layer.rect(0,this.height/4,this.width-2,this.height/2-2)
                            layer.rect(0,-this.height/4+1,this.width-game.tileset[0]/2-2,this.height/2-2)
                            layer.fill(86,65,54)
                            for(let a=0,la=round(this.width/game.tileset[0]*3-1);a<la;a++){
                    ...
                    case 107: case 111:
                        for(let a=0,la=3;a<la;a++){
                            for(let b=0,lb=this.width/game.tileset[0]*3-2+a;b<lb;b++){
                                layer.fill(65+a*2.5,80+a*5,70+a*2.5)
                                layer.rect(-this.width/2+(0.5+b+1-a*0.5)/(lb+2-a)*this.width,this.height/4*(a-1)+0.75,this.width/(lb+2-a)-1.5,this.height/2-1.5)
                            }
                        }
                    break
                    case 108: case 109: case 112:
                        for(let a=0,la=3;a<la;a++){
                            for(let b=0,lb=this.width/game.tileset[0]*2-2+a;b<lb;b++){
                                layer.fill(85+a*2.5,70+a*5,90+a*2.5)
                                layer.quad(
                                    -this.width/2+(0.5+b+1-a*0.5)/(lb+2-a)*this.width+game.tileset[0]*0.25-1,
                                    this.height/2,
                                    -this.width/2+(0.5+b+1-a*0.5)/(lb+2-a)*this.width-game.tileset[0]*0.25+1,
                                    this.height/2,
                                    -this.width/2+(0.5+b+1-a*0.5)/(lb+2-a)*this.width-game.tileset[0]*0.25+4,
                                    this.height/4*(a-2),
                                    -this.width/2+(0.5+b+1-a*0.5)/(lb+2-a)*this.width+game.tileset[0]*0.25-4,
                                    this.height/4*(a-2)
                                )
                    ...
                    case 114:
                        layer.fill(72,62,72)
                        cutRect(layer,0,this.height/3,this.width,this.height/3-1,1.5)
                        layer.fill(65,55,65)
                        cutRect(layer,0,0,this.width-4,this.height/3-1,1.5)
                        layer.fill(58,48,58)
                        cutRect(layer,0,-this.height/3,this.width-16,this.height/3-1,1.5)
                    break
                    default:
                        switch(game.level){
                            case 6:
            ...
            case 13:
                switch(game.level){
                    ...
                    break
                    case 85:
                        layer.fill(...game.tilecolor[this.position.y>game.edge[1]-game.tileset[1]*10?0:1])
                        layer.rect(0,0,this.width+1,this.height+1)
                        layer.fill(120,220-min(480,this.reload)/5,170-min(480,this.reload)/10)
                        layer.quad(
                            -this.width/2+20,-this.height/2-0.5,
                            -this.width/2+35,-this.height/2+15,
                            this.width/2-35,-this.height/2+15,
                            this.width/2-20,-this.height/2-0.5
                        )
                    break
            ...
            case 16:
                ...
                for(let a=0,la=4;a<la;a++){
                    if(lcos(a*90+this.time)>0){
                        if(game.level==23||game.level==26||game.level==101||game.level==105){
            ...
            case 17:
                ...
                switch(game.level){
                    ...
                    break
                    case 34: case 50: case 76: case 86: case 88: case 91: case 118:
                        layer.translate(-this.position.x,-this.position.y)
                        layer.fillGradient(graphics.gradient[0])
                        layer.triangle(
            ...
            case 18:
                ...
                switch(game.level){
                    ...
                    break
                    case 110:
                        if(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*68){
                            layer.fill(140,135,135)
                            layer.triangle(
                                this.width/2+0.5,-this.height/2-0.5,
                                -this.width/2-0.5,this.height/2+0.5,
            ...
            case 20:
                ...
                switch(game.level){
                    ...
                    break
                    case 34: case 50: case 54: case 76: case 86: case 88: case 91: case 104: case 105: case 110:
                    case 118:
                        layer.translate(-this.position.x,-this.position.y)
                        layer.fillGradient(graphics.gradient[0])
                        layer.triangle(
            ...
            case 23:
                ...
                switch(game.level){
                    ...
                    case 114:
                        layer.fill(...game.tilecolor[0])
                        layer.rect(0,0,this.width+1,this.height+1)
                        layer.fill(170-min(480,this.reload)/10,120,220-min(480,this.reload)/5)
                        layer.quad(
                            -this.width/2+5,-this.height/2-0.5,
                            -this.width/2+20,-this.height/2+15,
                            this.width/2-20,-this.height/2+15,
            ...
            case 24:
                ...
                switch(game.level){
                    ...
                    case 74:
                        layer.fill(83,67,58)
                        for(let a=0,la=round(this.width/game.tileset[0]*2);a<la;a++){
                            layer.rect(-this.width*(-0.5+(a+0.5)/la),0,6,this.height*0.4)
                            layer.rect(-this.width*(-0.5+(a+0.2)/la),0,3,this.height*0.4)
                            layer.rect(-this.width*(-0.5+(a+0.8)/la),0,3,this.height*0.4)
                        }
                        layer.fill(138,116,95)
                        layer.rect(0,-this.height*0.3,this.width,this.height*0.4)
                        layer.rect(0,this.height*0.3,this.width,this.height*0.4)
                    break
                    case 82: case 83: case 85:
                        layer.fill(144,140,140)
                        layer.rect(0,0,this.width,this.height)
                        layer.fill(96,95,97)
                        layer.beginShape()
                        layer.vertex(-this.width*0.5,-this.height*0.3)
                        layer.vertex(0,-this.height*0.2)
                        layer.vertex(this.width*0.5,-this.height*0.3)
                        layer.vertex(this.width*0.5,this.height*0.3)
                        layer.vertex(0,this.height*0.2)
                        layer.vertex(-this.width*0.5,this.height*0.3)
                    ...
                    break
                    case 89: case 90: case 94:
                        layer.fill(111,97,100)
                        layer.rect(0,-this.height*0.25,this.width,this.height*0.5)
                        layer.rect(0,this.height*0.35,this.width,this.height*0.3)
                        layer.rect(this.width*-0.5+5,0,10,this.height)
                        layer.rect(this.width*0.5-5,0,10,this.height)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la-1;a++){
                            layer.rect(this.width*(-0.5+(a+1)/la),0,20,this.height)
                        }
                    break
                    case 120:
                        layer.fill(60,55,60)
            ...
            case 28:
                ...
                switch(game.level){
                    ...
                    case 113: case 118: case 120: case 121: case 123:
                        switch(game.level){
                            case 34: case 50: case 118:
                            ...
                            break
                            case 75:
                                layer.fill(140,100,60)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(120,80,40)
                            break
                            case 82: case 83: case 85:
                                layer.fill(114,85,66)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(91,68,56)
                            break
                            case 87: case 113:
                            ...
                            break
                            default:
                                layer.fill(140,100,70)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(120,80,50)
                            break
                        }
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.quad(
                        ...
                        switch(game.level){
                            case 75:
                                layer.fill(99,73,20)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,8)
                                layer.fill(17,12,18)
                                for(let a=0,la=round(this.width/game.tileset[0])*3;a<la;a++){
                                    layer.quad(
                                        (this.width+game.tileset[0]*0.12)*(-0.5+a/la),
                                        4,
                                        (this.width+game.tileset[0]*0.12)*(-0.5+(a+0.4)/la),
                                        4,
                                        (this.width+game.tileset[0]*0.12)*(-0.5+(a+1)/la),
                                        -4,
                                        (this.width+game.tileset[0]*0.12)*(-0.5+(a+0.6)/la),
                                        -4
                                    )
                                }
                            break
                    ...
                    break
                    case 67: case 68: case 77: case 78: case 88: case 91: case 95: case 96: case 97: case 98:
                    case 99: case 104: case 105: case 110:
                        switch(game.level){
                            case 88: case 91: case 104: case 105: case 110:
                                layer.fill(79,145,193)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(64,106,147)
                            break
                            default:
                    ...
                    break
                    case 93: case 106:
                        layer.fill(193,122,80)
                        layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                        layer.fill(152,91,62)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,-this.height*0.2625,game.tileset[0]*0.88,this.height*0.275)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,this.height*0.2625,game.tileset[0]*0.88,this.height*0.275)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width-game.tileset[0]*0.2625,-this.height*0.1,game.tileset[0]*0.355,this.height*0.1+1)
                    ...
                    break
                    case 107: case 111:
                        layer.fill(153,122,120)
                        layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                        layer.fill(112,91,102)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,-this.height*0.2875,game.tileset[0]*0.88,this.height*0.225)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,this.height*0.2875,game.tileset[0]*0.88,this.height*0.225)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width-game.tileset[0]*0.2625,-this.height*0.1125,game.tileset[0]*0.355,this.height*0.125+1)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width+game.tileset[0]*0.2625,this.height*0.1125,game.tileset[0]*0.355,this.height*0.125+1)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width+game.tileset[0]*0.2425,-this.height*0.175,game.tileset[0]*0.395,this.height*0.125+1)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width-game.tileset[0]*0.2425,this.height*0.175,game.tileset[0]*0.395,this.height*0.125+1)
                        }
                    break
                    case 108: case 109: case 112:
                        for(let a=0,la=10;a<la;a++){
                            for(let b=0,lb=this.width/game.tileset[0]*2;b<lb;b++){
                                layer.fill(...mergeColor([135,65,90],[40,120,200],lsin((a+b*4)*52)*0.5+0.5))
                                layer.rect(this.width*((b+0.2+a%2*0.3+((a**2)*0.26+(b**2)*0.09)%0.3)/lb-0.5),this.height*((a+0.5)/la-0.5),this.width/lb*0.64,this.height/la+0.5)
                            }
                        }
                    break
                    case 114:
                        layer.fill(210,240,225,0.2)
                        for(let a=0,la=round(this.height/game.tileset[1]);a<la;a++){
                            for(let b=0,lb=round(this.width/game.tileset[0]);b<lb;b++){
                                for(let c=0,lc=5;c<lc;c++){
                                    cutRect(layer,this.width*(-0.5+(b+0.5)/lb),this.height*(-0.5+(a+0.5)/la),game.tileset[0]-c*4,game.tileset[1]-c*4,6-c)
                                }
                            }
                        }
                    break
            ...
            case 35:
                //mark 35
                switch(game.level){
                    case 22: case 35: case 100: case 103:
                        layer.fill(110,105,100)
                        layer.rect(0,0,this.width+1,this.height+1)
                    ...
                    case 29: case 53:
                        ...
                        layer.rect(0,0,this.width+1,this.height)
                    break
                    case 30: case 61: case 102: case 123:
                    ...
                    break
                    case 54: case 55: case 65: case 67: case 77: case 78: case 92: case 95: case 105: case 119:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
                    break
                    case 82: case 83: case 85:
                    ...
                    break
                    case 88: case 91: case 104: case 107: case 110: case 111:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
                        layer.fill(max(120,220-this.reload/4))
                        layer.quad(
                            -this.width/2+5,-this.height/2-0.5,
                            -this.width/2+25,-this.height/2+16,
                            this.width/2-25,-this.height/2+16,
            ...
            case 37:
                ...
                switch(game.level){
                    ...
                    break
                    case 55: case 65: case 92: case 119:
                        let shift=(this.position.x<game.tileset[0]*60&&this.position.x>game.tileset[0]*12&&game.level==55||(this.position.x<game.tileset[0]*66+game.edge[0]*0.5&&this.position.x>game.tileset[0]*12+game.edge[0]*0.5||this.position.x>game.tileset[0]*-66+game.edge[0]*0.5&&this.position.x<game.tileset[0]*-12+game.edge[0]*0.5)&&game.level==65||this.position.x<game.tileset[0]*50&&game.level==92||this.position.x<game.tileset[0]*36&&game.level==119)?60:0
                    ...
                    break
                    case 71:
                        layer.fill(152,121,93)
                        layer.rect(0,-this.height*0.3,this.width,this.height*0.4)
                        layer.rect(0,this.height*0.3,this.width,this.height*0.4)
                        layer.stroke(152,121,93)
                        layer.strokeWeight(3)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.line(this.width*(-0.5+(a+0.3)/la),-4,this.width*(-0.5+(a+0.3)/la),4)
                            layer.line(this.width*(-0.5+(a+0.4)/la),-4,this.width*(-0.5+(a+0.6)/la),4)
                            layer.line(this.width*(-0.5+(a+0.7)/la),-4,this.width*(-0.5+(a+0.7)/la),4)
                        }
                    break
                    case 75:
                        layer.fill(95,85,85)
                        layer.rect(0,-this.height*0.3,this.width,this.height*0.2)
                        layer.rect(0,0,this.width,this.height*0.2)
                        layer.rect(0,this.height*0.3,this.width,this.height*0.2)
                    break
                    case 76: case 86:
                        layer.fill(174,175,177)
                        layer.rect(0,-this.height*0.135,this.width,this.height*0.11)
                        layer.rect(0,this.height*0.135,this.width,this.height*0.11)
                        layer.fill(163,127,113)
                        layer.rect(0,-this.height*0.425,this.width,this.height*0.15)
                        layer.rect(0,this.height*0.425,this.width,this.height*0.15)
                        if(!this.redundant[3]){
                            layer.rect(-this.width*0.5+this.height*0.075,0,this.height*0.15,this.height)
                        }
                        if(!this.redundant[2]){
                            layer.rect(this.width*0.5-this.height*0.075,0,this.height*0.15,this.height)
                        }
                    ...
                    case 82: case 83: case 85:
                        layer.fill(95,94,90)
                        layer.rect(0,-this.height*0.4125,this.width,this.height*0.175)
                        layer.rect(0,this.height*0.4125,this.width,this.height*0.175)
                    ...
                    case 87: case 113:
                        ...
                        layer.rect(0,this.height*0.35,this.width,this.height*0.3)
                        for(let a=0,la=this.width/game.tileset[0];a<la;a++){
                            layer.rect(this.width*(-0.5+(a+0.5)/la),0,10,this.height)
                            layer.rect(this.width*(-0.5+(a+0.5)/la),-this.height*0.3,15,this.height*0.4)
                            layer.rect(this.width*(-0.5+(a+0.5)/la),this.height*0.3,15,this.height*0.4)
                        }
                    break
                    case 88: case 91:
                        if(abs(this.position.x-game.edge[0]*0.5)<game.tileset[0]*30){
                            layer.fill(96,91,83)
                            layer.rect(0,-this.height*0.3,this.width,this.height*0.4)
                            layer.rect(0,this.height*0.3,this.width,this.height*0.4)
                            for(let a=0,la=this.width/game.tileset[0]*5;a<la;a++){
                                layer.rect(this.width*(-0.5+(a+0.5)/la),0,2,this.height)
                            }
                        }else{
                            layer.fill(152,113,94)
                            layer.rect(0,-this.height*0.325,this.width+1,this.height*0.35)
                            layer.rect(0,this.height*0.225,this.width+1,this.height*0.35)
                            layer.fill(104,81,68)
                            for(let a=0,la=floor(this.width/game.tileset[0]*2.5);a<la;a++){
                                layer.rect((a-la*0.5+0.5)*0.4*game.tileset[0],-this.height*0.325,game.tileset[1]/15,this.height*0.35)
                                layer.rect((a-la*0.5+0.5)*0.4*game.tileset[0],this.height*0.225,game.tileset[1]/15,this.height*0.35)
                            }
                        }
                    break
                    case 89: case 90: case 94:
                        layer.fill(88,59,70)
                        layer.rect(0,-this.height*0.375,this.width,this.height*0.25)
                        layer.rect(0,this.height*0.375,this.width,this.height*0.25)
                        layer.stroke(88,59,70)
                        layer.strokeWeight(1.6)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.line(this.width*(-0.5+(a+0.15)/la),-this.height*0.35,this.width*(-0.5+(a+0.15)/la),this.height*0.35)
                            layer.line(this.width*(-0.5+(a+0.85)/la),-this.height*0.35,this.width*(-0.5+(a+0.85)/la),this.height*0.35)
                            layer.line(this.width*(-0.5+(a+0.15)/la),-this.height*0.35,this.width*(-0.5+(a+0.85)/la),this.height*0.35)
                            layer.line(this.width*(-0.5+(a+0.85)/la),-this.height*0.35,this.width*(-0.5+(a+0.15)/la),this.height*0.35)
                        }
                    break
                    case 104: case 105: case 110:
                        if(this.position.y>game.tileset[1]*40){
                            layer.fill(96,91,83)
                            layer.rect(0,-this.height*0.3,this.width,this.height*0.4)
                            layer.rect(0,this.height*0.3,this.width,this.height*0.4)
                            for(let a=0,la=this.width/game.tileset[0]*5;a<la;a++){
                    ...
                    case 107: case 111:
                        layer.fill(80,90,85)
                        layer.rect(0,-this.height*0.375,this.width,this.height/4)
                        layer.rect(0,this.height*0.375,this.width,this.height/4)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect(((a+0.5)/la-0.5)*this.width,0,15,3)
                            layer.rect(((a+0.5)/la-0.5)*this.width-6,-1,3,5)
                            layer.rect(((a+0.5)/la-0.5)*this.width+6,1,3,5)
                        }
                    break
                    case 108: case 109: case 112:
                        ...
                        layer.rect(0,this.height*0.4,this.width,this.height*0.2)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect(((a+0.5)/la-0.5)*this.width,0,1.5,this.height*0.8)
                            layer.rect(((a+0.5)/la-0.5)*this.width-5,0,1.5,this.height*0.8)
                            layer.rect(((a+0.5)/la-0.5)*this.width+5,0,1.5,this.height*0.8)
                            layer.rect(((a+0.5)/la-0.5)*this.width,0,3,this.height*0.4)
                            layer.rect(((a+0.5)/la-0.5)*this.width-5,0,3,this.height*0.4)
                            layer.rect(((a+0.5)/la-0.5)*this.width+5,0,3,this.height*0.4)
                        }
                    break
                    case 114:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.quad(
                                this.width*0.5-this.width*(a+1)/la-3,-this.height/5,
                                this.width*0.5-this.width*(a+1)/la+3,-this.height/5,
            ...
            case 38: case 56:
                ...
                switch(game.level){
                    ...
                    case 62:
                        layer.fill(93,97,96)
                        layer.rect(-this.width*0.375,0,this.width*0.25,this.height)
                        layer.rect(this.width*0.375,0,this.width*0.25,this.height)
                        layer.stroke(93,97,96)
                        for(let a=0,la=this.height/game.tileset[1]*2;a<la;a++){
                            layer.strokeWeight(2)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5,-this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5,-this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5)
                            layer.strokeWeight(1)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5,-this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5,-this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5)
                        }
                    break
                    case 67: case 68: case 77: case 78: case 95: case 96: case 97: case 98: case 99:
                    ...
                    break
                    case 72: case 81:
                        layer.fill(189,171,159)
                        layer.rect(-this.width*0.375,0,this.width*0.25,this.height)
                        layer.rect(this.width*0.375,0,this.width*0.25,this.height)
                        layer.stroke(189,171,159)
                        for(let a=0,la=this.height/game.tileset[1]*2;a<la;a++){
                            layer.strokeWeight(2)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5,-this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.5)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5,-this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.5)
                    ...
                    break
                    case 74:
                        layer.stroke(55,50,56)
                        layer.strokeWeight(1)
                        for(let a=0,la=this.height/game.tileset[1]*5;a<la;a++){
                            layer.line(-this.width*0.3,-this.height*(-0.5+(a+0.25)/la),this.width*0.3,-this.height*(-0.5+(a+1.25)/la))
                            layer.line(this.width*0.3,-this.height*(-0.5+(a+0.25)/la),-this.width*0.3,-this.height*(-0.5+(a+1.25)/la))
                        }
                        layer.noStroke()
                        layer.fill(96,92,80)
                    ...
                    case 75:
                        layer.fill(77,66,60)
                        layer.rect(-this.width*0.325,0,this.width*0.35,this.height)
                        layer.rect(this.width*0.325,0,this.width*0.35,this.height)
                        layer.fill(100,91,82)
                        for(let a=0,la=round(this.height/game.tileset[1])*3;a<la;a++){
                            layer.quad(
                                -this.width*0.45,this.height*(-0.5+(a+0.5)/la),
                                0,this.height*(-0.5+(a+0.5)/la)-this.width*0.15,
                                this.width*0.45,this.height*(-0.5+(a+0.5)/la),
                                0,this.height*(-0.5+(a+0.5)/la)+this.width*0.15
                            )
                        }
                    break
                    case 82: case 83: case 85:
                        layer.fill(129,131,126)
                        layer.rect(-this.width*0.5,0,3,this.height)
                        layer.rect(this.width*0.5,0,3,this.height)
                        layer.quad(
                            -this.width*0.5+1,-this.height*0.5,
                    ...
                    case 87: case 113:
                        ...
                        layer.rect(this.width*0.4,0,this.width*0.2,this.height)
                        for(let a=0,la=this.height/game.tileset[1]*3;a<la;a++){
                            layer.rect(0,this.height*(-0.5+(a+0.35)/la),this.width,2)
                            layer.rect(0,this.height*(-0.5+(a+0.65)/la),this.width,2)
                        }
                    break
                    case 88: case 104: case 105: case 110:
                    ...
                    break
                    case 93: case 106:
                        layer.fill(148,115,96)
                        layer.rect(-this.width*0.4,0,this.width*0.2,this.height)
                        layer.rect(this.width*0.4,0,this.width*0.2,this.height)
                        layer.stroke(148,115,96)
                        for(let a=0,la=this.height/game.tileset[1]*2;a<la;a++){
                            layer.strokeWeight(2)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.75,-this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.75)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.75,-this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.75)
                            layer.strokeWeight(1.5)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.75,-this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.75)
                            layer.line(this.width*0.4,this.height*(-0.5+(a+0.7375)/la)+1.75,-this.width*0.4,this.height*(-0.5+(a+0.2625)/la)-1.75)
                        }
                    break
                    case 108: case 109: case 112:
                        layer.noFill()
                ...
                for(let a=0,la=this.point.length;a<la;a++){
                    switch(game.level){
                        ...
                        case 100: case 103:
                            ...
                            layer.fill(200)
                            if((
                                entities.players[game.players+[2,4,0,3,1][this.point[a]]].life<entities.players[game.players+[2,4,0,3,1][this.point[a]]].base.life*0.8||
                                entities.players[game.players+[2,4,0,3,1][this.point[a]]].id==0
                            )&&!game.pvp){
                                layer.fill(255,50,50)
                            }
                            if(game.pvp){
                                switch(entities.players[game.players+[2,4,0,3,1][this.point[a]]].id){
                                    case 1:
                                        layer.fill(15,75,255)
                                    break
                                    case 2:
                        ...
                        case 101:
                            ...
                            layer.fill(200)
                            if((
                                entities.players[game.players+[4,8,0,5,3][this.point[a]]].life<entities.players[game.players+[4,8,0,5,3][this.point[a]]].base.life*0.8||
                                entities.players[game.players+[4,8,0,5,3][this.point[a]]].id==0
                            )&&!game.pvp){
                                layer.fill(255,50,50)
                            }
                            if(game.pvp){
                                switch(entities.players[game.players+[4,8,0,5,3][this.point[a]]].id){
                                    case 1:
                                        layer.fill(15,75,255)
                                    break
                                    case 2:
                    ...
                    layer.fill(0)
                    layer.textSize(12)
                    layer.text('ABCDEFG'[this.point[a]],a*40-la*20+20,1)
                }
            break
            case 40:
                switch(game.level){
            ...
            case 43:
                ...
                switch(game.level){
                    ...
                    case 75:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
                        if(this.position.y-this.height/2<game.tileset[1]*39.5&&this.position.y+this.height/2>game.tileset[1]*39.5){
                            layer.fill(71,33,10)
                            layer.rect(0,game.tileset[1]*39.5-this.position.y,this.width+1,game.tileset[1]*0.5)
                        }
                        if(this.position.y-this.height/2<game.tileset[1]*43.5&&this.position.y+this.height/2>game.tileset[1]*43.5){
                            layer.fill(71,33,10)
                            layer.rect(0,game.tileset[1]*43.5-this.position.y,this.width+1,game.tileset[1]*0.5)
                        }
                    break
                    case 93: case 106:
                        layer.pattern(graphics.pattern[1])
                        layer.rectPattern(0,0,this.width+1,this.height+1)
                    break
                    case 104: case 105:
                        if(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*150){
            ...
            case 44:
                ...
                switch(game.level){
                    ...
                    break
                    case 104: case 105: case 110:
                        if(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*(game.level==110?70:150)){
                            layer.fill(210,195,150)
                            layer.triangle(
                                -this.width/2-0.5,-this.height/2-0.5,
                                -this.width/2-0.5,this.height/2+0.5,
                ...
                switch(game.level){
                    ...
                    case 82: case 83: case 85:
                        ...
                        for(let a=0,la=5;a<la;a++){
                            layer.quad(
                                -this.width*0.625+2+a*(this.width*0.25-2),this.height*0.5,
                                -this.width*0.625+12+a*(this.width*0.25-2),-this.height*0.5,
                                -this.width*0.375-4+a*(this.width*0.25-2),-this.height*0.5,
                                -this.width*0.375+6+a*(this.width*0.25-2),this.height*0.5
                            )
                        }
                        layer.fill(62,49,60)
                        for(let a=0,la=5;a<la;a++){
                            layer.quad(
                                -this.width*0.625+6+a*(this.width*0.25-2),this.height*0.5,
                                -this.width*0.625+15+a*(this.width*0.25-2),-this.height*0.28,
                                -this.width*0.375-7+a*(this.width*0.25-2),-this.height*0.28,
                                -this.width*0.375+2+a*(this.width*0.25-2),this.height*0.5
                            )
                        }
                    break
                    case 88: case 91: case 104: case 105: case 110:
                        layer.fill(255,163,184)
                        layer.rect(0,0,this.width+1,this.height+1)
                    break
                    default:
            ...
            case 59:
                ...
                switch(game.level){
                    ...
                    break
                    case 74:
                        layer.translate(0,game.tileset[1]*0.2)
                        layer.rotate(atan2(this.height,this.width))
                        layer.fill(83,67,58)
                        for(let a=0,la=round(this.width/game.tileset[0]*3);a<la;a++){
                            layer.rect(-sqrt(this.width**2+this.height**2)*(-0.5+(a+0.5)/la),0,6,game.tileset[1]*0.16)
                            layer.rect(-sqrt(this.width**2+this.height**2)*(-0.5+(a+0.2)/la),0,3,game.tileset[1]*0.16)
                            layer.rect(-sqrt(this.width**2+this.height**2)*(-0.5+(a+0.8)/la),0,3,game.tileset[1]*0.16)
                        }
                        layer.rotate(-atan2(this.height,this.width))
                        layer.translate(0,-game.tileset[1]*0.2)
                        layer.fill(138,116,95)
                    ...
                    case 88: case 91: case 104: case 105: case 110:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*5;a<la;a++){
                            layer.rect(this.width*(-0.5+(a+0.5)/la),this.height*(-0.5+(a+0.5)/la)+game.tileset[1]*0.2,2,game.tileset[1]*0.2)
                        }
                    break
                    case 93: case 106:
                        layer.fill(135,96,75)
                        layer.quad(
                            -this.width*0.5,-this.height*0.5,
                            this.width*0.5,this.height*0.5,
                        ...
                        layer.fill(208,154,119)
                        layer.quad(
                            -this.width*0.5,-this.height*0.5+game.tileset[1]*0.08,
                            this.width*0.5,this.height*0.5+game.tileset[1]*0.08,
                            this.width*0.5,this.height*0.5+game.tileset[1]*0.22,
                            -this.width*0.5,-this.height*0.5+game.tileset[1]*0.22,
                        )
                    break
                    case 95: case 97: case 99:
                        ...
                        layer.quad(
                            -this.width*0.5,-this.height*0.5,
                            this.width*0.5,this.height*0.5,
                            this.width*0.5,this.height*0.5+game.tileset[1]*0.12,
                            -this.width*0.5,-this.height*0.5+game.tileset[1]*0.12,
                        )
                        layer.quad(
                            -this.width*0.5,-this.height*0.5+game.tileset[1]*0.28,
                            this.width*0.5,this.height*0.5+game.tileset[1]*0.28,
                            this.width*0.5,this.height*0.5+game.tileset[1]*0.4,
                            -this.width*0.5,-this.height*0.5+game.tileset[1]*0.4,
                        )
                        for(let a=0,la=this.width/game.tileset[0]*3;a<la;a++){
                            layer.quad(
                                this.width*(-0.5+(a+0.1)/la),game.tileset[1]*0.32+this.height*(-0.5+(a+0.1)/la),
                                this.width*(-0.5+(a+0.6)/la),game.tileset[1]*0.2+1+this.height*(-0.5+(a+0.6)/la),
                                this.width*(-0.5+(a+0.9)/la),game.tileset[1]*0.08+this.height*(-0.5+(a+0.9)/la),
                                this.width*(-0.5+(a+0.4)/la),game.tileset[1]*0.2-1+this.height*(-0.5+(a+0.4)/la)
                            )
                        }
                    break
                    default:
                ...
                switch(game.level){
                    ...
                    case 89: case 90: case 94:
                        ...
                        layer.quad(
                            this.width*0.5,-this.height*0.5,
                            -this.width*0.5,this.height*0.5,
                            -this.width*0.5,this.height*0.5+game.tileset[1]*0.0625,
                            this.width*0.5,-this.height*0.5+game.tileset[1]*0.0625,
                        )
                        layer.quad(
                            this.width*0.5,-this.height*0.5+game.tileset[1]*0.1875,
                            -this.width*0.5,this.height*0.5+game.tileset[1]*0.1875,
                            -this.width*0.5,this.height*0.5+game.tileset[1]*0.25,
                            this.width*0.5,-this.height*0.5+game.tileset[1]*0.25,
                        )
                        layer.stroke(88,59,70)
                        layer.strokeWeight(1.6)
                        for(let a=0,la=this.width/game.tileset[0]*2.5;a<la;a++){
                            layer.line(this.width*(-0.5+(a+0.15)/la),game.tileset[1]*0.0375-this.height*(-0.5+(a+0.15)/la),this.width*(-0.5+(a+0.15)/la),game.tileset[1]*0.2125-this.height*(-0.5+(a+0.15)/la))
                            layer.line(this.width*(-0.5+(a+0.85)/la),game.tileset[1]*0.0375-this.height*(-0.5+(a+0.85)/la),this.width*(-0.5+(a+0.85)/la),game.tileset[1]*0.2125-this.height*(-0.5+(a+0.85)/la))
                            layer.line(this.width*(-0.5+(a+0.15)/la),game.tileset[1]*0.0375-this.height*(-0.5+(a+0.15)/la),this.width*(-0.5+(a+0.85)/la),game.tileset[1]*0.2125-this.height*(-0.5+(a+0.85)/la))
                            layer.line(this.width*(-0.5+(a+0.85)/la),game.tileset[1]*0.0375-this.height*(-0.5+(a+0.85)/la),this.width*(-0.5+(a+0.15)/la),game.tileset[1]*0.2125-this.height*(-0.5+(a+0.15)/la))
                        }
                    break
                    case 93: case 106:
                        layer.fill(135,96,75)
            ...
            case 62:
                ...
                switch(game.level){
                    ...
                    case 82: case 83: case 85:
                        layer.fill(57,49,43)
                        layer.rect(0,0,this.width/2,this.height)
                        layer.fill(210,192,170)
                        layer.rect(0,this.height/2,this.width*2,this.height*0.4,4)
                        layer.fill(255,0.1)
                        layer.rect(0,this.height/2,this.width*2+8,this.height*0.4+8,8)
                        layer.rect(0,this.height/2,this.width*2+4,this.height*0.4+4,6)
                    break
                    case 88: case 91:
                        layer.fill(118,109,95)
                        if(abs(this.position.x-game.edge[0]*0.5)<10){
                            layer.beginShape()
                            layer.vertex(-this.width*0.5-80,this.height*0.5)
                            layer.vertex(-this.width*0.5,-this.height*0.5+game.tileset[1]*0.3)
                            layer.vertex(-game.tileset[0]*4.5,-this.height*0.5-game.tileset[1]*1.7)
                            layer.vertex(game.tileset[0]*4.5,-this.height*0.5-game.tileset[1]*1.7)
                            layer.vertex(this.width*0.5,-this.height*0.5+game.tileset[1]*0.3)
                            layer.vertex(this.width*0.5+80,this.height*0.5)
                            layer.endShape()
                    ...
                    case 89: case 90: case 94:
                        ...
                        if(
                            ...
                            layer.quad(
                                -this.width*0.5+10,-this.height*0.5+20,
                                this.width*0.5-10,-this.height*0.5+10,
                                this.width*0.5-10,this.height*0.5-10,
                                -this.width*0.5+10+(-this.height+20)*game.tileset[0]/game.tileset[1],this.height*0.5-10
                            )
                        }else{
                            layer.rect(0,0,this.width-20,this.height-20)
                        }
                    break
                    case 93: case 106:
                        layer.stroke(41,35,35)
                        layer.strokeWeight(3)
                        layer.line(-7.5,this.height*0.5,-7.5,-this.position.y)
                        layer.line(7.5,this.height*0.5,7.5,-this.position.y)
                    break
                    case 104: case 105: case 110:
                        layer.fill(118,109,95)
                        layer.rect(0,0,this.width-21,this.height-19)
                    break
                    default:
                        layer.fill(88,81,65)
                        layer.rect(0,0,this.width,this.height)
            ...
            case 67:
                ...
                switch(game.level){
                    case 71:
                        layer.fill(...game.tilecolor[1])
                        layer.ellipse(0,0,450,450)
                        layer.stroke(game.tilecolor[1][0]+30,game.tilecolor[1][1]+30,game.tilecolor[1][2]+30)
                        layer.strokeWeight(20)
                        layer.noFill()
                        layer.arc(0,0,360,360,210,255)
                    break
                    case 76: case 86:
                        layer.fill(34,38,48)
                        layer.arc(0,0,120,120,-180,0)
                        layer.fill(99,95,92)
                        layer.rect(0,-30,8,60)
                        layer.rect(-20,-27,8,54)
                        layer.rect(20,-27,8,54)
                        layer.rect(-40,-21,8,42)
                        layer.rect(40,-21,8,42)
                        layer.noFill()
                        layer.stroke(94,91,118)
                    ...
                    break
                    case 89: case 90: case 94:
                        layer.fill(195,85,15)
                        layer.quad(-13.5,0,-12,-2.5,12,-2.5,13.5,0)
                        layer.triangle(-9,0,9,0,0,-21)
                        layer.fill(220,210,220)
                        layer.quad(-6,-7,-4.5,-10.5,4.5,-10.5,6,-7)
                    break
                    default:
            ...
            case 77: case 80:
                for(let a=0,la=4;a<la;a++){
                    if(lcos(a*90+this.time)>0){
                        ...
                        regTriangle(layer,this.width/2*lsin(a*90+this.time),0,this.width*lcos(a*90+this.time)*0.12,this.height*0.12,-30)
                        regTriangle(layer,this.width/2*lsin(a*90+this.time)-this.width*lcos(a*90+this.time)*0.12,0,this.width*lcos(a*90+this.time)*0.12,this.height*0.12,-30)
                        regTriangle(layer,this.width/2*lsin(a*90+this.time)+this.width*lcos(a*90+this.time)*0.12,0,this.width*lcos(a*90+this.time)*0.12,this.height*0.12,-30)
                    }
                }
            break
        ...
        switch(this.type){
            case 1: case 17: case 18: case 20: case 21:
                switch(game.level){
                    ...
                    break
                    case 64: case 70: case 84: case 87: case 89: case 94: case 107: case 111:
                        switch(this.type){
                            case 1:
                                layer.translate(-this.position.x,-this.position.y)
                                layer.fillGradient(graphics.gradient[0])
                    ...
                    case 74:
                        if(this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    143+this.balls[a][3]*60,
                                    105+this.balls[a][3]*60,
                                    93+this.balls[a][3]*60
                                )
                                regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.4,this.balls[a][2]*0.4,this.balls[a][4])
                            }
                        }
                    break
                    case 76: case 86:
                        if(this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    255-this.balls[a][3]*50,
                                    188-this.balls[a][3]*50,
                                    152-this.balls[a][3]*50
                                )
                                regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.35,this.balls[a][2]*0.35,this.balls[a][4])
                            }
                        }
                    ...
                    case 88: case 91:
                        if(this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    162+this.balls[a][3]*40,
                                    170+this.balls[a][3]*40,
                                    61+this.balls[a][3]*40
                                )
                                layer.ellipse(this.balls[a][0],this.balls[a][1],this.balls[a][2],this.balls[a][2])
                                layer.triangle(
                                    this.balls[a][0]+lcos(this.balls[a][4])*this.balls[a][2]*0.5,
                                    this.balls[a][1]-lsin(this.balls[a][4])*this.balls[a][2]*0.5,
                                    this.balls[a][0]-lcos(this.balls[a][4])*this.balls[a][2]*0.5,
                                    this.balls[a][1]+lsin(this.balls[a][4])*this.balls[a][2]*0.5,
                                    this.balls[a][0]+lsin(this.balls[a][4])*this.balls[a][2]*0.5,
                                    this.balls[a][1]+lcos(this.balls[a][4])*this.balls[a][2]*1.5*this.balls[a][5]
                                )
                            }
                        }
                    break
                        ...
                        switch(this.type){
                            case 1:
                                if(this.position.y<game.tileset[1]*10&&game.level==93){
                                    ...
                                    layer.pattern(graphics.pattern[0])
                                    layer.rectPattern(0,0,this.width+1,this.height+1)
                                }
                            break
                            case 17:
                    ...
                    case 108: case 109: case 112:
                        ...
                        switch(this.type){
                            case 1:
                                layer.translate(-this.position.x,-this.position.y-nudge)
                                layer.fillGradient(graphics.gradient[0])
                                layer.rect(this.position.x,this.position.y+nudge,this.width+1,this.height+1)
                            break
                            case 17:
                                layer.translate(-this.position.x,-this.position.y-nudge)
                                layer.fillGradient(graphics.gradient[0])
                                layer.triangle(
                                    -this.width/2-0.5+this.position.x,-this.height/2-0.5+this.position.y+nudge,
                                    -this.width/2-0.5+this.position.x,this.height/2+0.5+this.position.y+nudge,
                                    this.width/2+0.5+this.position.x,this.height/2+0.5+this.position.y+nudge
                                )
                            break
                    ...
                    break
                    case 110:
                        if(!(this.position.y<game.tileset[1]*38&&this.position.x>game.tileset[0]*69)&&this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls.length;a<la;a++){
                                layer.fill(
                                    162+this.balls[a][3]*40,
                                    170+this.balls[a][3]*40,
            ...
            case 4: case 13: case 32:
                switch(game.level){
                    ...
                    break
                    case 23: case 26: case 35: case 101: case 103:
                        switch(this.type){
                            case 13:
                                layer.fill(120,220-min(480,this.reload)/5,170-min(480,this.reload)/10)
                                layer.quad(
            ...
            case 25:
                switch(game.level){
                    case 104: case 105: case 110:
                        ...
                        layer.quad(
                            -this.width/2,-this.height/2+0.5,
                            -this.width/2+15,-this.height/2-5,
                            this.width/2-15,-this.height/2-5,
                            this.width/2,-this.height/2+0.5
                        )
                        for(let a=0,la=this.balls.length;a<la;a++){
            ...
            case 31: case 33: case 36: case 42:
                if(game.level==30||game.level==54){
                    ...
                    switch(game.level){
                        ...
                        break
                        case 82: case 83: case 85:
                            place=[[0,0],[2,0],[1,0.5],[0,1],[2,1]][this.pos]
                        break
                        case 89:
                            place=[[0,0.5],[2,0],[2,1],[1,0],[3,0.5],[1,1]][this.pos]
                        break
                        case 94:
                            place=[[0,1],[1.5,0],[1.5,2],[0.5,0],[2,1],[0.5,2],[1,1]][this.pos]
                        break
                    }
                    let texts=''
                    if(game.level==19||game.level==24||game.level==27||game.level==34||game.level==36){
                        ...
                        texts=game.level==94?['Point A','Point B','Point C','Node','Node','Node',game.pvp?'Point D':'Node'][this.pos]:game.level==28?['Turret','Point','Turret','Turret','Guster','Guster','Guster','Guster'][this.pos]:this.type==42?'Rogue':this.pos>=3&&(game.level==25||game.level==26||game.level==89||game.level==104||game.level==105)||this.pos>=5?'Node':'Point '+'ABCDEFG'[game.level==28?0:this.pos]
                    }
                    graphics.overlay[0].fill(255)
                    graphics.overlay[0].textSize(10)
                    ...
                    if(this.type==33&&(
                        ...
                        game.level==85&&this.pos==1||
                        game.level==101&&this.pos==4
                    )){
                        let nudge=game.level==85?1:game.level==23||game.level==101?2:3
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                    ...
                    }else if(game.level==89&&game.pvp&&!game.royale&&this.pos==0){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                            graphics.overlay[0].text(`${formatTime(this.timers[a])}`,45+a*40,65)
                            graphics.overlay[0].fill(...playerColor(a+1))
                            graphics.overlay[0].rect(45+a*40,75,30,3,1)
                        }
                    }else if(game.level==94&&game.pvp&&!game.royale&&this.pos==0){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                            graphics.overlay[0].text(`${formatTime(this.timers[a])}`,25+a*40,90)
                            graphics.overlay[0].fill(...playerColor(a+1))
                            graphics.overlay[0].rect(25+a*40,100,30,3,1)
                        }
                    }
                }else if(game.level==25||game.level==26||game.level==104||game.level==105){
                    ...
                    if(game.level==19||game.level==24||game.level==27||game.level==34||game.level==36){
                        ...
                        texts=this.type==42?'Rogue':this.pos>=3&&(game.level==25||game.level==26||game.level==104||game.level==105)||this.pos>=5?'Node':'Point '+'ABCDEFG'[game.level==28?0:this.pos]
                    }
                    graphics.overlay[0].fill(255)
                    graphics.overlay[0].textSize(10)
                    graphics.overlay[0].text(texts,25+place[0]*40,15+place[1]*25)
                    graphics.overlay[0].fill(...playerColor(this.owner))
                    graphics.overlay[0].rect(25+place[0]*40,25+place[1]*25,30,3,1)
                    if(this.type==33&&this.pos==2&&game.pvp&&!game.royale&&(game.level==26||game.level==105)){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                    ...
                    let texts=''
                    if(game.level==19||game.level==24||game.level==27||game.level==34||game.level==36||game.level==38||game.level==39&&!game.pvp&&!game.royale){
                        switch(this.type){
                            case 31:
                                texts='Fort'
                            break
                    ...
                    if(this.type==31&&game.level==19&&game.pvp&&!game.royale&&this.pos==2||this.type==31&&game.level==24||this.type==33&&game.level==23&&this.pos==4||game.level==28&&this.pos==1||this.type==31&&game.level==31&&game.pvp&&!game.royale&&this.pos==3||game.level==33&&this.pos==0||game.level==39||game.level==49&&this.pos==3&&game.pvp||game.level==63&&this.pos==0||game.level==69&&this.pos==2||game.level==84&&this.pos==0||this.type==33&&game.level==101&&this.pos==4||game.level==109&&this.pos==2){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                            graphics.overlay[0].text(formatTime(this.timers[a]),25+(this.pos-(game.level==19||game.level==69||game.level==109?2:0)-(game.level==31||game.level==49?3:0))*40,15+(a+1)*25)
                            switch(a+1){
                                case 1:
                                    graphics.overlay[0].fill(15,75,255)
                                break
                            ...
                            graphics.overlay[0].rect(25+(this.pos-(game.level==19||game.level==69||game.level==109?2:0)-(game.level==31||game.level==49?3:0))*40,25+(a+1)*25,30,3,1)
                        }
                    }else if(this.pos==0&&(game.level==27)&&game.pvp&&!game.royale){
                        graphics.overlay[0].fill(255)
                        graphics.overlay[0].textSize(10)
                    ...
                    }else if(this.pos==0&&(game.level==38)&&game.pvp&&!game.royale){
                        graphics.overlay[0].fill(255)
                        graphics.overlay[0].textSize(10)
                    ...
                    }else if(this.pos==0&&(game.level==44||game.level==65)&&game.pvp&&!game.royale){
                        graphics.overlay[0].fill(255)
                        graphics.overlay[0].textSize(10)
                    ...
                    }else if(this.pos==0&&(game.level==77||game.level==98||game.level==99)&&game.pvp&&!game.royale){
                        graphics.overlay[0].fill(255)
                        graphics.overlay[0].textSize(10)
                        graphics.overlay[0].text(formatTime(min(game.time,36000)),25+(this.pos+3-(game.level==19||game.level==69?2:0)-(game.level==31?3:0))*40,15+25)
                    ...
                    }else if(game.level==76&&this.pos==0||game.level==88){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                            graphics.overlay[0].text(`${formatTime(this.timers[a])}`,25+a*40,40)
                            graphics.overlay[0].fill(...playerColor(a+1))
                            graphics.overlay[0].rect(25+a*40,50,30,3,1)
                        }
                    }
            ...
            case 35:
                ...
                switch(game.level){
                    ...
                    case 92: case 119:
                        ...
                        layer.fill(120)
                        regTriangle(layer,0,-this.height/2+7.5+[-1,1][this.pos],6,6,[0,60][this.pos])
                    break
                }
            break
            case 40:
            ...
            case 43: case 44: case 45: case 46: case 47:
                switch(game.level){
                    ...
                    case 75:
                        for(let a=0,la=this.balls.length;a<la;a++){
                            layer.fill(
                                66+this.balls[a][3]*30,
                                60+this.balls[a][3]*30,
                                22+this.balls[a][3]*30
                            )
                            regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]*0.5,this.balls[a][2]*0.5,this.balls[a][4])
                        }
                    break
            ...
            case 49: case 51: case 52: case 53: case 54:
                switch(game.level){
                    ...
                    case 88: case 91: case 104: case 105: case 110:
                        for(let a=0,la=this.balls.length;a<la;a++){
                            layer.fill(
                                227+this.balls[a][3]*40,
                                139+this.balls[a][3]*40,
                                170+this.balls[a][3]*40
                            )
                            regPoly(layer,this.balls[a][0],this.balls[a][1],this.balls[a][5],this.balls[a][2]/2,this.balls[a][2]/2,this.balls[a][4])
                        }
            ...
            case 57:
                ...
                if(game.level==22||game.level==100){
                    layer.scale(1-game.pointAnim[2])
                }else if(game.level==49&&!game.pvp){
                    layer.scale(1-game.pointAnim[1])
                }
                layer.fill(game.level==64||game.level==67||game.level==68||game.level==70||game.level==71||game.level==74||game.level==77||game.level==78||game.level==84||game.level==86||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99?250:180,1-this.recharge/60-this.hide)
                layer.textSize(9)
                if((typeof this.weapon)==`object`){
                    if(this.weapon.length==4){
                        layer.text(`${cutName(types.weapon[types.player[this.weapon[1]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon[2]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon[3]].weapon].name)}`,0,-this.height)
            ...
            case 71:
                ...
                if((typeof this.weapon)==`object`){
                    if(this.weapon.length==4){
                        layer.text(`${cutName(types.weapon[types.player[this.weapon[1]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon[2]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon[3]].weapon].name)}`,0,-this.height-10)
                    }else{
                        layer.text(`${cutName(types.weapon[types.player[this.weapon[1]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon[2]].weapon].name)}`,0,-this.height-10)
                    }
                    if(this.weapon2.length==4){
                        layer.text(`${cutName(types.weapon[types.player[this.weapon2[1]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon2[2]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon2[3]].weapon].name)}`,0,-this.height)
                    }else{
                        layer.text(`${cutName(types.weapon[types.player[this.weapon2[1]].weapon].name)} / ${cutName(types.weapon[types.player[this.weapon2[2]].weapon].name)}`,0,-this.height)
                    }
                }else{
            ...
            case 1: case 17: case 18: case 20: case 21:
                switch(game.level){
                    ...
                    case 87: case 113:
                        ...
                        for(let a=0,la=this.balls[1].length;a<la;a++){
                            layer.fill(
                                76+this.balls[1][a][3]*20,
                                54+this.balls[1][a][3]*20,
                                41+this.balls[1][a][3]*20
                            )
                            regPoly(layer,this.balls[1][a][0],this.balls[1][a][1],this.balls[1][a][5],this.balls[1][a][2]*0.35,this.balls[1][a][2]*0.35,this.balls[1][a][4])
                        }
                    break
                    case 89: case 94:
                        layer.noStroke()
                        for(let a=0,la=this.balls[1].length;a<la;a++){
                            layer.fill(
                                107+this.balls[1][a][3]*20,
                                64+this.balls[1][a][3]*20,
                                72+this.balls[1][a][3]*20
                            )
                            regPoly(layer,this.balls[1][a][0],this.balls[1][a][1],this.balls[1][a][5],this.balls[1][a][2]*0.35,this.balls[1][a][2]*0.35,this.balls[1][a][4])
                        }
                    break
                    ...
                    case 114:
                        ...
                        if(this.position.y>=game.tileset[1]*10){
                            for(let a=0,la=this.balls[1].length;a<la;a++){
                                layer.fill(
                                    35+this.balls[1][a][3]*30,
                                    43+this.balls[1][a][3]*30,
                                    33+this.balls[1][a][3]*30
                                )
                                regPoly(layer,this.balls[1][a][0],this.balls[1][a][1],this.balls[1][a][5],this.balls[1][a][2]*0.5,this.balls[1][a][2]*0.5,this.balls[1][a][4])
                            }
                        }
        ...
        switch(this.type){
            ...
            case 3:
                switch(game.level){
                    ...
                    break
                    case 30: case 56: case 59: case 60: case 67: case 68: case 77: case 78: case 79: case 88:
                    case 89: case 90: case 91: case 94: case 95: case 96: case 97: case 98: case 99: case 110:
                    case 114: case 122:
                        this.bounder.position.x=this.position.x+this.width/2
                        this.bounder.position.y=this.position.y+this.height/2
                        this.bounder.width=this.width
                    ...
                    break
                    case 71:
                        this.bounder.position.x=this.position.x
                        this.bounder.position.y=this.position.y
                        this.bounder.width=this.width
                        this.bounder.height=this.height
                    break
                }
            ...
            case 4: case 23: case 32: case 35: case 40:
                if((game.level==61||game.level==102||game.level==123)&&this.type==35){
                ...
                if(this.reload>0){
                    if(this.type==35&&game.level==29){
                        ...
                        this.reload-=(
                            ...
                            (game.level==19||game.level==31)&&this.type!=35&&!(this.type==32&&game.pvp)?1/3:1
                        )*
                        (this.type==32&&game.level==42?2/3:1)*
                        (this.type==35&&game.level==42?1/6:1)*
                        (this.type==35&&(game.level==55||game.level==119)?2:1)
                    }
            ...
            case 78: case 79: case 80: case 81:
                ...
                if((game.level==55||game.level==92||game.level==119)&&this.pos>=0){
                    let mult=game.level==55||game.level==119?2:1
                    if(this.position.x>((game.level==119?65.5:game.level==92?100.5:127.5)+4*this.pos)*game.tileset[0]){
                        this.position.x-=3*mult
                        this.bounder.position.x-=3*mult
                        this.velocity.x=-3*mult
                        for(let a=0,la=this.boundary.length;a<la;a++){
                            for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                                for(let c=0,lc=this.boundary[a][b].length;c<lc;c++){
                                    this.boundary[a][b][c].x-=3*mult
                                }
                            }
                        }
                    }
                    if(this.position.y>this.base.position.y-game.tileset[1]*3&&(this.pos==6||this.pos==8)){
                        this.position.y-=2*mult
                        this.bounder.position.y-=2*mult
                        this.velocity.y=-2*mult
                        for(let a=0,la=this.boundary.length;a<la;a++){
                            for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                                for(let c=0,lc=this.boundary[a][b].length;c<lc;c++){
            ...
            break
            case 11:
                if(game.level==22&&(abs(this.base.position.y-game.tileset[1]*54.75)<1||abs(this.base.position.y-game.tileset[1]*53.75)<1)&&!game.point[1]&&this.height>0||game.level==100&&!game.point[1]&&this.height>2){
                    this.height-=0.1
                ...
                }else if(game.level==100&&game.point[1]&&this.height<this.base.height){
                    this.height+=0.1
                    this.bounder.height+=0.1
                    this.position.y-=0.05
                    this.bounder.position.y-=0.05
            ...
            case 13:
                if(this.reload>0){
                    ...
                    this.reload-=game.level==101?0.2:(game.level==23?(this.reduction?0.5:0.225):game.level==19||game.level==26||game.level==31||game.level==33||game.level==85||game.level==105?0.5:1)
                    if((this.reload==479||this.reload==459||this.reload==439||this.reload==419||this.reload==399)&&game.level!=23&&game.level!=26&&game.level!=85&&game.level!=101||this.reload==469&&(game.level==32||game.level==33)){
                        let mult=0
                        switch(game.level){
                            case 6:
                            ...
                            case 19: case 31:
                                ...
                                entities.projectiles[entities.projectiles.length-1].velocity.y*=mult
                            break
                            case 22: case 24: case 100: case 101: case 103:
                                entities.projectiles.push(new projectile(graphics.main[0],this.position.x,this.position.y-this.height/2,65,random(-100,-90),this.align,200,180,false,-1))
                                mult=random(1.2,1.8)
                                entities.projectiles[entities.projectiles.length-1].velocity.x*=mult
                                entities.projectiles[entities.projectiles.length-1].velocity.y*=mult
            ...
            case 15:
                if(this.reload>0){
                    this.reload-=(game.level==19||game.level==31||game.level==55||game.level==92||game.level==103||game.level==119?0.5:1)
                    if(game.level!=55&&game.level!=92&&game.level!=103  ){
                        switch(game.level){
                            case 19: case 22: case 23: case 24: case 31: case 35: case 100: case 101: case 103:
            ...
            case 16:
                ...
                if(game.level==23||game.level==101){
            ...
            break
            case 28:
                if(game.level==114&&this.time>this.pause&&this.position.y>game.edge[1]-game.tileset[1]*10){
                    let speed=sin(this.time-this.pause)*0.1
                    this.position.y+=speed
                    this.bounder.position.y+=speed
                    this.internalBounder.position.y+=speed
                    this.velocity.y=speed
                    for(let a=0,la=this.boundary.length;a<la;a++){
                        for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                            for(let c=0,lc=this.boundary[a][b].length;c<lc;c++){
            ...
            case 31:
                ...
                }else if(game.level==76&&game.pvp&&this.owner>0&&this.owner<=game.players&&this.owner==game.point[1]){
                    this.timers[this.owner-1]++
                }
            break
            case 33:
                //mark 33
                if(game.level==61||game.level==102||game.level==123){
                    if(game.elevate==0&&this.position.y>this.base.position.y){
                        this.position.y-=1.5
                        this.bounder.position.y-=1.5
                        this.internalBounder.position.y-=1.5
                ...
                }else if((game.level==26||game.level==105||game.level==109)&&this.pos==2){
                    for(let a=0,la=game.point.length;a<la;a++){
                        if(game.point[a]>0&&game.point[a]<=game.players){
                            this.timers[game.point[a]-1]++
                        }
                    }
                }else if((game.level==28||game.level==49||game.level==69||game.level==88)&&this.owner>0&&this.owner<=game.players){
                    this.timers[this.owner-1]++
                }else if((game.level==33||game.level==63||game.level==84||game.level==85)&&game.pvp){
                    for(let a=0,la=entities.walls[1].length;a<la;a++){
                        if(entities.walls[1][a].owner>0&&entities.walls[1][a].owner<=game.players){
                            this.timers[entities.walls[1][a].owner-1]++
                        }
                    }
                }else if(game.level==89&&game.pvp&&this.owner>0&&this.owner<=game.players&&this.pos==0&&this.owner==game.point[1]&&this.owner==game.point[2]){
                    this.timers[this.owner-1]++
                ...
                }else if(game.level==101&&this.pos==4&&this.owner>0&&this.owner<=game.players){
                    this.timers[this.owner-1]++
                    if((this.timers[this.owner-1]>10800&&this.raided==0||this.timers[this.owner-1]>14400&&this.raided==1)&&this.raidTick==0){
                        this.raided++
                        game.raid++
            ...
            case 37:
                ...
                }else if((game.level==61||game.level==102||game.level==123)&&this.pos!=2){
            ...
            case 38:
                if(game.level==22){
                    ...
                    for(let a=0,la=game.players;a<la;a++){
                        if(
                            (
                                this.base.position.x<game.edge[0]/2&&entities.players[a].position.x>this.base.position.x-250&&entities.players[a].position.x<this.base.position.x+this.width/2+entities.players[a].width/4||
                                this.base.position.x>game.edge[0]/2&&entities.players[a].position.x<this.base.position.x+250&&entities.players[a].position.x>this.base.position.x-this.width/2-entities.players[a].width/4
                            )&&
                            abs(entities.players[a].position.y-(this.base.position.y+this.base.height/2))<100&&
                    ...
                    if(this.base.height==10){
                        if(abs(this.position.x-game.tileset[0]*49.5)<1){
                            ...
                            if(!game.point[2/*1*/]&&this.height<game.tileset[1]*3){
                                this.height+=1
                                this.bounder.height+=1
                                this.internalBounder.height+=1
                                this.position.y+=0.5
                            ...
                            }else if(game.point[2/*1*/]&&this.height>0){
                                this.height-=1
                                this.bounder.height-=1
                                this.internalBounder.height-=1
                                this.position.y-=0.5
                    ...
                    if(this.position.x<300||this.position.x>game.edge[0]-300){
                        if(abs(this.position.x-game.tileset[0]*3.5)<1){
                            game.gate[0]=this.height>10
                        }
                        if(abs(this.position.x-(game.edge[0]-game.tileset[0]*3.5))<1){
                            game.gate[1]=this.height>10
                        }
                        if(game.point[3]>0&&game.point[3]<=game.players&&abs(this.base.position.x-entities.players[game.point[3]-1].position.x)<200&&abs(this.base.position.y+this.base.height/2-entities.players[game.point[3]-1].position.y-75)<150){
                            if(this.height>0){
                    ...
                    if(game.point[0]==0){
                        if(this.height<this.base.height){
                            this.height+=0.25
                            this.bounder.height+=0.25
                            this.internalBounder.height+=0.25
                            this.position.y+=0.125
                            this.bounder.position.y+=0.125
                            this.internalBounder.position.y+=0.125
                            this.velocity.y=0.125
                            for(let a=0,la=this.boundary.length;a<la;a++){
                                for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                                    for(let c=0,lc=this.boundary[a][b].length;c<lc;c++){
                                        if(a==0||a==2&&c==1||a==3&&c==1){
                                            this.boundary[a][b][c].y+=0.25
                                        }
                                    }
                                }
                            }
            ...
            case 74:
                let visible74=false
                for(let a=0,la=(game.level==89||game.level==94)&&!game.pvp?entities.players.length:game.players;a<la;a++){
                    if(
                ...
                let mult=game.level==89||game.level==94?2:1
                if(visible74){
                    if(this.height>0){
                        this.height-=2*mult
                        this.bounder.height-=2*mult
                ...
                for(let b=0,lb=this.collide[a].length;b<lb;b++){
                    ...
                    if(
                            ...
                            if(c.rules.stopper){
                                ...
                                if(c.rules.rocket){
                                    ...
                                    for(let e=0,le=entities.players.length;e<le;e++){
                                        if(entities.players[e].index==c.index){
                                            entities.players[e].life=max(entities.players[e].life-c.damage*0.25)
                                        }
                                    }
                                }
                            }
                        ...
                        &&!((this.type==8||this.type==81)&&(this.time<45||c.id<=0||this.recharge>0||c.weaponType==-1
                            ...
                            ||game.classWeapon&&!c.playerData.name.includes('CarrySentry')&&(c.subWeaponA.uses>=(c.subWeaponAData.uses==1?c.subWeaponAData.uses:c.subWeaponAData.uses*c.ammoMult)||c.subWeaponA.uses<=0)
                        ...
                        switch(this.type){
                            case 3:
                                if(rules.safeWater){
                                ...
                                }else if(game.level==28&&this.position.y>game.edge[1]-650||game.level==41||game.level==121){
                                    c.velocity.x*=0.9
                                    c.velocity.y*=0.6
                                    if(c.jump.active<=0){
                                        c.jump.time=1
                                    ...
                                    c.jump.active=1
                                    c.wet=1
                                    c.chillTime=max(c.chillTime,300)
                                }else{
                                    c.velocity.y=-10
                                    c.takeDamage(50)
                                    c.collect.time=max(c.collect.time,300)
                            ...
                            break
                            case 8: case 81:
                                if(!((game.level==22||game.level==100)&&game.pointAnim[4]>=1)){
                                    if(game.level==16){
                                    ...
                                    if(game.classWeapon){
                                        c.subWeaponA.uses=c.subWeaponAData.name==`Ammo Pack`?min(c.subWeaponA.uses+1,c.subWeaponAData.uses*2):
                                            min(c.subWeaponAData.uses==1?c.subWeaponAData.uses:c.subWeaponAData.uses*c.ammoMult,c.subWeaponA.uses+ceil(c.subWeaponAData.uses*c.ammoMult/2))
                                        c.subWeaponA.cooldown=min(c.subWeaponA.cooldown,30)
                                    }else{
                                        c.weapon.uses=c.weaponData.name==`Ammo Pack`?min(c.weapon.uses+1,c.weaponData.uses*2):
                                            min(c.weaponData.uses==1?c.weaponData.uses:c.weaponData.uses*c.ammoMult,c.weapon.uses+ceil(c.weaponData.uses*c.ammoMult/2*(listing[1].includes(c.playerType)?1/3:1)))
                                    ...
                                    if(this.type==81){
                                        ...
                                        switch(game.level){
                                            ...
                                            case 55: case 92: case 119:
                                                this.remove=true
                                            break
                                            case 79: case 82: case 85:
                                                let hold=[this.position.x,this.position.y]
                                                let index=floor(random(0,game.placer[1].length))
                                                let loc=game.placer[1][index]
                                                let speed=[loc[0]-this.position.x,loc[1]-this.position.y]
                            ...
                            break
                            case 11:
                                if(!(game.level==22&&(abs(this.base.position.y-game.tileset[1]*49.75)<1||abs(this.base.position.y-game.tileset[1]*48.75)<1)&&!game.point[1])&&!(game.level==100&&!game.point[1])){
                                    if(game.level==23){
                                        if(this.height>=this.base.height){
                            ...
                            case 16:
                                if((typeof this.weapon)=='object'){
                                    ...
                                    this.recharge=1800
                                }else if(this.weapon>=findName('PlayerRandomScout',types.player)&&this.weapon<findName('PlayerRandomScout',types.player)+10&&!game.pvp&&game.weapon[c.id-1].length<(game.pvp?1:2)){
                                ...
                                }else if(game.level==41||game.level==52||game.level==53||game.level==56||game.level==75||game.level==120||game.level==121){
                                ...
                                }else if(game.level!=13&&game.level!=14&&game.level!=48&&game.level!=57&&game.level!=80){
                                    if(
                                ...
                                }else if(!game.weapon[c.id-1].includes(this.weapon)&&(game.level==13&&game.weapon[c.id-1].length<3||game.level==14&&game.weapon[c.id-1].length<(game.classWeapon?(game.pvp?1:2):game.peakWeapon?(game.mainline?1:2):4))||(game.level==48||game.level==57||game.level==80)&&game.weapon[c.id-1].length<(game.pvp?1:2)){
                            ...
                            break
                            case 31:
                                if(c.name!='Buster'&&!c.construct&&!c.sidekick&&!c.fort&&c.id>0&&!game.attacker&&(c.weapon.uses<=0||c.weaponType==-1)&&game.level!=76&&!((game.level==22||game.level==23||game.level==25||game.level==26||game.level==27||game.level==32||game.level==33||game.level==100||game.level==101||game.level==104||game.level==105)&&!(c.id==this.owner||(game.level==27||game.level==38)&&game.pvp&&(c.id==1&&this.pos==0||c.id==2&&this.pos==3||c.id==3)||this.owner>=0&&c.id>=0&&!game.pvp))){
                                    if(c.auto){
                            ...
                            case 50:
                                if(game.level==29){
                                    c.newWeapon()
                                    this.recharge=3600-(game.gaming-1)*600
                                }else if((typeof this.weapon)=='object'){
                                    c.assort.storeSubWeapon=this.weapon.length==4?[this.weapon[1],this.weapon[2],this.weapon[3]]:[this.weapon[1],this.weapon[2]]
                                    c.newWeaponSet(this.weapon[0])
                                    let chunk=game.classWeapon?3:game.peakWeapon?1:game.level==27&&game.pvp?0:floor(random(0,1.5))
                                    this.weapon=weaponize(chunk)
                            ...
                            case 71:
                                if((typeof this.weapon)=='object'){
                                    let setter=floor(random(0,2))==0?this.weapon:this.weapon2
                                    c.assort.storeSubWeapon=setter.length==4?[setter[1],setter[2],setter[3]]:[setter[1],setter[2]]
                                    c.newWeaponSet(setter[0])
                                    let chunk=game.classWeapon?3:game.peakWeapon?1:game.level==27&&game.pvp?0:floor(random(0,1.5))
                                    this.weapon=weaponize(chunk)
                                    this.weapon2=weaponize(chunk)
                                    this.recharge=3600-(game.gaming-1)*600
                            ...
                            case 73:
                                this.recharge=1800-(game.gaming-1)*300
                                c.life=min(max(c.life,c.base.life*2),c.life+c.base.life/(c.playerData.name=='PlayerMobster'?5:2))
                                this.remove=true
                            break
                            case 75:
                                this.recharge=120
                                    ...
                                    switch(d){
                                        ...
                                        case 1:
                                            ...
                                            switch(this.type){
                                                ...
                                                break
                                                case 4:
                                                    if(game.level==25||game.level==26||game.level==104||game.level==105||game.level==110){
                                                        c.bounceTime=15
                                                    }
                                                    if(this.reload<=0&&!c.auto&&!c.construct&&(c.id>0||game.attacker||game.level==17||game.level==18||game.level==19||game.level==31)&&c.life>0&&c.attacking&&!(c.construct&&(game.level==19||game.level==31))){
                                                        ...
                                                        switch(game.level){
                                                            ...
                                                            break
                                                            case 25: case 26: case 104: case 105: case 110:
                                                            ...
                                                            break
                                                            case 75:
                                                                entities.projectiles.push(new projectile(c.layer,this.position.x,this.position.y-this.height/2-5-game.tileset[1]*4,280,0,c.id,800,1800,0,c.index))
                                                                if(c.id>0&&c.id<=game.gaming){
                                                                    for(let e=0,le=entities.players.length;e<le;e++){
                                                                        if(entities.players[e].id==c.id){
                                                                            entities.players[e].disable=true
                                                            ...
                                                            case 100: case 101: case 103:
                                                                if(game.pointAnim[0]<1){
                                                                    for(let e=0,le=8;e<le;e++){
                                                                        entities.projectiles.push(new projectile(graphics.main[0],this.position.x+20,this.position.y-this.height/2,60,random(97.5,112.5),this.align,100,240,false,-1))
                                                            ...
                                                            case 106:
                                                                if(this.position.x<game.edge[0]*0.5){
                                                                    for(let e=0,le=5;e<le;e++){
                                                                        entities.projectiles.push(new projectile(graphics.main[0],this.position.x,this.position.y-this.height/2,60,random(-115,-135),this.align,100,240,false,-1))
                                                                        let mult=random(1.5,2.5)
                                                                        entities.projectiles[entities.projectiles.length-1].velocity.x*=mult
                                                                        entities.projectiles[entities.projectiles.length-1].velocity.y*=mult
                                                                    }
                                                ...
                                                case 32:
                                                    if(this.reload<=0&&!c.auto&&(!c.fort||c.id==0||game.level==42)&&(c.id>0||game.attacker||game.level==17||game.level==18||game.level==19||game.level==31)&&c.life>0&&(c.attacking&&!(game.level==42&&c.fort)||game.level==42&&c.id>game.gaming&&c.fort&&this.reload<=-1200)){
                                                        ...
                                                        switch(game.level){
                                                            ...
                                                            break
                                                            case 22: case 100: case 103: case 107: case 111:
                                                                for(let e=0,le=10;e<le;e++){
                                                ...
                                                case 35:
                                                    if(this.reload<=0&&!c.auto&&!c.construct&&(c.id>0||game.attacker||game.level==17||game.level==18||game.level==19||game.level==31)&&c.life>0&&c.attacking){
                                                        ...
                                                        switch(game.level){
                                                            ...
                                                            break
                                                            case 22: case 32: case 33: case 40: case 52: case 120:
                                                                for(let e=0,le=15;e<le;e++){
                                                            ...
                                                            case 55: case 65:
                                                                ...
                                                                switch(this.pos){
                                                                    case 0:
                                                                        ...
                                                                        if(valid){
                                                                            for(let e=0,le=entities.walls[1].length;e<le;e++){
                                                                                if(entities.walls[1][e].type!=33&&entities.walls[1][e].type!=35||game.level==55||game.level==119){
                                                                                ...
                                                                                if(entities.walls[1][e].type!=33&&entities.walls[1][e].type!=35){
                                                                                    if(entities.walls[1][e].pos==1||entities.walls[1][e].pos==2||entities.walls[1][e].pos==3||entities.walls[1][e].pos==4||entities.walls[1][e].pos==5){
                                                                                        if(entities.walls[1][e].pos==3){
                                                                                            ...
                                                                                            entities.walls[1][entities.walls[1].length-1].checkBar()
                                                                                            entities.walls[1][entities.walls[1].length-1].formBounder()
                                                                                            entities.walls[1][entities.walls[1].length-1].pos=3
                                                                                        }
                                                                                        entities.walls[1][e].pos--
                                                                                    }else if(entities.walls[1][e].pos==0){
                                                                                        entities.walls[1][e].pos=7
                                        ...
                                        case 2:
                                            ...
                                            if(this.type==38&&game.level==101){
                                                c.target.point=floor(random(0,5))
                                            }
                                        break
                                        case 3:
                                            c.position.x=this.position.x-this.width/2-c.width/2-0.01
