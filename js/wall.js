class wall{
    ...
    set(){
        ...
        switch(this.type){
            ...
            case 65: case 66: case 68: case 69: case 70: case 71: case 72: case 73:
                this.recharge=0
                this.falling=0
                this.infoFade=0
                this.hide=0
            ...
            case 33:
                ...
                switch(game.level){
                    ...
                    case 23:
                        ...
                        this.raidTick=0
                    break
                    case 26: case 28: case 33: case 49: case 63:
                        this.timers=[]
                        for(let a=0,la=game.players;a<la;a++){
                            this.timers.push(0)
                        }
            ...
            case 42:
                if(game.level==30||game.level==54){
                    ...
                    this.owner=game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:game.level==32||game.level==58?0:(game.level==22||game.level==23||game.level==25||game.level==26||game.level==35)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):-1
                    entities.players.push(new player(graphics.main[1],this.position.x,this.position.y-50,this.owner,0,[],false,findName(game.level==32||game.level==38||game.level==58?'Payload':'Rogue',types.player),game.index))
                    game.index++
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    for(let d=0,ld=[1,1,1,2,2,2,3,3,4,4,5,6][floor(random(0,12))];d<ld;d++){
                                        this.balls[1].push([
                                            ...
                                            map(pos,0,1,this.boundary[list[a]][b][0].y,this.boundary[list[a]][b][1].y)-this.position.y+(list[a]!=2&&list[a]!=3?random(0,4):0)+d*11-d**2*0.25,
                                            random(6,8)-d*0.25,random(0,1),random(0,360),floor(random(4,7))])
                                    }
                                }
                            }
                        }
    ...
    checkRedundancy(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if((c.standard||(c.type==59||c.type==60)&&(game.level==58||game.level==63||game.level==66))&&(this.type!=37||game.level==41)&&c.type!=37&&!(c.type==24&&(game.level==59||game.level==60))&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47&&game.level!=49)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&(game.level==30||game.level==56))){
    ...
    checkOverlay(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if(c.standard&&this.type!=37&&c.type!=37&&!(c.type==24&&(game.level==59||game.level==60))&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47&&game.level!=49)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&(game.level==30||game.level==56))&&!(this.type==35||c.type==35&&game.level==29)){
            ...
            case 11:
                ...
                switch(game.level){
                    ...
                    case 58: case 63: case 66:
                        ...
                        for(let a=0,la=4;a<la;a++){
                            layer.quad(
                                -this.width*0.5+a*(this.width*0.25-2),this.height*0.5,
                                -this.width*0.5+8+a*(this.width*0.25-2),-this.height*0.4375,
                                -this.width*0.25-2+a*(this.width*0.25-2),-this.height*0.4375,
                                -this.width*0.25+6+a*(this.width*0.25-2),this.height*0.5
                            )
                        }
                    break
                    case 59: case 60:
                        ...
                        layer.rect(0,-this.height*0.25+1,this.width,2)
                ...
                switch(game.level){
                    ...
                    case 41: case 43: case 44: case 49: case 50: case 52: case 53: case 56: case 61:
                        switch(game.level){
                            ...
                            break
                            case 61:
                                layer.fill(153,104,74,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(130,82,68,this.fade)
                            break
                            default:
                    ...
                    case 59: case 60:
                        ...
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,-this.height*0.275,game.tileset[0]*0.88,this.height*0.25)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,this.height*0.275,game.tileset[0]*0.88,this.height*0.25)
                    ...
                    break
                    case 64:
                        layer.fill(139,105,93,this.fade)
                        for(let a=0,la=round(this.height/game.tileset[1]);a<la;a++){
                        ...
                        layer.fill(116,88,80,this.fade)
                        for(let a=0,la=round(this.height/game.tileset[1]);a<la;a++){
                            for(let b=0,lb=round(this.width/game.tileset[0]);b<lb;b++){
                                layer.beginShape()
                        ...
                        layer.fill(211,155,78,this.fade)
                    break
                    default:
                        layer.fill(60)
                        layer.rect(0,0,this.width+1,this.height+1,2)
                ...
                switch(game.level){
                    ...
                    case 64:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*7;a<la;a++){
                            layer.line(this.width*(-0.5+a/la),-this.height*0.5+0.5,this.width*(-0.5+(a+0.5)/la),-this.height*0.25+0.25)
                            layer.line(this.width*(-0.5+a/la),this.height*0.5-0.5,this.width*(-0.5+(a+0.5)/la),this.height*0.25-0.25)
                            layer.line(this.width*(-0.5+(a+1)/la),-this.height*0.5+0.5,this.width*(-0.5+(a+0.5)/la),-this.height*0.25+0.25)
                            layer.line(this.width*(-0.5+(a+1)/la),this.height*0.5-0.5,this.width*(-0.5+(a+0.5)/la),this.height*0.25-0.25)
                            layer.line(this.width*(-0.5+(a+0.5)/la),-this.height*0.25+0.25,this.width*(-0.5+(a+0.5)/la),this.height*0.25-0.25)
                        }
                    break
                    default:
                        switch(game.level){
        ...
        switch(this.type){
            ...
            case 31: case 33: case 36: case 42:
                if(game.level==30||game.level==54){
                    ...
                    if(this.type==31&&game.level==19&&game.pvp&&this.pos==2||this.type==31&&game.level==24||this.type==33&&game.level==23&&this.pos==4||game.level==28&&this.pos==1||this.type==31&&game.level==31&&game.pvp&&this.pos==3||game.level==33&&this.pos==0||game.level==39||game.level==49&&this.pos==3||game.level==63&&this.pos==0){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                            graphics.overlay[0].text(formatTime(this.timers[a]),25+(this.pos-(game.level==19?2:0)-(game.level==31||game.level==49?3:0))*40,15+(a+1)*25)
                            switch(a+1){
                                case 1:
                                    graphics.overlay[0].fill(15,75,255)
                                break
                            ...
                            graphics.overlay[0].rect(25+(this.pos-(game.level==19?2:0)-(game.level==31||game.level==49?3:0))*40,25+(a+1)*25,30,3,1)
                        }
    ...
    update(){
        ...
        switch(this.type){
            ...
            case 4: case 23: case 32: case 35: case 40:
                ...
                if(this.reload>0){
                    if(this.type==35&&game.level==29){
                        ...
                        this.reload-=(game.level==28&&this.type==40?0.25:game.level==28&&this.type==35?1/3:game.level==25||game.level==26?0.25:game.level==24?0.25:game.level==22||game.level==23||game.level==33||game.level==40||game.level==49&&this.type==32||game.level==59?0.5:(game.level==19||game.level==31)&&this.type!=35&&!(this.type==32&&game.pvp)?1/3:1)*(this.type==32&&game.level==42?2/3:1)*(this.type==35&&game.level==42?1/6:1)
                    }
            ...
            case 66: case 68: case 69: case 70: case 71: case 72: case 73:
            ...
            case 33:
                ...
                }else if((game.level==28||game.level==49)&&this.owner>0&&this.owner<=game.players){
                    this.timers[this.owner-1]++
            ...
            for(let a=0,la=this.collide.length;a<la;a++){
                for(let b=0,lb=this.collide[a].length;b<lb;b++){
                    ...
                    if(
                        ...
                        switch(this.type){
                            case 3:
                                if(game.level==25||game.level==26||game.level==30||game.level==32||game.level==33||game.level==55||game.level==56||game.level==59||game.level==60||game.level==65){
                                    c.velocity.x*=0.925
                                    c.velocity.y*=0.6
                                    c.jump.time=1
                                    c.jump.active=1
                            ...
                            break
                            case 33:
                                if(game.level!=19&&game.level!=29&&game.level!=42&&game.level!=55&&!dm()&&!c.construct&&!c.sidekick&&!c.fort&&c.id>0&&!game.attacker&&c.weapon.uses<=0&&!((game.level==22||game.level==23||game.level==25||game.level==26||game.level==27||game.level==32||game.level==33||game.level==44||game.level==58||game.level==63||game.level==65)&&!(c.id==this.owner||game.level==27&&game.pvp&&(c.id==1&&this.pos==0||c.id==2&&this.pos==3||c.id==3)||this.owner>0&&c.id>0&&!game.pvp))){
                                    if(c.auto){
                                        c.newWeaponSet(c.type)
                                    }else{
                                        c.newWeapon()
