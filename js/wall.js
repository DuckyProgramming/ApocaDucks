        ...
        switch(this.type){
            ...
            case 33:
                ...
                switch(game.level){
                    ...
                    case 62: case 64: case 71: case 73: case 74: case 75: case 90:
                        this.timers=[]
                        for(let a=0,la=game.players;a<la;a++){
        ...
        switch(this.type){
            case 1:
                switch(game.level){
                    ...
                    break
                    case 56: case 60: case 61: case 71: case 74: case 75:
                        if(this.position.y<game.tileset[1]*10){
                            if(this.time<480||this.time<600&&this.time%30<15){
                                layer.fill(80)
                                layer.rect(0,0,this.width+1,this.height+1)
            ...
            case 4:
                ...
                switch(game.level){
                    ...
                    break
                    case 55: case 59: case 60: case 65: case 75: case 79:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
            ...
            case 17:
                ...
                switch(game.level){
                    ...
                    break
                    case 34: case 50: case 76: case 86: case 88:
                        layer.translate(-this.position.x,-this.position.y)
                        layer.fillGradient(graphics.gradient[0])
                        layer.triangle(
            ...
            case 20:
                ...
                switch(game.level){
                    ...
                    break
                    case 34: case 50: case 54: case 76: case 86: case 88:
                        layer.translate(-this.position.x,-this.position.y)
                        layer.fillGradient(graphics.gradient[0])
                        layer.triangle(
                            -this.width/2-0.5+this.position.x,-this.height/2-0.5+this.position.y,
            ...
            case 28:
                ...
                switch(game.level){
                    ...
                    break
                    case 67: case 68: case 77: case 78: case 88:
                        switch(game.level){
                            case 88:
            ...
            case 35:
                ...
                switch(game.level){
                    ...
                    break
                    case 54: case 55: case 65: case 67: case 77: case 78:
                        layer.fill(...game.tilecolor[1])
                        layer.rect(0,0,this.width+1,this.height+1)
                    break
                    case 82: case 83: case 85:
        ...
        switch(this.type){
            ...
            case 31: case 33: case 36: case 42:
                if(game.level==30||game.level==54){
                    ...
                    }else if(game.level==89&&game.pvp&&this.pos==0){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                    ...
                    if(this.type==31&&game.level==19&&game.pvp&&this.pos==2||this.type==31&&game.level==24||this.type==33&&game.level==23&&this.pos==4||game.level==28&&this.pos==1||this.type==31&&game.level==31&&game.pvp&&this.pos==3||game.level==33&&this.pos==0||game.level==39||game.level==49&&this.pos==3||game.level==63&&this.pos==0||game.level==69&&this.pos==2||game.level==84&&this.pos==0){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
                    ...
                    }else if(this.pos==0&&game.level==77&&game.pvp){
                        graphics.overlay[0].fill(255)
                        graphics.overlay[0].textSize(10)
                        ...
                        switch(this.type){
                            case 3:
                                if(
                                    ...
                                    game.level==67||game.level==68||game.level==69||game.level==71||game.level==77||game.level==78||game.level==79||game.level==88||game.level==89
                                ){
                                    c.velocity.x*=0.925
                                    c.velocity.y*=0.6
                                    c.jump.time=1
                                                ...
                                                case 35:
                                                    if(this.reload<=0&&!c.auto&&!c.construct&&(c.id>0||game.attacker||game.level==17||game.level==18||game.level==19||game.level==31)&&c.life>0&&c.attacking){
                                                        ...
                                                        switch(game.level){
                                                            ...
                                                            case 88:
                                                                for(let e=0,le=12;e<le;e++){
                                                                    entities.projectiles.push(new projectile(graphics.main[0],this.position.x,this.position.y-this.height/2,34,-240+(e+0.5)/le*120,c.id,200,120,false,c.index))
