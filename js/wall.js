class wall{
    ...
    set(){
        ...
        switch(this.type){
                        ...
                        for(let a=0,la=list.length;a<la;a++){
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    this.balls.push([
                                        map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,10):0),
                            ...
                            for(let b=0,lb=this.boundary[list[a]].length;b<lb;b++){
                                ...
                                for(let c=0,lc=round(len);c<lc;c++){
                                    ...
                                    for(let d=0,ld=floor(random(2,7));d<ld;d++){
                                        this.balls.push([
                                            map(pos,0,1,this.boundary[list[a]][b][0].x,this.boundary[list[a]][b][1].x)-this.position.x+(list[a]==2?random(-6,0):list[a]==3?random(0,10):0)+(d>0?random(-5,5):0),
            ...
            case 65: case 66:
                ...
                }else if(this.type==50||this.type==61){
            ...
            break
            case 33:
                this.owner=game.level==44&&game.pvp?[1,1,-1,2,2][this.pos]:game.level==43?game.point[this.pos]:game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:game.level==29||game.level==37?0:game.level==27&&game.pvp?[1,1,2,2][this.pos]:(game.level==22||game.level==23||game.level==25||game.level==26||game.level==32||game.level==35||game.level==40||game.level==47||game.level==49||game.level==55)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):-1
                ...
                switch(game.level){
                    ...
                    case 37:
                        ...
                        this.endTime=0
                    break
                    case 36: case 41: case 45: case 50: case 51: case 52: case 53:
                        this.timers=[]
                        for(let a=0,la=game.players;a<la;a++){
            ...
            case 42:
                if(game.level==30||game.level==54){
                    ...
                    this.owner=game.level==38&&game.pvp?[1,-1,-1,2][this.pos]:game.level==32?0:(game.level==22||game.level==23||game.level==25||game.level==26||game.level==35)&&!game.pvp&&!game.attacker?floor(random(1,game.players+1)):-1
                    entities.players.push(new player(graphics.main[1],this.position.x,this.position.y-50,this.owner,0,[],false,findName(game.level==32||game.level==38?'Payload':'Rogue',types.player),game.index))
                    game.index++
        ...
        if(!this.remove){
            for(let a=0,la=entities.walls.length;a<la;a++){
                for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                    ...
                    if(c.type==this.type&&(c.position.x!=this.position.x||c.position.y!=this.position.y)&&!c.remove&&!(game.level==54&&abs(this.position.x+this.width/2-game.tileset[0]*149)<1&&this.position.y>game.edge[1]*0.9)){
    ...
    checkRedundancy(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if(c.standard&&(this.type!=37||game.level==41)&&c.type!=37&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&game.level==30)){
    ...
    checkOverlay(){
        for(let a=0,la=entities.walls.length;a<la;a++){
            for(let b=0,lb=entities.walls[a].length;b<lb;b++){
                let c=entities.walls[a][b]
                if(c.standard&&this.type!=37&&c.type!=37&&(this.type!=38&&c.type!=38||game.level!=22&&game.level!=23&&game.level!=33&&game.level!=37&&game.level!=43&&game.level!=47)&&this.type!=56&&c.type!=56&&!((c.type==20||c.type==21)&&this.type==24&&game.level==30)&&!(this.type==35||c.type==35&&game.level==29)){
        ...
        switch(this.type){
                ...
                switch(game.level){
                    ...
                    case 32: case 33:
                        ...
                        for(let a=0,la=floor(this.height/game.tileset[1]*2);a<la;a++){
                            layer.rect(0,(a-la*0.5+0.25)*game.tileset[1]*0.5,this.width,2)
                            layer.rect(0,(a-la*0.5+0.75)*game.tileset[1]*0.5,this.width,2)
                            layer.rect(0,(a-la*0.5+0.5)*game.tileset[1]*0.5,2,game.tileset[0]*0.25)
                        }
                    break
                    case 34: case 50:
                    ...
                    break
                    case 55:
                        let shift=this.position.x<game.tileset[0]*60?60:0
            ...
            case 24:
                switch(game.level){
                    ...
                    case 32: case 33:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect((a-la*0.5+0.25)*game.tileset[0]*0.5,0,2,this.height)
                            layer.rect((a-la*0.5+0.75)*game.tileset[0]*0.5,0,2,this.height)
                            layer.rect((a-la*0.5+0.5)*game.tileset[0]*0.5,this.height*0.3,game.tileset[0]*0.25,2)
            ...
            case 28:
                switch(game.level){
                    ...
                    case 41: case 43: case 44: case 49: case 50: case 52: case 53:
                        switch(game.level){
                            case 34: case 50:
                                layer.fill(171,137,102,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(141,116,86,this.fade)
                            break
                            case 39:
                                layer.fill(87,73,60,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(67,57,47,this.fade)
                            break
                            case 41:
                                layer.fill(131,164,218,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(90,109,168,this.fade)
                            break
                            case 43:
                                layer.fill(58,53,60,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(44,41,48,this.fade)
                            break
                            case 44:
                                layer.fill(70,65,59,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(59,55,52,this.fade)
                            break
                            case 49:
                                layer.fill(58,44,33,this.fade)
                                layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                                layer.fill(48,37,31,this.fade)
                            break
                            default:
                    ...
                    case 47:
                        layer.fill(120,80,60,this.fade)
                        layer.rect(0,0,this.width,this.height)
                        layer.stroke(140,100,80,this.fade)
                        layer.strokeWeight(4)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                    ...
                    break
                    case 51:
                        layer.fill(226,180,147,this.fade)
                        layer.rect(0,0,this.width+game.tileset[0]*0.1,this.height)
                        layer.fill(178,144,109,this.fade)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.quad(
                        ...
                        layer.fill(147,123,91,this.fade)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,0,game.tileset[0]*0.9,game.tileset[0]*0.1)
                        }
                    break
                    case 54:
                        layer.fill(41,39,40,this.fade)
                        layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                        layer.fill(20,16,15,this.fade)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                    ...
                    break
                    case 55:
                        layer.fill(185,129,104,this.fade)
                        layer.rect(0,0,this.width+game.tileset[0]*0.12,this.height)
                        layer.fill(144,101,94,this.fade)
                        for(let a=0,la=round(this.width/game.tileset[0]);a<la;a++){
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,-this.height*0.25,game.tileset[0]*0.88,this.height*0.3)
                            layer.rect(-this.width/2+(a+0.5)/la*this.width,this.height*0.25,game.tileset[0]*0.88,this.height*0.3)
            ...
            case 37:
                switch(game.level){
                    ...
                    case 32: case 33:
                        ...
                        layer.fill(108,81,70)
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.rect((a-la*0.5+0.25)*game.tileset[0]*0.5,-this.height*0.3,2,this.height*0.4)
                    ...
                    case 49:
                        ...
                        if(this.width<=game.tileset[0]*2){
                            ...
                            layer.quad(
                                -game.tileset[0]*0.25-9,-this.height/3,
                                -game.tileset[0]*0.25-2,-this.height/3,
                                game.tileset[0]*0.25-2,this.height/3,
                                game.tileset[0]*0.25-9,this.height/3
                            )
                            layer.quad(
                            ...
                            for(let a=0,la=this.width/game.tileset[0];a<la;a++){
                                layer.quad(
                                    ...
                                    this.width*0.5-this.width*(a+0.25)/la-2,this.height/3,
                                    this.width*0.5-this.width*(a+0.25)/la-9,this.height/3
                                )
                                layer.quad(
                                    this.width*0.5-this.width*(a+0.75)/la+9,-this.height/3,
                                    this.width*0.5-this.width*(a+0.75)/la+2,-this.height/3,
                    ...
                    case 54:
                        if(this.position.x<game.tileset[0]*150){
                            ...
                            layer.fill(63,43,71)
                            layer.rect(0,-this.height*0.375,this.width+1,this.height*0.25)
                            layer.rect(0,0,this.width+1,this.height*0.25)
                            layer.rect(0,this.height*0.375,this.width+1,this.height*0.25)
                            layer.fill(45,26,45)
                            for(let a=0,la=round(this.width/game.tileset[0]*2);a<la;a++){
                                layer.rect(-this.width/2+(a+0.5)/2*game.tileset[0],-this.height*0.375,game.tileset[1]/10,this.height*0.25-2)
                                layer.rect(-this.width/2+(a+0.5)/2*game.tileset[0],0,game.tileset[1]/10,this.height*0.25-2)
                                layer.rect(-this.width/2+(a+0.5)/2*game.tileset[0],this.height*0.375,game.tileset[1]/10,this.height*0.25-2)
                            }
                        }
                    break
                    case 55:
                        ...
                        for(let a=0,la=this.width/game.tileset[0]*2;a<la;a++){
                            layer.line(this.width*(-0.5+(a+0.25)/la)-1.5,-this.height*0.4,this.width*(-0.5+(a+0.25)/la)-1.5,this.height*0.4)
                            layer.line(this.width*(-0.5+(a+0.75)/la)+1.5,-this.height*0.4,this.width*(-0.5+(a+0.75)/la)+1.5,this.height*0.4)
                            layer.line(this.width*(-0.5+(a+0.25)/la)-1.5,-this.height*0.4,this.width*(-0.5+(a+0.75)/la)+1.5,this.height*0.4)
                            layer.line(this.width*(-0.5+(a+0.75)/la)+1.5,-this.height*0.4,this.width*(-0.5+(a+0.25)/la)-1.5,this.height*0.4)
                            if(a<la-1){
            ...
            case 49:
                switch(game.level){
                    ...
                    case 39:
                        ...
                        layer.rect(-this.width*0.5+7,-this.height*0.25,10,this.height*0.5+1)
                        layer.rect(this.width*0.5-7,-this.height*0.25,10,this.height*0.5+1)
                        layer.rect(-this.width*0.5+5,this.height*0.25,10,this.height*0.5+1)
                        layer.rect(this.width*0.5-5,this.height*0.25,10,this.height*0.5+1)
                        layer.rect(0,-this.height*0.25,this.width-4,this.height*0.4)
                        layer.rect(0,this.height*0.25,this.width,this.height*0.4)
                        layer.fill(56,46,37)
                        layer.rect(-this.width*0.5+7,-this.height*0.25,3,this.height*0.5+1)
                        layer.rect(this.width*0.5-7,-this.height*0.25,3,this.height*0.5+1)
                        layer.rect(-this.width*0.5+5,this.height*0.25,3,this.height*0.5+1)
                        layer.rect(this.width*0.5-5,this.height*0.25,3,this.height*0.5+1)
                    break
                    default:
        ...
        switch(this.type){
            case 1: case 17: case 18: case 20: case 21:
                switch(game.level){
                    ...
                    break
                    case 30:
                        if(!(this.type==18&&this.height<game.tileset[1]*0.5)){
            ...
            case 31: case 33: case 36: case 42:
                if(game.level==30||game.level==54){
                    ...
                    if(this.type==31&&game.level==19&&game.pvp&&this.pos==2||this.type==31&&game.level==24||this.type==33&&game.level==23&&this.pos==4||game.level==28&&this.pos==1||this.type==31&&game.level==31&&game.pvp&&this.pos==3||game.level==33&&this.pos==0||game.level==39){
                        for(let a=0,la=this.timers.length;a<la;a++){
                            graphics.overlay[0].fill(255)
                            graphics.overlay[0].textSize(10)
            ...
            case 35:
                switch(game.level){
                    ...
                    break
                    case 55:
                        layer.fill(220-this.reload*2/3)
                        layer.quad(
                            -this.width/2-10,-this.height/2-0.5,
        ...
        switch(this.type){
            ...
            case 4: case 23: case 32: case 35: case 40:
                if(this.reload>0){
                    if(this.type==35&&game.level==29){
                        ...
                        this.reload-=(game.level==28&&this.type==40?0.25:game.level==28&&this.type==35?1/3:game.level==25||game.level==26?0.25:game.level==24?0.25:game.level==22||game.level==23||game.level==33||game.level==40||game.level==49&&this.type==32?0.5:(game.level==19||game.level==31)&&this.type!=35&&!(this.type==32&&game.pvp)?1/3:1)*(this.type==35&&game.level==42?1/6:1)
                    }
            ...
            case 66:
                if(game.level!=29&&game.level!=37||this.type==57){
                    ...
                    if(this.type==50||this.type==57||this.type==61){
                        let visible=false
                ...
                if(game.level==55&&this.pos>=0){
                    if(this.position.x>(116.5+4*this.pos)*game.tileset[0]){
                        this.position.x-=1.5
                        this.bounder.position.x-=1.5
                        this.velocity.x=-1.5
                        for(let a=0,la=this.boundary.length;a<la;a++){
                            for(let b=0,lb=this.boundary[a].length;b<lb;b++){
                                for(let c=0,lc=this.boundary[a][b].length;c<lc;c++){
                                    this.boundary[a][b][c].x-=1.5
                                }
                            }
                        }
                    }
                    if(this.position.y>this.base.position.y-game.tileset[1]*3&&(this.pos==5||this.pos==7)){
                        this.position.y--
            ...
            case 33:
                if(game.level==23&&this.pos==4&&this.owner>0&&this.owner<=game.players){
                    ...
                    this.timers[this.owner-1]++
                }else if(game.level==33&&game.pvp){
                    for(let a=0,la=entities.walls[1].length;a<la;a++){
                        if(entities.walls[1][a].owner>0&&entities.walls[1][a].owner<=game.players){
                            this.timers[entities.walls[1][a].owner-1]++
                        }
            ...
            case 38:
                ...
                }else if(game.level==33&&this.position.x<400){
                    if(deployer.timer>0){
                ...
                }else if(game.level==49&&this.base.height<=10){
                    if(game.point[2]==0){
            ...
            for(let a=0,la=this.collide.length;a<la;a++){
                for(let b=0,lb=this.collide[a].length;b<lb;b++){
                    ...
                    if(
                        ...
                        this.type!=63&&this.type!=65&&this.type!=66&&this.type!=67&&
                        ...
                        switch(this.type){
                            case 3:
                                if(game.level==25||game.level==26||game.level==30||game.level==32||game.level==33||game.level==55){
                                    c.velocity.x*=0.925
                                    c.velocity.y*=0.6
                                    c.jump.time=1
                                    c.jump.active=1
                            ...
                            case 16:
                                if(game.level==16){
                                    ...
                                    this.weapon=listing[chunk][floor(random(listing[chunk].length))]
                                }else if(game.level==41||game.level==52||game.level==53){
                                ...
                                }else if(!game.weapon[c.id-1].includes(this.weapon)&&(game.level==13&&game.weapon[c.id-1].length<3||game.level==14&&game.weapon[c.id-1].length<(game.peakWeapon||game.classWeapon?(game.mainline?1:2):4))||game.level==48&&game.weapon[c.id-1].length<1){
                            ...
                            break
                            case 33:
                                if(game.level!=19&&game.level!=29&&game.level!=36&&game.level!=41&&game.level!=42&&game.level!=50&&game.level!=51&&game.level!=52&&game.level!=53&&game.level!=55&&!c.construct&&!c.sidekick&&!c.fort&&c.id>0&&!game.attacker&&c.weapon.uses<=0&&!((game.level==22||game.level==23||game.level==25||game.level==26||game.level==27||game.level==32||game.level==33||game.level==44)&&!(c.id==this.owner||game.level==27&&game.pvp&&(c.id==1&&this.pos==0||c.id==2&&this.pos==3||c.id==3)||this.owner>0&&c.id>0&&!game.pvp))){
                                    if(c.auto){
                                        c.newWeaponSet(c.type)
                                    }else{
                                        c.newWeapon()
                            ...
                            break
                            case 57:
                                if(!(game.level==49&&game.pointAnim[1]>=1)){
                                ...
                                if(!this.redundant[d]){
                                    ...
                                    switch(d){
                                        ...
                                        case 1:
                                                            ...
                                                            case 55:
                                                                ...
                                                                switch(this.pos){
                                                                                ...
                                                                                if(entities.walls[1][e].type!=33&&entities.walls[1][e].type!=35){
                                                                                    if(entities.walls[1][e].pos==1||entities.walls[1][e].pos==2||entities.walls[1][e].pos==3||entities.walls[1][e].pos==4){
                                                                                        if(entities.walls[1][e].pos==4){
                                                                                            ...
                                                                                            entities.walls[1][entities.walls[1].length-1].pos=4
                                                                                        }
                                                                                        entities.walls[1][e].pos--
                                                                                    }else if(entities.walls[1][e].pos==0){
                                                                                        entities.walls[1][e].pos=5
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
                                                                    ...
                                                                    case 2:
                                                                        valid=true
                                                                        for(let e=0,le=entities.walls[1].length;e<le;e++){
                                                                            if(entities.walls[1][e].pos==6||entities.walls[1][e].pos==7){
                                                                                valid=false
                                                                            }
                                                                        }
                                                                        if(valid){
                                                                            for(let e=0,le=entities.walls[1].length;e<le;e++){
                                                                                if(entities.walls[1][e].type!=33&&entities.walls[1][e].type!=35){
                                                                                    if(entities.walls[1][e].pos==2||entities.walls[1][e].pos==3||entities.walls[1][e].pos==4){
                                                                                        ...
                                                                                        entities.walls[1][e].pos=(entities.walls[1][e].type==8||entities.walls[1][e].type==9||entities.walls[1][e].type==12)&&game.players!=1?6:7
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
                                            ...
                                            if(c.parachute){
                                                c.parachute=false
                                                if(!game.pvp&&game.level!=19&&game.level!=29&&game.level!=31&&game.level!=41&&game.level!=42&&game.level!=52&&game.level!=53){
