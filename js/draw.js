    ...
    switch(stage.scene){
        ...
        case 'main':
            ...
            for(let c=0,lc=game.gaming;c<lc;c++){
                ...
                if(!special){
                    key[c]*=dev.sight?5:entities.players[c].parachute?3:
