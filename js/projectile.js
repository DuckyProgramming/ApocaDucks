class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index,args=[]){
		...
		switch(this.type){
			...
			case 508: case 509: case 512: case 514: case 515: case 518:
				...
				this.speed=
					...
					this.type==376||this.type==463||this.type==464||this.type==493||this.type==501?10:
					this.type==356?8:
				...
				this.velocity={x:this.speed*lsin(this.direction),y:this.speed*lcos(this.direction)-
					(
						...
						this.type==495||this.type==496||this.type==499||this.type==500?0:
				...
				switch(this.type){
					...
					case 438: case 448: case 509: case 514:
    ...
    display(layer,offsetX=0,offsetY=0){
        ...
        switch(this.type){
			...
			case 485:
				...
				layer.ellipse(0,-2,2,1)
				layer.ellipse(-1.5,-3.2,2,1)
				layer.ellipse(1.5,-3.2,2,1)
			break
			case 489:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
    ...
    update(){
        ...
        for(let a=0,la=this.stun>0?2:this.rules.slow?2:this.rules.fast?6:4;a<la;a++){
			switch(this.type){
				...
				case 435: case 438: case 448: case 509: case 514:
