class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index,args=[]){
		...
		switch(this.type){
			...
			case 389: case 390: case 391: case 392: case 402: case 404: case 413: case 417: case 425:
				this.partisan=true
				this.width=this.type==97||this.type==134||this.type==138||this.type==162||this.type==163||this.type==164||this.type==165||this.type==233||this.type==243||this.type==252||this.type==259||this.type==268||this.type==283||this.type==301||this.type==303?12:
					this.type==118||this.type==122||this.type==123||this.type==128||this.type==129||this.type==137||this.type==140||this.type==141||this.type==142||this.type==144||this.type==157||this.type==171||this.type==249||this.type==260||this.type==261||this.type==272||this.type==328||this.type==356||this.type==373||this.type==402?8:
					4
				this.height=this.type==97||this.type==134||this.type==138||this.type==162||this.type==163||this.type==164||this.type==165||this.type==233||this.type==243||this.type==252||this.type==259||this.type==268||this.type==283||this.type==301||this.type==303?12:
					this.type==118||this.type==122||this.type==123||this.type==128||this.type==129||this.type==137||this.type==140||this.type==141||this.type==142||this.type==144||this.type==157||this.type==171||this.type==249||this.type==260||this.type==261||this.type==272||this.type==328||this.type==356||this.type==373||this.type==402?8:
					4
				this.speed=
				...
				this.velocity={x:this.speed*lsin(this.direction),y:this.speed*lcos(this.direction)-
					(
						this.type==68||this.type==132||this.type==134||this.type==135||this.type==136||this.type==169||this.type==170||this.type==206||this.type==210||this.type==233||this.type==240||this.type==283||this.type==301||this.type==311||this.type==312||this.type==376?0:
						this.type==344||this.type==404?5:
						4
					)
				}
				this.goal=-1
				if(this.type==135||this.type==136||this.type==169||this.type==170||this.type==311||this.type==312){
					...
					this.type==328||this.type==373||this.type==404
				){
					for(let a=0,la=entities.players.length;a<la;a++){
					...
					}else if(this.type==261||this.type==373){
					...
					this.type==323||this.type==329||this.type==349||this.type==360||this.type==368||
					this.type==372||this.type==375||this.type==392||this.type==417
				){
					this.trap=true
					this.stopAnim=1
			...
			case 7: case 23: case 37: case 40: case 46: case 76: case 77:
				...
				this.time=5
			break
			case 15: case 74: case 75: case 222: case 223: case 287: case 288: case 371:
			...
			case 26: case 53: case 54: case 58: case 307:
				...
				this.time=time
			break
			case 28: case 359: case 366: case 383: case 412:
				this.width=4
				this.height=4
				this.speed=this.type==366?12:10
				this.time=time*(this.id==0?0.6:1)
				this.bounces=0
				this.bounceTimer=0
				this.previous={position:{x:this.position.x,y:this.position.y}}
			...
			case 133: case 148: case 149: case 230: case 262: case 320:
				...
				this.time=time
			break
			case 147: case 244: case 258: case 285: case 289: case 290: case 291: case 296: case 410:
				this.speed=16
				this.time=time
				this.midpoint={position:{x:this.position.x,y:this.position.y}}
				this.past=[
			...
			case 365: case 400: case 406: case 415:
				this.time=time
				this.speed=0
				this.extent=this.type==363||this.type==400||this.type==415?80:this.type==365?400:2400
					...
					if(
						...
						for(let b=0,lb=bound.length;b<lb;b++){
							if(intersect(this.position,extend,bound[b][0],bound[b][1])){
								...
								if(dist(this.position.x,this.position.y,point.x,point.y)==this.extent){
									if(this.type==406){
										c.takeDamage(this.damage*(this.crit?2.5:1)*constrain(0.25+0.75*this.extent/500,0.5,1)*constrain(1.375-this.extent/400,1,1.25)*constrain(2-this.extent/1000,0.4,1))
									}else{
			...
			case 198:
				...
				this.height*=3
			break
			case 203: case 207: case 306: case 420:
				this.speed=random(6,8)
				this.time=random(time,time*2)
				this.position.x+=this.speed*lsin(this.direction)
				this.position.y-=this.speed*lcos(this.direction)
    ...
    display(layer,offsetX=0,offsetY=0){
        ...
        switch(this.type){
			...
			case 349:
				...
				if(this.timer>435&&this.timer<40){
			...
			case 372:
				...
				layer.fill(250,50,50,this.fade)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.fill(150,this.fade)
				regStar(layer,0,0,3,3,3,6,6,this.direction+this.position.x)
			...
			case 406:
				...
				layer.line(0,7.5,0,-this.extent)
		...
		switch(this.type){
			case 2: case 26: case 31: case 32: case 41: case 48: case 80: case 266: case 307:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
			...
			case 3:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<240&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
			...
			case 16:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||game.classWeapon&&this.id==entities.players[b].id&&this.id>0)){
						entities.players[b].takeDamage(this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
			...
			case 21: case 53:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						...
						for(let d=0,ld=entities.players.length;d<ld;d++){
							if(entities.players[d].index==this.index){
								entities.players[d].life=min(entities.players[d].life+this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1),entities.players[d].base.life)
							}
						}
					}
				}
			...
			case 22: case 58:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<240&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/240)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 27:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<240&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)&&!(this.id==-1&&entities.players[b].id>0)){
						entities.players[b].takeDamage(this.damage*(1-c/240)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
			...
			case 30: case 166: case 211: case 228: case 290: case 311: case 312: case 344: case 425:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<100&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/100)*0.8*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 55:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<180&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/180)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 60: case 324:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1)*(this.id==-1&&entities.players[b].id>0&&game.level!=19?(this.timer<5?0.1:0.5):1)*(entities.players[b].fort?0.5:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 65:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<200&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)&&!(this.id==-1&&entities.players[b].id>0)&&!entities.players[b].construct){
						entities.players[b].takeDamage(this.damage*(1-c/200)*0.8*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 73:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<100&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/100)*0.8*(entities.players[b].index==this.index?0.75:1)*(this.id==-1&&entities.players[b].id>0?(this.timer<5?0.1:0.5):1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
			...
			case 83:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<200&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/200)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 86: case 229: case 262:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<90&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/90)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 104:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<100&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/100)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 110:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<75&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/75)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 113: case 235: case 264:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<150&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/150)*0.8*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 153:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].playerData.name!='ReusableBuster'&&entities.players[b].life>0&&c<180&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
			...
			case 206: case 250:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<140&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
			...
			case 280:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<300&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
			...
			case 336:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<40&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/40)*0.8*(entities.players[b].index==this.index?0.75:1))
			...
			case 349: case 417:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<130&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/130)*min(1,0.5+(this.time-30)/15*0.5)*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 351:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||game.classWeapon&&this.id==entities.players[b].id&&this.id>0)){
						entities.players[b].takeDamage(this.damage*(1-c/105)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1)*(game.classWeapon&&this.id==entities.players[b].id&&this.id>0?0.25:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
						}
						entities.players[b].velocity.x+=15*(1.5-c/105)*lsin(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?1.5:1)
						entities.players[b].velocity.y-=15*(1.5-c/105)*lcos(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?1.5:1)
						entities.players[b].lastingForce[0]+=(1.5-c/105)*lsin(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?2.25:1)
						entities.players[b].lastingForce[1]-=(1.5-c/105)*lcos(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?2.25:1)
					}
				}
			break
			case 352:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].gasTime=max(entities.players[b].gasTime,ceil(5*(1-c/120)))
				...
				for(let b=0,lb=entities.projectiles.length;b<lb;b++){
					if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<100+entities.projectiles[b].width*0.35+entities.projectiles[b].height*0.35&&(((this.id==0?1:0)!=(entities.projectiles[b].id==0?1:0)||this.id==-1&&entities.projectiles[b].id!=-1||game.pvp&&this.id!=entities.projectiles[b].id))&&entities.projectiles[b].active){
						entities.projectiles[b].active=false
				...
				for(let b=0,lb=8;b<lb;b++){
					entities.projectiles.push(new projectile(this.layer,this.position.x,this.position.y,6,b/lb*360+random(0,360/lb),this.id,this.base.damage*0.6,10,this.crit,this.index))
			...
			case 359:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<150&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/150)*0.8*(entities.players[b].index==this.index?0.75:1)*(entities.players[b].construct?5:1)*(entities.players[b].fort?2.5:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 360:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<225&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/225)*min(1,0.5+(this.time-30)/15*0.5)*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 368:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<130&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||entities.players[b].index==this.index)){
						if(entities.players[b].index!=this.index){
							entities.players[b].takeDamage(this.damage*(1-c/130)*min(1,0.5+(this.time-30)/15*0.5)*(entities.players[b].index==this.index?0.75:1))
							entities.players[b].collect.time=450
							entities.players[b].die.killer=this.index
						}else{
							entities.players[b].velocity.x+=15*(1-c/130)*lsin(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?1.5:1)/(1+abs(entities.players[b].velocity.x)*0.2)
							entities.players[b].velocity.y-=5*(1-c/130)*lcos(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?1.5:1)/(1+abs(entities.players[b].velocity.y)*0.2)
							entities.players[b].lastingForce[0]+=22.5*(1-c/130)*lsin(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?2.25:1)/(1+abs(entities.players[b].velocity.x)*0.2)
							entities.players[b].lastingForce[1]-=7.5*(1-c/130)*lcos(atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y))*(this.index==entities.players[b].index?2.25:1)/(1+abs(entities.players[b].velocity.y)*0.2)
						}
						if(game.invis){
							entities.players[b].visible=15
						}
			...
			case 370:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<102&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/102)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 378:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<90){
						...
						}else if(((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
							entities.players[b].takeDamage(this.damage*(1-c/90)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
							entities.players[b].die.killer=this.index
							entities.players[b].collect.time=450
							if(game.invis){
			...
			case 379:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||game.classWeapon&&this.id==entities.players[b].id&&this.id>0)){
						entities.players[b].takeDamage(this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1)*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 384:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*((1-c/120)**0.75)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 385:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/120)*0.8*(entities.players[b].index==this.index?0.75:1)*constrain(1.2-(this.hitTime==0?this.timer:this.hitTime)/this.base.time*4,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 389:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<165&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
			...
			case 392:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<125&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/125)*min(1,0.5+(this.time-30)/15*0.5)*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
			...
			case 413:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<87.5&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||entities.players[b].id==-1||game.pvp&&(this.id!=entities.players[b].id||!teamMode())||friendly)){
						entities.players[b].takeDamage(this.damage*(1-c/87.5)*0.8*(entities.players[b].index==this.index?0.75:1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
							entities.players[b].visible=15
    ...
    update(){
		...
		switch(this.type){
			...
			case 402: case 404: case 410: case 412: case 413: case 416: case 417: case 425:
				delete this.past[0]
				this.past.splice(0,1)
				this.past.push([this.position.x,this.position.y])
				if(this.type!=68&&this.type!=135&&this.type!=136&&this.type!=240&&this.type!=311&&this.type!=312&&this.type!=392){
        ...
        for(let a=0,la=this.rules.slow?2:this.rules.fast?6:4;a<la;a++){
			switch(this.type){
				...
				case 414: case 418: case 419: case 420: case 421: case 422: case 423:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
				...
				case 391: case 402: case 410: case 412: case 413: case 416: case 425:
					...
					if(this.type==402&&this.hitting>0){
						...
						if(this.type==366){
							this.velocity.y+=0.05
						}else if(this.type!=68&&this.type!=135&&this.type!=136&&this.type!=169&&this.type!=170&&this.type!=240&&this.type!=311&&this.type!=312&&this.type!=367&&!(this.type==416&&this.active)){
							this.velocity.y+=0.1
						}
					}
					...
					if(this.type==353&&this.active&&this.time>=15){
						this.active=false
						this.explode()
					}
				break
				...
				case 314: case 323: case 329: case 349: case 360: case 368: case 372: case 375: case 392: case 417:
					...
					if(
						(this.type==284||this.type==286||this.type==329||this.type==349||this.type==368||this.type==372||this.type==392||this.type==417)&&
						this.timer>=(this.type==349||this.type==368||this.type==372||this.type==392||this.type==417?30:60)&&this.active&&!(this.type==372&&this.delay>0)
					){
								...
								if(entities.players[a].index==this.index){
									if(
										(
											...
											lsin(entities.players[a].direction.main)>0&&this.position.x>entities.players[a].position.x||
											this.type==368&&abs(this.position.x-entities.players[a].position.x)<100
										)&&
				...
				case 163:
					if(a==0){
						...
						let inputSet=this.id==0||((game.level==27||game.level==38||teamMode())&&game.pvp?this.index+1:this.id)>game.gaming?[
				...
				break
				case 222: case 223: case 287: case 288: case 319: case 371: case 374: case 424:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					this.travel+=this.speed
					if(this.travel>(this.id==0?750:1500)){
					...
					for(let b=0,lb=entities.projectiles.length;b<lb;b++){
						if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<15+entities.projectiles[b].width*0.35+entities.projectiles[b].height*0.35&&(((this.id==0?1:0)!=(entities.projectiles[b].id==0?1:0)||this.id==-1&&entities.projectiles[b].id!=-1||game.pvp&&this.id!=entities.projectiles[b].id))&&entities.projectiles[b].active){
				...
				case 280:
					...
					if(a==0){
						...
						let inputSet=this.id==0||((game.level==27||game.level==38||teamMode())&&game.pvp?this.index+1:this.id)>game.gaming?[false,false]:inputs.keys[game.gaming==1?1:game.gaming==2&&this.id==1?2:this.id-1]
						if(inputSet[0]){
				...
				case 352:
					...
					if(a==0&&this.time>15&&this.active){
						let id=((game.level==27||game.level==38||teamMode())&&game.pvp?this.index+1:this.id)
						let inputSet=this.id==0||id>game.gaming?[game.det[id]==0]:inputs.release[game.gaming==1?1:id-1]
						if(inputSet[0]){
							this.active=false
							this.explode()
						}
				...
				if(
					(
						...
						(
							...
							this.type==9||this.type==10||this.type==11||this.type==38||this.type==63||
							this.type==72||this.type==82||this.type==155||this.type==194||this.type==216&&entities.players[b].life<entities.players[b].base.life*2||
							this.type==273||(this.type==339||this.type==369)&&entities.players[b].construct&&entities.players[b].id==this.id||this.type==345||this.type==350||this.type==357&&entities.players[b].life<=entities.players[b].base.life*1.25||
							this.type==364||this.type==378||this.type==396||this.type==398||this.type==409||this.type==418
						)&&
					...
					!((this.type==91||this.type==92||this.type==93||this.type==96||this.type==108||this.type==192||this.type==203||this.type==204||this.type==207||this.type==208||this.type==237||this.type==238||this.type==239||this.type==275||this.type==296||this.type==302||this.type==306||this.type==420)&&this.hit.includes(entities.players[b].index))&&
					...
					if((this.type==9||this.type==155||this.type==216||this.type==396)&&((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id&&this.index!=entities.players[b].index||this.id==entities.players[b].id&&this.type==216)){
						...
						entities.players[b].life=min(entities.players[b].life+this.damage*3*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*2))
					...
					}else if((this.type==194||this.type==398)&&((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id)){
						if(!entities.players[b].fort){
							entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125))*(this.index==entities.players[b].index?0.1:1),max(entities.players[b].life,entities.players[b].base.life*2))
						}
					}else if(this.type==418&&((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id&&this.index!=entities.players[b].index)){
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*3))
					}else if(this.type==6||this.type==15||this.type==33||this.type==74||this.type==75||this.type==81||this.type==276){
						...
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*5))
					}else if(this.type==339&&entities.players[b].construct&&entities.players[b].id==this.id){
						entities.players[b].life=min(entities.players[b].life+this.damage,max(entities.players[b].life,entities.players[b].base.life*2))
						...
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125))*0.8,max(entities.players[b].life,entities.players[b].base.life*1.5))
						...
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*2))
						entities.players[b].speedBuff=max(entities.players[b].defendBuff,480)
					}else if(this.type==357&&((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id&&this.index!=entities.players[b].index||this.id==entities.players[b].id&&this.type==216)){
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125))*1.4,max(entities.players[b].life,entities.players[b].base.life*1.5))
					}else if(this.type==364&&((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id&&this.index!=entities.players[b].index||this.id==entities.players[b].id&&this.type==216)){
						entities.players[b].life=min(entities.players[b].life+this.damage*(min(2,entities.players[b].base.life/125))*0.9,max(entities.players[b].life,entities.players[b].base.life*1.75))
						entities.players[b].weapon.cooldown=max(entities.players[b].weapon.cooldown-60,0)
						entities.players[b].subWeaponA.cooldown=max(entities.players[b].subWeaponA.cooldown-60,0)
						entities.players[b].weapon.reload=max(entities.players[b].weapon.reload-60,0)
						...
						entities.players[b].takeDamage(this.damage*(entities.players[b].life>=1000&&!(entities.players[b].fort&&entities.players[b].id>0&&!game.pvp)?1.5:entities.players[b].life>=500&&!(entities.players[b].fort&&entities.players[b].id>0&&!game.pvp)?1.25:1))
					}else if(this.type==388){
						entities.players[b].takeDamage(this.damage*(entities.players[b].life>=1000&&!(entities.players[b].fort&&entities.players[b].id>0&&!game.pvp)?2:entities.players[b].life>=500&&!(entities.players[b].fort&&entities.players[b].id>0&&!game.pvp)?1.5:1))
					}else if(
						this.exploder&&this.type!=389
					){
						if(this.type==41||this.type==97||this.type==98||this.type==121||this.type==146||this.type==353||this.type==412){
							...
							entities.players[b].takeDamage(this.damage*0.5)
						}
						this.explode()
					}else if((this.type==111||this.type==134||this.type==182||this.type==373)&&entities.players[b].id>0){
						entities.players[b].takeDamage(this.damage*0.2)
					}else if(this.type==138){
						entities.players[b].takeDamage(this.damage/30)
						...
						entities.players[b].gasser=this.index
					}else if(this.type==341||this.type==343||this.type==354||this.type==414){
						entities.players[b].takeDamage(this.damage*max(1,1.2-this.timer*0.025))
					}else if(this.rules.fast&&this.type!=409||this.type==342){
						entities.players[b].takeDamage(this.damage*min(1,0.5+this.timer*0.125))
						...
						entities.players[b].takeDamage(this.damage*(1+this.timer/15))
					...
					}else if(this.type==398&&entities.players[b].fort&&!entities.players[b].auto){
						...
						if(((this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp&&this.id!=-1&&entities.players[b].id!=-1||this.id==entities.players[b].id&&this.index!=entities.players[b].index||this.id==entities.players[b].id&&this.type==216)){
							entities.players[b].life=min(entities.players[b].life+this.damage*this.travel/400*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*2))
						}else{
							entities.players[b].takeDamage(this.damage*this.travel/400)
						}
					}else if(this.type==411){
						entities.players[b].takeDamage(this.damage*max(1,1.25-this.timer*0.03125))
					}else{
						entities.players[b].takeDamage(this.damage)
					}
					if(entities.players[b].life>base){
						for(let d=0,ld=entities.players.length;d<ld;d++){
							if(entities.players[d].index==this.index){
								entities.players[d].stats.damage+=(entities.players[b].life-base)*0.25
							}
						}
					}
					switch(this.type){
						case 13:
							...
							entities.players[b].subWeaponA.cooldown=min(entities.players[b].subWeaponAData.cooldown+15,entities.players[b].subWeaponA.cooldown+15)
						break
						case 36: case 249:
							for(let d=0,ld=entities.players.length;d<ld;d++){
								if(entities.players[d].index==this.index){
						...
						case 407:
							for(let d=0,ld=entities.players.length;d<ld;d++){
								...
								if(b!=d&&entities.players[d].explodable()&&entities.players[d].life>0&&e<60&&((this.id==0?1:0)!=(entities.players[d].id==0?1:0)||this.id==-1||entities.players[d].id==-1||game.pvp&&(this.id!=entities.players[d].id||!teamMode()))){
						...
						case 419:
							for(let d=0,ld=entities.players.length;d<ld;d++){
								if(entities.players[d].index==this.index){
									entities.players[d].life=min(entities.players[d].life+entities.players[d].base.life,max(entities.players[d].life,entities.players[d].base.life*2))
								}
							}
						break
						case 420:
							for(let d=0,ld=entities.players.length;d<ld;d++){
								if(entities.players[d].index==this.index){
									entities.players[d].position.x=entities.players[b].position.x
									entities.players[d].position.y=entities.players[b].position.y+entities.players[b].height/2-entities.players[d].height/2
								}
							}
						break
						case 421:
							...
							if(entities.players[b].life<=0&&entities.players[b].playerData.sizeBuff>1){
								for(let d=0,ld=entities.players.length;d<ld;d++){
									if(entities.players[d].index==this.index){
					...
					if(!entities.players[b].immune()){
						switch(this.type){
							...
							case 40:
								...
								entities.players[b].subWeaponA.cooldown=min(entities.players[b].subWeaponAData.cooldown+60,entities.players[b].subWeaponA.cooldown+60)
							break
							...
							break
							case 94:
								entities.players[b].stunTime=max(entities.players[b].stunTime,this.id==0?120:600)
							break
							case 99:
							...
							break
							case 222: case 374:
								entities.players[b].velocity.x+=lsin(this.direction)*8
								entities.players[b].velocity.y-=lcos(this.direction)*8
								entities.players[b].lastingForce[0]+=lsin(this.direction)*4
								entities.players[b].lastingForce[1]-=lcos(this.direction)*4
							break
							case 223:
							...
							break
							case 343:
								entities.players[b].velocity.x+=this.speed*lsin(this.direction)*0.9
								entities.players[b].velocity.y-=this.speed*lcos(this.direction)*0.9
							break
							case 371:
								entities.players[b].velocity.x+=lsin(this.direction)*8
								entities.players[b].velocity.y-=lcos(this.direction)*8
							...
							break
							case 388:
								entities.players[b].weapon.cooldown=min(entities.players[b].weaponData.cooldown+10,entities.players[b].weapon.cooldown+10)
								entities.players[b].subWeaponA.cooldown=min(entities.players[b].subWeaponAData.cooldown+10,entities.players[b].subWeaponA.cooldown+10)
							break
							case 317:
							...
							break
							case 338:
								entities.players[b].gasTime=max(900,entities.players[b].gasTime+600)
								entities.players[b].gasser=this.index
							break
							case 346:
								entities.players[b].chillTime=max(entities.players[b].chillTime,240)
							break
							case 412:
								entities.players[b].gasTime=max(5,entities.players[b].gasTime+3)
								entities.players[b].gasser=this.index
							break
							case 423:
								entities.players[b].velocity.x+=this.speed*lsin(this.direction)*1.8
							...
							break
							case 424:
								entities.players[b].velocity.x+=lsin(this.direction)*10
								entities.players[b].velocity.y-=lcos(this.direction)*10
						...
						switch(this.type){
							...
							case 298: case 324:
								entities.players[b].DOT.damage+=this.damage/120
								entities.players[b].DOT.active=max(240,entities.players[b].DOT.active+120)
							break
							case 327:
								entities.players[b].DOT.damage+=this.damage/60
		...
		if(this.drone&&this.timer%30==0){
			if(
				this.check.length>=4&&
				dist(this.position.x,this.position.y,this.check[this.check.length-1][0],this.check[this.check.length-1][1])<10&&
				dist(this.position.x,this.position.y,this.check[this.check.length-2][0],this.check[this.check.length-2][1])<10&&
				dist(this.position.x,this.position.y,this.check[this.check.length-3][0],this.check[this.check.length-3][1])<10&&
				dist(this.position.x,this.position.y,this.check[this.check.length-4][0],this.check[this.check.length-4][1])<10
			){
				this.active=false
			}
