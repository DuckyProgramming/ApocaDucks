class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index,args=[]){
		...
		if(game.hitscan){
			...
			switch(this.type){
				...
				case 440: case 441: case 442: case 454: case 456: case 459: case 460: case 461: case 465: case 492:
		...
		switch(this.type){
			...
			case 362: case 378: case 379: case 430: case 445: case 489:
				this.speed=5
				this.time=time
			break
			...
			case 508: case 509: case 512: case 514: case 515: case 518: case 519: case 520:
				...
				size=this.type==97||this.type==134||this.type==138||this.type==162||this.type==163||this.type==164||this.type==165||this.type==233||this.type==243||this.type==252||
					...
					this.type==157||this.type==171||this.type==249||this.type==260||this.type==261||this.type==272||this.type==328||this.type==356||this.type==373||this.type==402||
					this.type==501?8:
					4
				this.width=size
				this.height=size
				this.speed=
					this.type==389?4+min(6,time/30):
					this.type==376||this.type==463||this.type==464||this.type==493||this.type==501||this.type==520?10:
					this.type==356?8:
					this.type==344||this.type==360?12:
					this.type==210?0:
					this.type==209?random(8,10):
					this.type==447?6.6:
					this.type==474||this.type==475||this.type==484||this.type==512||this.type==518?15:
				...
				this.velocity={x:this.speed*lsin(this.direction),y:this.speed*lcos(this.direction)-
					(
						this.type==474||this.type==475||this.type==484||this.type==512||this.type==518?3:
						...
						this.type==240||this.type==283||this.type==301||this.type==311||this.type==312||this.type==376||this.type==437||this.type==463||this.type==464||this.type==490||
						this.type==495||this.type==496||this.type==499||this.type==500||this.type==520?0:
						this.type==344||this.type==404||this.type==447||this.type==493?5:
						4
					)
				}
				this.goal=-1
				switch(this.type){
					case 135: case 136: case 169: case 170: case 311: case 312: case 463: case 464:
						this.effectiveDirection=this.direction
						this.twistMult=1
					break
					case 120: case 177: case 178: case 179: case 180:
					case 182: case 183: case 210: case 227: case 271:
					case 318:
					...
					break
					case 111: case 118: case 119: case 121: case 122:
					case 123: case 124: case 128: case 129: case 132:
					case 134: case 137: case 138: case 139: case 140:
					case 141: case 142: case 143: case 144: case 157:
					case 158: case 159: case 160: case 161: case 162:
					case 163: case 164: case 165: case 168: case 171:
					case 172: case 184: case 200: case 211: case 233:
					case 248: case 252: case 259: case 260: case 261:
					case 268: case 272: case 283: case 295: case 301:
					case 328: case 373: case 404: case 437:
						for(let a=0,la=entities.players.length;a<la;a++){
					...
					break
					case 119: case 121: case 132: case 200:
					...
					case 209: case 201: case 216: case 220: case 221:
					case 243: case 245: case 246: case 247: case 250:
					case 263: case 284: case 286: case 304: case 314:
					case 323: case 329: case 349: case 360: case 368:
					case 372: case 375: case 392: case 417: case 435:
					case 438: case 448: case 509: case 514: case 519:
						...
						if(this.type==117||this.type==245||this.type==246||this.type==247){
							...
							this.delay=0
						}else if(this.type==375||this.type==519){
							this.fail=false
				...
				if(this.rules.stickybomb){
					...
					let lim=this.type==392||this.type==509?9:this.type==372?10:this.type==368?3:4
					let ct=0
			...
			break
			case 6: case 33: case 79: case 81: case 109: case 152: case 189: case 321: case 386: case 387:
			case 388: case 422:
			...
			case 7: case 23: case 37: case 40: case 46: case 76: case 77:
				...
				this.time=5
			break
			case 15: case 74: case 75: case 222: case 223: case 287: case 288: case 371: case 449: case 479:
				this.speed=random(3,5)*1.25
				this.time=random(time,time*2)
				this.width*=4
				this.height*=4
				this.classification.flame=true
			...
			case 25:
				...
				this.time=15
			break
			case 26: case 53: case 54: case 58: case 307: case 506:
				this.speed=3
				this.time=time
			break
			case 28: case 359: case 366: case 383: case 412: case 431: case 473: case 485: case 521:
				size=this.type==485?6:2
				this.width=size
				this.height=size
				this.speed=this.type==485?8:this.type==366?12:10
				this.time=time*(this.id==0?0.6:1)
				this.bounces=0
				this.bounceTimer=0
				this.previous={position:{x:this.position.x,y:this.position.y}}
				...
				this.velocity={x:this.speed*lsin(this.direction),y:this.speed*lcos(this.direction)-(this.type==366?3:4)}
				if(this.type==366){
					this.travel=0
				}
			break
			...
			case 71:
				...
				this.time=random(time,time*2)
			break
			case 80: case 85: case 215: case 337:
				this.speed=1.5
				this.time=time
			break
			...
			break
			case 133: case 148: case 149: case 230: case 262: case 320:
				this.speed=2
				this.time=time
			break
			case 147: case 244: case 258: case 285: case 289: case 290: case 291: case 296: case 410: case 453:
				this.speed=16
				this.time=time
				this.midpoint={position:{x:this.position.x,y:this.position.y}}
				this.past=[
			...
			case 486: case 487: case 488: case 491:
						...
						for(let b=0,lb=bound.length;b<lb;b++){
							if(intersect(this.position,extend,bound[b][0],bound[b][1])){
								...
								if(dist(this.position.x,this.position.y,point.x,point.y)==this.extent){
									...
									if(this.hitscanConvert){
										this.timer=this.extent/4/this.transverse
										let type=this.type
										...
										switch(this.type){
											...
											break
											case 415:
												c.takeDamage(this.damage*(c.fort?2:1)*constrain(1.8-this.extent/1500,0.2,1))
											break
											case 455:
												if(c.id==this.id){
													...
													c.takeDamage(this.damage*constrain(1.8-this.extent/1500,0.2,1))
												}
												this.remove=true
											break
											case 477: case 486: case 487: case 491:
												c.takeDamage(this.damage)
											break
											case 478:
												c.takeDamage(this.damage*max(1,1.2-this.extent/4/this.transverse*0.025))
											break
											case 488:
												c.takeDamage(this.damage*(c.fort||c.construct||c.rules.tank?5:1))
											break
											default:
												c.takeDamage(this.damage*constrain(1.8-this.extent/1500,0.2,1))
											break
										...
										if(this.type==190&&!c.fort){
											...
											c.knockbackForce(this.speed*2,this.direction,1,1)
											if(!c.immune()){
												c.dizzyTime=max(c.dizzyTime,30)
											}
											this.remove=true
				...
				switch(this.type){
					case 406:
						...
						this.position.x+=lsin(this.direction)*this.extent
						this.position.y-=lcos(this.direction)*this.extent
						this.explode()
						this.position.x-=lsin(this.direction)*this.extent
						this.position.y+=lcos(this.direction)*this.extent
					break
					case 477: case 478:
						this.deviation=random(40,100)
					break
				}
			break
			case 192:
			...
			case 369:
				...
				this.speed=random(2.4,4)
				this.time=random(time,time*1.5)
			break
			case 370: case 469:
				this.speed=5
				this.time=time
    ...
    display(layer,offsetX=0,offsetY=0){
        ...
        switch(this.type){
			...
			break
			case 30: case 311: case 312: case 450:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
				layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
			...
			case 284:
				...
				layer.ellipse(0,0,6)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.fill(233-this.crit*180,181+this.crit*60,121+this.crit*120,this.fade*min(1,this.timer/90))
				layer.ellipse(0,0,4)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,360-this.fade*360)
			...
			case 286:
				...
				layer.ellipse(0,0,6)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.fill(101-this.crit*100,240,236,this.fade*min(1,this.timer/90))
				layer.ellipse(0,0,4)
			break
			case 287:
			...
			break
			case 321:
				layer.fill(160-this.crit*160,200,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(160-this.crit*160,150+this.crit*50,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			break
			case 322:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 324:
				...
				layer.ellipse(0,0,4)
				layer.fill(100,250,100,this.fade)
				layer.arc(0,0,3,3,-90,90)
				layer.fill(250,100,250,this.fade)
				layer.arc(0,0,3,3,90,270)
			break
			case 325:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.rect(0,4,1,8)
				...
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(250,0,0,this.fade*0.2)
				layer.ellipse(0,0,9)
				layer.ellipse(0,0,7)
				layer.ellipse(0,0,5)
				layer.fill(250,this.fade)
			...
			case 326:
				...
				layer.fill(240-this.crit*200,this.crit*240,this.crit*240,this.fade)
				layer.ellipse(0,0,4,10)
				layer.ellipse(0,0,8,4)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade*6-5)
					layer.ellipse(0,0,180-(this.fade*6-5)*180)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade*6-5)
					layer.ellipse(0,0,120-(this.fade*6-5)*120)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade*6-5)
					layer.ellipse(0,0,60-(this.fade*6-5)*60)
				}
			break
			case 327:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 329:
				...
				layer.ellipse(0,0,6)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.fill(149-this.crit*140,219+this.crit*20,186+this.crit*60,this.fade*min(1,this.timer/90))
				layer.ellipse(0,0,4)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,360-this.fade*360)
			...
			case 330:
				...
				layer.noStroke()
				layer.fill(125,175,225,this.fade)
				layer.ellipse(60*lsin(this.time),60*lcos(this.time),8)
				layer.ellipse(-60*lsin(this.time),-60*lcos(this.time),8)
				layer.ellipse(60*lcos(this.time),-60*lsin(this.time),8)
				layer.ellipse(-60*lcos(this.time),60*lsin(this.time),8)
				layer.ellipse(60*lsin(this.time+10),60*lcos(this.time+10),8)
				layer.ellipse(-60*lsin(this.time+10),-60*lcos(this.time+10),8)
			...
			case 336:
				...
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(50,100,150,this.fade*0.8)
					layer.ellipse(0,0,30-this.fade*30)
				}
			break
			case 337:
				...
				layer.fill(80,120,60,this.fade)
				layer.ellipse(0,0,20)
				regStar(layer,0,0,5,24,24,15,15,this.position.x+this.position.y)
				regStar(layer,0,0,5,15,15,30,30,this.position.x+this.position.y)
				layer.fill(80,120,60,this.fade)
				layer.ellipse(0,0,10)
				regStar(layer,0,0,5,16,16,10,10,this.position.x+this.position.y)
				regStar(layer,0,0,5,10,10,20,20,this.position.x+this.position.y)
			break
			case 338:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.rect(0,4,1,8)
				...
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(30,150,30,this.fade)
				layer.ellipse(0,0,4)
				layer.fill(240,40,40,this.fade)
				layer.ellipse(0,0,2)
			break
			case 339:
				...
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(100,200,250,this.fade)
				layer.rect(0,4,2,2)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
			break
			...
			case 344:
				...
				layer.rect(0,0,3)
				for(let a=0,la=3;a<la;a++){
					layer.triangle(-0.5,-1,0.5,-1,0,-3)
					layer.rotate(120)
				}
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 346:
				...
				layer.fill(160-this.crit*160,160,160,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(160,200,200,this.fade)
				layer.ellipse(0,0,3)
			break
			case 347:
				layer.fill(40,240,40+this.crit*200,this.fade)
				...
				layer.fill(40,80,40+this.crit*200,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(200,175,200,this.fade)
				layer.quad(-4,0,0,-1,1,0,0,4)
				layer.fill(150,250,150,this.fade)
				layer.ellipse(0,0,3)
			break
			case 348: case 408:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
				layer.fill(250,150,255,this.fade)
				layer.ellipse(0,0,3,1.5)
			break
			case 349:
				layer.rotate(-this.direction)
				if(this.stopAnim>0){
				...
				if(this.timer>30&&this.timer<35){
					...
					layer.ellipse(0,0,6+(this.timer-30)*4)
				}
				if(this.timer>40&&this.timer<45){
					...
					layer.ellipse(0,0,6+(this.timer-40)*4)
				}
				/*if(this.timer>435&&this.timer<440){
					layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*(1-(this.timer-35)/5))
					layer.ellipse(0,0,6+(this.timer-35)*4)
				}*/
				layer.fill(250,this.fade)
				layer.ellipse(0,0,6)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				//layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*min(1,this.timer/45))
				layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(192-this.fade*192)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(128-this.fade*128)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(64-this.fade*64)*(this.fail?0.25:1))
				}
			break
			case 350:
				layer.fill(240-this.crit*200,120+this.crit*200,240+this.crit*40,this.fade)
			...
			case 351:
				...
				layer.rect(0,2,1,4)
				layer.fill(240-this.crit*200,240+this.crit*200,40+this.crit*200,this.fade)
				layer.ellipse(0,0,5,16)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,195-this.fade*240)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,130-this.fade*160)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,65-this.fade*80)
				}
			break
			case 352:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 353:
				...
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,375-this.fade*375)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,250-this.fade*250)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,125-this.fade*125)
				}
			break
			case 354:
				layer.stroke(255-this.crit*200,150+this.crit*100,150+this.crit*100,this.fade)
			...
			case 356:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,13)
				layer.fill(250-this.crit*200,200,this.crit*250,this.fade)
				...
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,80+this.crit*200,this.fade)
					layer.ellipse(0,0,405-this.fade*405)
					layer.fill(240-this.crit*200,200,60+this.crit*200,this.fade)
					layer.ellipse(0,0,270-this.fade*270)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,135-this.fade*135)
				}
			...
			case 359: case 473:
				...
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,60+this.crit*200,this.fade)
					layer.ellipse(0,0,360-this.fade*360)
					layer.fill(240-this.crit*200,180,50+this.crit*200,this.fade)
					layer.ellipse(0,0,240-this.fade*240)
					layer.fill(240-this.crit*200,120,40+this.crit*200,this.fade)
					layer.ellipse(0,0,120-this.fade*120)
				}
			...
			case 360:
				...
				if(this.stopAnim>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2.5)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,5)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,7.5)
				}
				layer.fill(150,225,225,this.fade)
				regStar(layer,0,0,3,2.5,2.5,10,10,this.direction+this.position.x)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,7.5)
				//layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*min(1,this.timer/45))
				layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade)
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(300-this.fade*300)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(200-this.fade*200)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(100-this.fade*100)*(this.fail?0.25:1))
				}
			break
			case 361:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 366:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,160+this.crit*80,160+this.crit*80,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
				layer.fill(240-this.crit*200,120+this.crit*120,120+this.crit*120,this.fade)
				layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
				layer.fill(240-this.crit*200,80+this.crit*160,80+this.crit*160,this.fade)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(250-this.crit*200,140+this.crit*80,160+this.crit*80,this.fade)
				regStar(layer,0,0,5,9,9,3,3,this.timer)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,6)
				if(!this.active&&this.fade<1){
					layer.fill(250-this.crit*200,140+this.crit*80,160+this.crit*80,this.fade)
			...
			case 368:
				...
				if(this.stopAnim>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
					layer.fill(220-this.crit*200,200,40+this.crit*200,this.fade)
					layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
					layer.fill(200-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				}
				if(this.timer>30&&this.timer<35){
					layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*(1-(this.timer-30)/5))
				...
				layer.fill(240,220,0,this.fade)
				regStar(layer,0,0,3,1.5,1.5,8,8,this.direction+this.position.x)
				layer.fill(20,this.fade)
				regStar(layer,0,0,3,1.5,1.5,8,8,this.direction+60+this.position.x)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,6)
				//layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*min(1,this.timer/45))
				layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
			...
			break
			case 369:
				layer.fill(200-this.crit*200,80+this.crit*120+this.color*80,120+this.crit*120-this.color*40,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,40*(1-this.time/this.base.time))
				layer.fill(200-this.crit*200,120+this.crit*120+this.color*80,120+this.crit*120-this.color*40,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,20*(1-this.time/this.base.time))
			break
			case 370:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				...
				layer.rect(0,2,1,4)
				layer.fill(120,120+this.crit*200,120+this.crit*200,this.fade)
				layer.ellipse(0,0,4.8,15.2)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,186-this.fade*186)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,124-this.fade*124)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,62-this.fade*62)
				}
			break
			case 371:
				layer.fill(100-this.crit*100,160,60+this.crit*180,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(80-this.crit*80,120,20+this.crit*220,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			break
			case 372:
				layer.rotate(-this.direction)
				...
				layer.fill(240,135,30,this.fade)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.ellipse(0,0,6)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,5)
				layer.rotate(-this.direction-this.position.x)
				for(let a=0,la=3;a<la;a++){
					layer.rotate(120)
					layer.fill(255-this.crit*200,150+this.crit*100,150+this.crit*100,this.fade)
					layer.rect(0,-1.25,1,2.5)
					layer.fill(250,this.fade)
					layer.quad(-0.5,-5,0.5,-5,0.6,-4,-0.6,-4)
				}
				//layer.fill(160-this.crit*160,160+this.crit*80,160+this.crit*80,this.fade*min(1,this.timer/45))
				layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			break
			case 374:
				layer.fill(200-this.crit*200+this.color*40,240-this.color*40,240+this.crit*40,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(160-this.crit*160+this.color*40,200-this.color*40,200+this.crit*80,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			break
			case 375:
				layer.rotate(-this.direction)
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,10)
				regStar(layer,0,0,5,3,3,10,10,this.direction+this.position.x)
				layer.fill(0,this.crit*250,this.crit*250,this.fade)
			...
			case 376: case 520:
				...
				layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,2)
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,4)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,5)
				layer.fill(0,this.crit*250,this.crit*250,this.fade)
				layer.rect(0,0,2.5)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(135-this.fade*135)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(90-this.fade*90)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(45-this.fade*45)*(this.fail?0.25:1))
				}
			break
			case 377:
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,300-this.fade*300)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
			...
			break
			case 378:
				layer.fill(40-this.crit*40,240,40+this.crit*200,this.fade)
				layer.rect(0,4,1,8)
				layer.fill(40-this.crit*40,160,40+this.crit*200,this.fade)
				layer.rect(0,3,1,6)
				layer.fill(40-this.crit*40,80,40+this.crit*200,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(120-this.crit*120,240,120+this.crit*200,this.fade)
				layer.ellipse(0,0,4,12)
				if(!this.active&&this.fade<1){
					layer.fill(120-this.crit*120,240,120+this.crit*200,this.fade)
					layer.ellipse(0,0,150-this.fade*150)
					layer.fill(80-this.crit*80,240,80+this.crit*200,this.fade)
					layer.ellipse(0,0,100-this.fade*100)
					layer.fill(40-this.crit*40,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,50-this.fade*50)
				}
			...
			case 382:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
				layer.stroke(250,225,25,this.fade)
				layer.strokeWeight(1)
				layer.line(1,1,-1,-1)
			break
			case 383:
				...
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(100,255,0,this.fade*0.5)
				layer.ellipse(0,0,10)
				layer.fill(250,this.fade)
				regPoly(layer,0,0,16,4,4,0)
			...
			case 384: case 466:
				...
				layer.rect(0,3,1,6)
				layer.fill(160-this.crit*120,160,160,this.fade)
				layer.rect(0,2,1,4)
				layer.fill(250,this.fade*0.5)
				layer.ellipse(0,0,6,20)
				layer.ellipse(0,0,5,16)
				layer.fill(120,120+this.crit*200,120+this.crit*200,this.fade)
				layer.ellipse(0,0,4,12)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,160+this.crit*200,this.fade)
					layer.ellipse(0,0,240-this.fade*240)
					layer.fill(240-this.crit*200,160,140+this.crit*200,this.fade)
					layer.ellipse(0,0,160-this.fade*160)
					layer.fill(240-this.crit*200,80,120+this.crit*200,this.fade)
					layer.ellipse(0,0,80-this.fade*80)
				}
			break
			case 385:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade*5)
				layer.rect(0,4,1,8)
				layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade*5)
				layer.rect(0,3,1,6)
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade*5)
				layer.rect(0,2,1,4)
				...
				layer.ellipse(0,0,2.5)
				layer.noStroke()
				if(!this.active&&this.fade<0.2){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade*5)
					layer.ellipse(0,0,240-(this.fade*5)*240)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade*5)
					layer.ellipse(0,0,160-(this.fade*5)*160)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade*5)
					layer.ellipse(0,0,80-(this.fade*5)*80)
				}
				if(!this.active&&this.fade>=0.8&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade*5-4)
					layer.ellipse(0,0,240-(this.fade*5-4)*240)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade*5-4)
					layer.ellipse(0,0,160-(this.fade*5-4)*160)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade*5-4)
					layer.ellipse(0,0,80-(this.fade*5-4)*80)
				}
			break
			case 386:
				layer.rotate(this.position.y*14+this.time*6)
				layer.fill(240-this.crit*200,120,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.quad(-10*(1-this.time/this.base.time),0,0,-40*(1-this.time/this.base.time),10*(1-this.time/this.base.time),0,0,40*(1-this.time/this.base.time))
				layer.fill(240-this.crit*200,180,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
				layer.quad(-5*(1-this.time/this.base.time),0,0,-20*(1-this.time/this.base.time),5*(1-this.time/this.base.time),0,0,20*(1-this.time/this.base.time))
			break
			case 387:
				layer.fill(240-this.crit*200,120,this.crit*200,this.fade*this.time/this.base.time*0.5)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(240-this.crit*200,180,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			break
			case 388:
				layer.fill(150,250,250,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,50*(1-this.time/this.base.time))
				layer.fill(250-this.crit*100,250-this.crit*100,250,this.fade*this.time/this.base.time*0.5)
				layer.ellipse(0,0,40*(1-this.time/this.base.time))
			break
			case 389:
				layer.rotate(-this.direction)
			...
			case 392: case 509:
				...
				if(this.stopAnim>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,5/3)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,10/3)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,5)
				}
				if(this.timer>30&&this.timer<35){
					layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*(1-(this.timer-30)/5))
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,4)
				regStar(layer,0,0,3,1,1,6,6,this.direction+this.position.x)
				switch(this.tick){
					case 0:
						layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
						//layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*min(1,this.timer/45))
					break
					case 1:
						layer.fill(...[[100-this.crit*50,225,75+this.crit*175],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
						//layer.fill(100-this.crit*50,225,75+this.crit*175,this.fade*min(1,this.timer/45))
					break
					case 2:
						layer.fill(...[[75-this.crit*25,100+this.crit*125,225+this.crit*25],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
						//layer.fill(75-this.crit*25,100+this.crit*125,225+this.crit*25,this.fade*min(1,this.timer/45))
					break
				}
				layer.ellipse(0,0,3)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(150-this.fade*150)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(100-this.fade*100)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(50-this.fade*50)*(this.fail?0.25:1))
				}
			break
			case 396:
				layer.fill(40,240,40+this.crit*200,this.fade)
				...
				layer.rect(0,2,1,4)
				layer.fill(150,250,150,this.fade)
				layer.ellipse(0,0,2+lsin(this.timer*12)*1.5)
			break
			case 398:
				layer.stroke(255-this.crit*150,255,200+this.crit*50,this.fade)
				layer.strokeWeight(4)
				layer.noFill()
				layer.ellipse(0,0,72)
				for(let a=0,la=this.shocks.length;a<la;a++){
					layer.stroke(255-this.crit*150,255,200+this.crit*50,this.fade*this.shocks[a][2])
					layer.line(
						lsin(this.shocks[a][0])*36,
						lcos(this.shocks[a][0])*36,
						0,0
					)
					layer.line(
						lsin(this.shocks[a][1])*36,
						lcos(this.shocks[a][1])*36,
						0,0
					)
				}
			break
			case 402:
				...
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(200,this.fade)
				layer.rotate(this.time*8)
				for(let a=0,la=3;a<la;a++){
					layer.quad(-2,0,0,-12,2,0,0,12)
					layer.rotate(120)
				}
				layer.rotate(this.time*-8)
				layer.fill(250,this.fade)
			...
			case 403:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
				layer.fill(50,255,255,this.fade)
				layer.ellipse(0,0,3,1.5)
			break
			case 404:
				layer.rotate(-this.direction)
				layer.fill(250,this.fade)
				for(let a=0,la=this.past.length-1;a<la;a++){
					let w1=map(a,0,la+1,1,6)
					let w2=map(a+1,0,la+1,1,6)
					let an=atan2(this.past[a+1][0]-this.past[a][0],this.past[a+1][1]-this.past[a][1])
					let dx1=lcos(an)*w1/2
					let dy1=lsin(an)*w1/2
					let dx2=lcos(an)*w2/2
					let dy2=lsin(an)*w2/2
					layer.quad(
						this.past[a][0]-this.position.x+dx1,this.past[a][1]-this.position.y-dy1,
						this.past[a][0]-this.position.x-dx1,this.past[a][1]-this.position.y+dy1,
						this.past[a+1][0]-this.position.x-dx2,this.past[a+1][1]-this.position.y+dy2,
						this.past[a+1][0]-this.position.x+dx2,this.past[a+1][1]-this.position.y-dy2
					)
				}
				for(let a=0,la=12;a<la;a++){
					layer.fill(100,200,100+this.crit*150,this.fade*0.1)
					layer.ellipse(0,0,22-a)
				}
				layer.fill(250,this.fade)
				layer.ellipse(0,0,10)
				layer.stroke(250,this.fade)
			...
			break
			case 406:
				layer.stroke(160-this.crit*160,40+this.crit*200,240,this.fade*5-4)
				layer.strokeWeight(1.8)
				layer.line(0,4,0,-this.extent)
				layer.stroke(160-this.crit*160,40+this.crit*120,160+this.crit*80,this.fade*5-4)
				layer.strokeWeight(1.5)
				layer.line(0,4,0,-this.extent)
				layer.stroke(160-this.crit*160,40,80+this.crit*160,this.fade*5-4)
				layer.strokeWeight(1.2)
				layer.line(0,4,0,-this.extent)
				layer.stroke(250,this.fade)
				...
				layer.ellipse(0,-this.extent,(150-this.fade*150))
				layer.fill(240-this.crit*200,100,120+this.crit*120,this.fade)
				layer.ellipse(0,-this.extent,(100-this.fade*100))
				layer.fill(240-this.crit*200,40,120+this.crit*120,this.fade)
				layer.ellipse(0,-this.extent,(50-this.fade*50))
			break
			case 407:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.rect(0,12,1,24)
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3,4)
				layer.triangle(-0.5,-1,0.5,-1,0,-2.5)
			break
			case 409:
				layer.fill(40,240,40+this.crit*200,this.fade)
				layer.rect(0,8,1,16)
			...
			case 410:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,1.3125)
				layer.fill(240-this.crit*200,120,40+this.crit*200,this.fade)
				layer.ellipse(this.past[6][0]-this.position.x,this.past[6][1]-this.position.y,2.625)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,4.375)
			break
			case 411:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.rect(0,4,1.5,8)
			...
			case 414: case 451: case 476: case 511:
				...
				layer.ellipse(0,0,3)
				layer.ellipse(-1.5,0,1.5)
				layer.stroke(200,50,50,this.fade)
				layer.strokeWeight(1)
				layer.line(-1,-1,1,1)
			break
			case 416:
			...
			case 417:
				...
				layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
				layer.ellipse(-1,0,2)
				layer.fill(...[[225-this.crit*175,75+this.crit*150,100+this.crit*150],[200,200,200],[150,150,150]][this.timer>35||this.timer>=30&&this.timer<33?(this.dets>1?0:2):1],this.fade)
				layer.ellipse(1,0,2)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade*0.8)
					layer.ellipse(0,0,(192-this.fade*192)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade*0.8)
					layer.ellipse(0,0,(128-this.fade*128)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade*0.8)
					layer.ellipse(0,0,(64-this.fade*64)*(this.fail?0.25:1))
				}
				if(this.detTimer>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.detTimer*0.08)
					layer.ellipse(0,0,(192-this.detTimer*19.2)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.detTimer*0.08)
					layer.ellipse(0,0,(128-this.detTimer*12.8)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.detTimer*0.08)
					layer.ellipse(0,0,(64-this.detTimer*6.4)*(this.fail?0.25:1))
				}
			break
			case 418:
				layer.fill(40,240,40+this.crit*200,this.fade)
			...
			case 421:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3,4)
				layer.quad(-0.5,-2.5,0,0,0.5,-2.5,0,-3)
			break
			case 422:
				layer.fill(200-this.crit*200,160,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(160-this.crit*160,150+this.crit*50,this.crit*200,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			break
			...
			case 425:
				...
				layer.vertex(-3,-2.7)
				layer.vertex(-3,2.7)
				layer.bezierVertex(-4.25,1.2,-4.25,-1.2,-3,-2.7)
				layer.endShape()
				layer.beginShape()
				layer.vertex(3,-2.7)
				layer.vertex(3,2.7)
			...
			case 431:
				...
				layer.fill(250,this.fade)
				regPoly(layer,0,0,16,4,4,0)
				layer.rotate(this.position.x*3)
				layer.stroke(225-this.crit*175,75+this.crit*175,75+this.crit*175,this.fade)
				layer.strokeWeight(1)
				layer.noFill()
			...
			case 433: case 481:
				...
				layer.ellipse(0,0,120)
				for(let a=0,la=this.shocks.length;a<la;a++){
					layer.stroke(255-this.crit*150,255,100+this.crit*150,this.fade*this.shocks[a].fade)
					for(let b=0,lb=this.shocks[a].branches.length;b<lb;b++){
						layer.line(
							this.shocks[a].branches[b].origin[0],
							this.shocks[a].branches[b].origin[1],
							this.shocks[a].branches[b].end[0],
							this.shocks[a].branches[b].end[1]
						)
					}
				}
			break
			...
			case 441:
				...
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.rect(0,2,0.5,4)
				layer.fill(255,175,100,this.fade)
				layer.rect(-1,0,1,0,0,3)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
				layer.fill(255,175,100,this.fade)
			...
			case 445:
				...
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,195-this.fade*195)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,130-this.fade*130)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
			...
			case 447: case 475:
				...
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
				layer.fill(200-this.crit*180,200,40+this.crit*200,this.fade)
				layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
				layer.fill(160-this.crit*160,160,40+this.crit*200,this.fade)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,8)
				layer.fill(250-this.crit*200,this.crit*200,this.crit*200,this.fade)
				layer.quad(0,0,-0.5,-1.5,0,-3,0.5,-1.5)
				layer.quad(0,0,-0.5,1.5,0,3,0.5,1.5)
				layer.fill(250-this.crit*200,250,this.crit*200,this.fade)
				layer.quad(0,0,-1.5,-0.5,-3,0,-1.5,0.5)
				layer.quad(0,0,1.5,-0.5,3,0,1.5,0.5)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,200,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(270-this.fade*270)*(this.fail?0.5:1))
					layer.fill(200-this.crit*180,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(180-this.fade*180)*(this.fail?0.5:1))
					layer.fill(160-this.crit*160,120,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(90-this.fade*90)*(this.fail?0.5:1))
				}
			break
			case 448:
				...
				if(this.stopAnim>0){
					layer.fill(240-this.crit*200,240,240,this.fade)
					layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
					layer.fill(240-this.crit*200,220,220,this.fade)
					layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
					layer.fill(240-this.crit*200,200,200,this.fade)
					layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				}
				if(this.timer>30&&this.timer<35){
					layer.fill(225-this.crit*175,225+this.crit*25,225+this.crit*25,this.fade*(1-(this.timer-30)/5))
					layer.ellipse(0,0,6+(this.timer-30)*4)
				}
				if(this.timer>45&&this.timer<50){
					layer.fill(225-this.crit*175,225+this.crit*25,225+this.crit*25,this.fade*(1-(this.timer-35)/5))
					layer.ellipse(0,0,6+(this.timer-45)*4)
				}
				layer.fill(250,this.fade)
				layer.ellipse(0,0,6)
				regStar(layer,0,0,3,2,2,8,8,this.direction+this.position.x)
				layer.fill(...[[50,50,50+this.crit*200],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
				layer.ellipse(0,0,3)
				layer.fill(...[[250-this.crit*250,200-this.crit*150,200+this.crit*50],[200,200,200]][this.timer>35||this.timer>=30&&this.timer<33?0:1],this.fade)
				layer.ellipse(0,0,2)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,240,this.fade)
					layer.ellipse(0,0,(192-this.fade*192)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,240,this.fade)
					layer.ellipse(0,0,(128-this.fade*128)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,240,this.fade)
					layer.ellipse(0,0,(64-this.fade*64)*(this.fail?0.25:1))
				}
			break
			case 449:
				layer.fill(240-this.crit*200,240,200+this.crit*40,this.fade*this.time/this.base.time*0.25)
				layer.ellipse(0,0,90*(1-this.time/this.base.time))
				layer.fill(200-this.crit*200,240,200+this.crit*40,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,60*(1-this.time/this.base.time))
				layer.fill(160-this.crit*160,200,160+this.crit*80,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,30*(1-this.time/this.base.time))
			...
			case 452:
				...
				layer.fill(240,120,40,this.fade)
				layer.ellipse(0,0,5.5)
				layer.fill(240,200,40,this.fade)
				layer.ellipse(0,0,2.5)
			break
			case 453:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,240,120+this.crit*200,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,1.5)
				layer.fill(240-this.crit*200,180,120+this.crit*200,this.fade)
				layer.ellipse(this.past[6][0]-this.position.x,this.past[6][1]-this.position.y,3)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,10)
			break
			...
			case 459:
				...
				layer.fill(250,this.fade)
				layer.arc(0,0,3,3,-90,90)
				layer.rect(0,0.5,3,1)
			break
			case 460:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				layer.rect(0,6,0.5,12)
				layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
				layer.rect(0,4.5,0.5,9)
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.rect(0,3,0.5,6)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,3)
			...
			case 462:
				...
				//layer.fill(100,this.fade)
				layer.fill(250,this.fade)
				//layer.quad(0,-2,-2,0,0,2,2,0)
				layer.rotate(this.position.x*-8)
				layer.rect(0,0,2)
				if(!this.active&&this.fade<1){
					/*layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,222.5-this.fade*222.5)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,150-this.fade*150)
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,75-this.fade*75)*/
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,210-this.fade*210)
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,140-this.fade*140)
			...
			case 469:
				...
				if(!this.active&&this.fade<1){
					layer.stroke(255-this.crit*150,255,100+this.crit*150,this.fade)
					layer.strokeWeight(6-this.fade*6)
					layer.noFill()
					layer.ellipse(0,0,240-this.fade*240)
					layer.ellipse(0,0,160-this.fade*160)
					layer.ellipse(0,0,80-this.fade*80)
			...
			case 472:
				...
				layer.fill(250,this.fade)
				layer.ellipse(0,0,7.5)
				layer.fill(200-this.crit*160,180,240,this.fade)
				layer.ellipse(0,0,3,7.5)
				layer.ellipse(0,0,6,3)
				if(this.detTimer>0){
					layer.stroke(240-this.crit*240,240,240,this.detTimer*0.08)
					layer.ellipse(0,0,(150-this.detTimer*15)*(this.fail?0.25:1))
					layer.stroke(200-this.crit*200,200,200,this.detTimer*0.08)
					layer.ellipse(0,0,(100-this.detTimer*10)*(this.fail?0.25:1))
					layer.stroke(160-this.crit*160,160,160,this.detTimer*0.08)
					layer.ellipse(0,0,(50-this.detTimer*5)*(this.fail?0.25:1))
				}
			break
			case 474: case 518:
				...
				if(!this.active&&this.fade<1){
					...
					layer.ellipse(0,0,(90-this.fade*90)*(this.fail?0.5:1))*/
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(210-this.fade*210)*(this.fail?0.5:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(140-this.fade*140)*(this.fail?0.5:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(70-this.fade*70)*(this.fail?0.5:1))
				}
			break
			case 477: case 478:
				let color=this.rules.medTarget?[100,250,100+this.crit*150]:[250-this.crit*150,250-this.crit*50,250]
			...
			case 482: case 516:
				...
				layer.rect(0,3,1,6)
				layer.fill(160-this.crit*160,40,80+this.crit*160,this.fade)
				layer.rect(0,2,1,4)
			...
			case 483:
				...
				for(let a=0,la=this.shocks.length;a<la;a++){
					layer.stroke(255-this.crit*150,100+this.crit*150,100+this.crit*150,this.fade*this.shocks[a][2])
					layer.line(
						lsin(this.shocks[a][0])*32,
						lcos(this.shocks[a][0])*32,
						lsin(this.shocks[a][1])*16,
						lcos(this.shocks[a][1])*16
					)
				}
			break
			case 484:
				layer.rotate(-this.direction)
				layer.fill(100-this.crit*100,100+this.crit*100,100+this.crit*100,this.fade*2-1)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
				layer.fill(125-this.crit*100,125+this.crit*100,125+this.crit*100,this.fade*2-1)
				layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
				layer.fill(150-this.crit*100,150+this.crit*100,150+this.crit*100,this.fade*2-1)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(250,this.fade*2-1)
				layer.ellipse(0,0,8)
				layer.fill(250-this.crit*200,this.crit*200,this.crit*200,this.fade*2-1)
				layer.quad(0,0,-0.5,-1.5,0,-3,0.5,-1.5)
				layer.quad(0,0,-0.5,1.5,0,3,0.5,1.5)
				layer.fill(100-this.crit*100,100+this.crit*100,100+this.crit*100,this.fade*2-1)
				layer.quad(0,0,-1.5,-0.5,-3,0,-1.5,0.5)
			...
			case 485:
				...
				layer.ellipse(0,0,12)
				//layer.rotate(this.position.x*3)
				layer.rotate(this.position.x*2)
				layer.fill(225-this.crit*175,75+this.crit*175,75+this.crit*175,this.fade)
				layer.ellipse(0,-2.4,2,1)
				layer.ellipse(-1.5,-3.6,2,1)
				layer.ellipse(1.5,-3.6,2,1)
			break
			case 489:
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				...
				layer.ellipse(0,0,6,20)
				layer.ellipse(0,0,8)
				layer.stroke(255,this.fade*0.5)
				layer.strokeWeight(1)
				layer.arc(0,0,6,6,-75,-15)
				if(!this.active&&this.fade<1){
					layer.noStroke()
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,300-this.fade*300)
			...
			case 493:
				...
				layer.rect(0,0,4,5)
				layer.fill(250-this.crit*200,this.crit*200,this.crit*200,this.fade)
				layer.rect(-1.5,0,1,5)
				layer.rect(1.5,0,1,5)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(216-this.fade*216)*(this.fail?0.5:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(144-this.fade*144)*(this.fail?0.5:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(72-this.fade*72)*(this.fail?0.5:1))
				}
			break
			case 494:
				let fade494=2*this.fade-1
				layer.rotate(atan2(this.velocity.x,-this.velocity.y)-this.direction)
				layer.fill(240-this.crit*200,240,40+this.crit*200,fade494)
				layer.rect(0,6,1,12)
				layer.fill(240-this.crit*200,160,40+this.crit*200,fade494)
				layer.rect(0,4.5,1,9)
				layer.fill(240-this.crit*200,80,40+this.crit*200,fade494)
				layer.rect(0,3,1,6)
				layer.fill(120,120+this.crit*200,120+this.crit*200,fade494)
				layer.ellipse(0,0,6,20)
				layer.fill(100,100+this.crit*200,100+this.crit*200,fade494)
				layer.ellipse(0,0,4,16)
				layer.fill(225,125,25,fade494)
				layer.ellipse(0,0,4)
				/*if(!this.active&&this.fade<1&&6*this.fade-5>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,(6*this.fade-5))
					layer.ellipse(0,0,195-(6*this.fade-5)*195)
					layer.fill(240-this.crit*200,160,40+this.crit*200,(6*this.fade-5))
					layer.ellipse(0,0,130-(6*this.fade-5)*130)
					layer.fill(240-this.crit*200,80,40+this.crit*200,(6*this.fade-5))
					layer.ellipse(0,0,65-(6*this.fade-5)*65)
				}*/
				if(!this.active&&this.fade<1&&fade494>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,fade494)
					layer.ellipse(0,0,270-fade494*270)
					layer.fill(240-this.crit*200,160,40+this.crit*200,fade494)
					layer.ellipse(0,0,180-fade494*180)
					layer.fill(240-this.crit*200,80,40+this.crit*200,fade494)
					layer.ellipse(0,0,90-fade494*90)
				}
			break
			case 495:
				layer.rotate(-this.direction)
			...
			case 496:
				...
				layer.rotate(this.position.x)
				if(!this.active&&this.fade<1){
					layer.fill(75-this.crit*75,175+this.crit*75,25+this.crit*200,this.fade*0.5)
					layer.ellipse(0,0,360*(1-this.fade*this.fade*this.fade))
				}
				layer.fill(250,this.fade)
				layer.rect(0,0,6,6,1.5)
			...
			case 498: case 510:
				...
				if(!this.active&&this.fade<1&&fade498>0){
					layer.fill(240-this.crit*200,240,40+this.crit*200,fade498)
					layer.ellipse(0,0,(270-fade498*270)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,160,40+this.crit*200,fade498)
					layer.ellipse(0,0,(180-fade498*180)*(this.fail?0.25:1))
					layer.fill(240-this.crit*200,80,40+this.crit*200,fade498)
					layer.ellipse(0,0,(90-fade498*90)*(this.fail?0.25:1))
				}
			break
			case 499:
				layer.rotate(-this.direction)
				...
				for(let a=0,la=9;a<la;a++){
					layer.vertex(lsin(a/la*360)*this.width*0.5,lcos(a/la*360)*this.height*0.5)
					layer.vertex(lsin((a+1.25)/la*360)*this.width*0.75,lcos((a+1.25)/la*360)*this.height*0.75)
				}
				layer.endShape()
				layer.fill(225-this.crit*175,75+this.crit*175,75+this.crit*175,this.fade)
				layer.ellipse(0,0,this.width*0.8,this.height*0.8)
				layer.fill(250,this.fade)
				layer.ellipse(0,0,this.width*0.7,this.height*0.7)
			break
			case 500:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
				...
				layer.rotate(15)
				for(let a=0,la=5;a<la;a++){
					layer.triangle(0,-5,-0.5,-3,0.5,-3)
					layer.rotate(360/la)
				}
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 505: case 507:
				...
				layer.fill(240-this.crit*200,160,40+this.crit*200,this.fade)
				layer.triangle(-0.5,2,0.5,2,0,6.5)
				layer.fill(240-this.crit*200,80,40+this.crit*200,this.fade)
				layer.triangle(-0.5,2,0.5,2,0,5.5)
				layer.fill(120,120+this.crit*200,120+this.crit*200,this.fade)
				layer.ellipse(0,0,4,12)
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
			...
			case 506:
				...
				if(this.timer>50&&this.timer<55){
					layer.fill(225-this.crit*175,75+this.crit*150,100+this.crit*150,this.fade*(1-(this.timer-50)/5))
					layer.ellipse(0,0,6+(this.timer-50)*4)
				}
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,150-this.fade*150)
			...
			case 512:
				...
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,200,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(252-this.fade*252)*(this.fail?0.5:1))
					layer.fill(200-this.crit*180,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(168-this.fade*168)*(this.fail?0.5:1))
					layer.fill(160-this.crit*160,120,40+this.crit*200,this.fade)
			...
			case 519:
				...
				if(!this.active&&this.fade<1){
					layer.fill(240-this.crit*200,200,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(225-this.fade*225)*(this.fail?0.5:1))
					layer.fill(200-this.crit*180,160,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(150-this.fade*150)*(this.fail?0.5:1))
					layer.fill(160-this.crit*160,120,40+this.crit*200,this.fade)
					layer.ellipse(0,0,(75-this.fade*75)*(this.fail?0.5:1))
				}
			break
			case 521:
				layer.rotate(-this.direction)
				layer.fill(40-this.crit*40,240,40+this.crit*200,this.fade)
				layer.ellipse(this.past[0][0]-this.position.x,this.past[0][1]-this.position.y,2)
				layer.fill(80-this.crit*80,200,80+this.crit*200,this.fade)
				layer.ellipse(this.past[4][0]-this.position.x,this.past[4][1]-this.position.y,4)
				layer.fill(120-this.crit*120,160,120+this.crit*200,this.fade)
				layer.ellipse(this.past[8][0]-this.position.x,this.past[8][1]-this.position.y,6)
				layer.fill(200,this.fade*0.5)
				regPoly(layer,0,0,16,5,5,0)
				//layer.fill(60-this.crit*60,180+this.crit*60,this.crit*240,this.fade*this.time/this.base.time)
				layer.fill(60-this.crit*60,240+this.crit*30,120+this.crit*120,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,6*(0.8+0.2*lsin(this.time*12)))
				//layer.fill(120-this.crit*120,240+this.crit*30,this.crit*240,this.fade*this.time/this.base.time)
				layer.fill(120-this.crit*120,240+this.crit*30,240+this.crit*30,this.fade*this.time/this.base.time)
				layer.ellipse(0,0,3*(0.8+0.2*lsin(this.time*12)))
				if(!this.active&&this.fade<1){
					layer.fill(120-this.crit*120,240,120+this.crit*200,this.fade)
					layer.ellipse(0,0,165-this.fade*165)
					layer.fill(80-this.crit*80,240,80+this.crit*200,this.fade)
					layer.ellipse(0,0,110-this.fade*110)
					layer.fill(40-this.crit*40,240,40+this.crit*200,this.fade)
					layer.ellipse(0,0,55-this.fade*55)
				}
			break
		...
		switch(this.type){
			case 48:
				if(!this.active&&this.fade<1){
					...
					layer.fill(120,this.fade*3)
					layer.ellipse(0,0,600*(1-this.fade*this.fade*this.fade))
				}
			break
			case 484:
				if(!this.active&&this.fade<1){
					//layer.fill(100,this.fade*3)
					layer.fill(120,this.fade*3)
					layer.ellipse(0,0,300*(1-this.fade*this.fade*this.fade))
				}
			break
		}
		layer.pop()
	...
	distExplosion(target,type){
		switch(type){
			case 0:
				return min(dist(
					this.position.x,this.position.y,
					constrain(this.position.x,target.position.x-target.width/2-this.width/2,target.position.x+target.width/2+this.width/2),
			...
			case 1:
				return min(dist(
					...
					this.position.x,this.position.y,
					constrain(this.position.x,target.previous.position.x*6-target.position.x*5-target.width/2-this.width/2,target.previous.position.x*6-target.position.x*5+target.width/2+this.width/2),
					constrain(this.position.y,target.previous.position.y*6-target.position.y*5-target.height/2-this.height/2,target.previous.position.y*6-target.position.y*5+target.height/2+this.height/2)
				))
			case 2:
				return dist(
					this.position.x,this.position.y,
	...
	validExplodeTarget(target){
		return (this.id<=0?this.id:game.traitor&&this.id-1==game.traitorKey?0:game.pvp?this.id:1)!=
			...
			target.index==this.index&&!(duel.trigger&&rules.teamMode&&game.noPlayer)
	}
	explode(){
		this.exploded=true
		let radius=60
		...
		switch(this.type){
			case 2: case 26: case 31: case 32: case 41: case 48: case 80: case 266: case 307:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
			...
			case 21: case 53:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						for(let d=0,ld=entities.players.length;d<ld;d++){
							if(entities.players[d].index==this.index){
								entities.players[d].life=min(entities.players[d].life+this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index),entities.players[d].base.life)
							}
						}
					}
				}
			...
			case 60: case 324:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*(this.id==-1&&entities.players[b].id>0&&game.level!=19?(this.timer<5?0.1:0.5):1)*(entities.players[b].fort?0.5:1))
						entities.players[b].generalizedTake(this)
					}
				}
			...
			case 73:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*(this.id==-1&&entities.players[b].id>0?(this.timer<5?0.1:0.5):1))
						entities.players[b].generalizedTake(this)
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						/*if(!entities.players[b].fort){
							print(
								...
								this.damage*sqrt(1-c/radius)*falloff*entities.players[b].selfDamageCheck(this.index)
							)
						}*/
						entities.players[b].generalizedTake(this)
			...
			case 351:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1)*(game.classWeapon&&this.id==entities.players[b].id&&this.id>0?0.25:1))
						entities.players[b].generalizedTake(this)
			...
			case 352:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].gasTime=max(entities.players[b].gasTime,max(4,ceil(5*(1-c/radius))))
				...
				for(let b=0,lb=entities.projectiles.length;b<lb;b++){
					if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<radius+entities.projectiles[b].width*0.35+entities.projectiles[b].height*0.35&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
			...
			case 356:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					let launch=min(1,2-2*c/105)*(entities.players[b].jump.time==0&&entities.players[b].jump.active>0&&entities.players[b].velocity.y<0?3:1)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
						let dir=atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y)
			...
			case 359:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(entities.players[b].construct?5:1)*(entities.players[b].fort?2:1))
						entities.players[b].generalizedTake(this)
						let dir=atan2(entities.players[b].position.x-this.position.x,this.position.y-entities.players[b].position.y)
			...
			break
			case 360:
				radius=150+constrain(this.timer*0.125-15,0,15)
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*sqrt(1-c/radius)*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
					}
				}
			break
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius){
						if(this.onTeam(entities.players[b])&&this.index!=entities.players[b].index){
							entities.players[b].life=min(entities.players[b].life+this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1)*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*2))
			...
			case 384:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*((1-c/radius)**1.5)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 385:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-(this.hitTime==0?this.timer:this.hitTime)/this.base.time*4,0.2,1))
						entities.players[b].generalizedTake(this)
					}
				}
			...
			case 389:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*(2+min(3,this.base.time/60))*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
					}
				}
			break
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						if(entities.players[b].index==this.index&&c<90){
							...
							if(this.type==392){
								...
								entities.players[b].knockbackSet(4.8*launch,dir,1,1)
								entities.players[b].knockbackSetForce(2.4*launch,dir,1,1)
							}
							entities.players[b].assort.stickyJump=true
			...
			case 412:
				for(let b=0,lb=10;b<lb;b++){
					...
					this.addProjectile(new projectile(this.layer,this.position.x,this.position.y,6,dir,this.id,this.base.damage*0.5,10,this.crit,this.index))
			...
			break
			case 413:
				//radius=this.type==462?75:87.5
				radius=80
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index))
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/60*0.4))
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/60*0.25))
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/60*0.2))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 416: case 468: case 472:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
						if(this.type==472&&!entities.players[b].immune()){
							entities.players[b].freezeTime=max(entities.players[b].freezeTime,120)
						}
					}
				}
				for(let b=0,lb=entities.projectiles.length;b<lb;b++){
					...
					if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<radius+this.width*0.35+this.height*0.35+entities.projectiles[b].width*0.35+entities.projectiles[b].height*0.35&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
						entities.projectiles[b].defuse()
					}
				}
			break
			case 425:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*min(1,1.4-this.bounces*0.4)*entities.players[b].selfDamageCheck(this.index))
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*min(1,1.25-this.bounces*0.25)*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].takeDamage(this.damage*(1-c/radius)*min(1,1.2-this.bounces*0.2)*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 430:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					//if(entities.players[b].explodable()&&c<radius&&(this.validExplodeTarget(entities.players[b])||game.classWeapon&&this.id==entities.players[b].id&&this.id>0)){
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						let dmg=this.damage*(1-c/radius)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1)*(game.classWeapon&&this.id==entities.players[b].id&&this.id>0?0.5:1)
				...
				if(total430>0){
					for(let d=0,ld=entities.players.length;d<ld;d++){
						if(entities.players[d].index==this.index){
							entities.players[d].life=min(entities.players[d].life+min(40,total430/2),entities.players[d].base.life)
						}
					}
				}
			break
			...
			case 462:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/30*0.4))
						//entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/30*0.25))
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(this.detTime==0?1:1-(60-this.detTime)/30*0.2))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 466:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*((1-c/radius)**2)*0.8*entities.players[b].selfDamageCheck(this.index)*constrain(1.2-this.timer/this.base.time*4,0.2,1))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 469:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						entities.players[b].generalizedTake(this)
						if(!entities.players[b].immune()){
							entities.players[b].stunTime=max(entities.players[b].stunTime,30*(1-0.5*c/radius))
						}
					}
				}
			break
			...
			case 473:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let radius=entities.players[b].construct?120:100
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(entities.players[b].construct?5:1))
						entities.players[b].generalizedTake(this)
						let dir=atan2(entities.players[b].position.x-this.previous.position.x,this.previous.position.y-entities.players[b].position.y)
						entities.players[b].knockback(5*(1.5-c/radius),dir,1,1)
						entities.players[b].knockbackForce(1.5-c/radius,dir,1,1)
					}
				}
			break
			...
			case 494: case 498:
				//radius=100
				//radius=135
				radius=this.fail?60:120
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						//entities.players[b].takeDamage(this.damage*(1-c/radius))
						entities.players[b].takeDamage(this.damage*sqrt(1-c/radius))
						entities.players[b].generalizedTake(this)
					}
				}
			break
			case 495:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*0.5)
						entities.players[b].generalizedTake(this)
					}
				}
				for(let b=0,lb=10;b<lb;b++){
			...
			case 496:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])&&!entities.players[b].immune()){
						entities.players[b].DOT.damage+=this.damage*(1-c/radius)/7200
						entities.players[b].DOT.active+=5
						entities.players[b].collect.time=min(entities.players[b].collect.time+15,450)
					}
				}
			break
			case 500:
			...
			case 512:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=this.distExplosion(entities.players[b],0)
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						entities.players[b].takeDamage(this.damage*(entities.players[b].fort?2:1)*(1-c/radius)*entities.players[b].selfDamageCheck(this.index))
						entities.players[b].generalizedTake(this)
						if(!entities.players[b].immune()){
							entities.players[b].vulnerableTime=min(entities.players[b].vulnerableTime+360*(1-c*0.8/radius),720)
			...
			case 516:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius&&this.validExplodeTarget(entities.players[b])){
						...
						entities.players[b].takeDamage(this.damage*(1-c/radius)*constrain(1.2-this.timer/this.base.time*8,0.2,1),1)
						entities.players[b].generalizedTake(this)
					}
				}
				//note an anticannon projectiles moves 48 pixels per frame while a regular rocket moves 20
				//thus projectile expiry for it will be twice as fast
			break
			case 519:
				radius=130
				for(let b=0,lb=entities.players.length;b<lb;b++){
			...
			case 521:
				...
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&c<radius){
						if(this.onTeam(entities.players[b])&&this.index!=entities.players[b].index){
							entities.players[b].life=min(entities.players[b].life+this.damage*(1-c/radius)*entities.players[b].selfDamageCheck(this.index)*(min(2,entities.players[b].base.life/125)),max(entities.players[b].life,entities.players[b].base.life*2))
						}else if(this.validExplodeTarget(entities.players[b])&&this.index!=entities.players[b].index){
							entities.players[b].takeDamage(this.damage*(1-c/radius))
							entities.players[b].generalizedTake(this)
						}
    ...
    update(){
				...
				for(let a=0,la=entities.players.length;a<la;a++){
					if(entities.players[a].index==this.index&&!entities.players[a].sidekick&&entities.players[a].assort.penalty>=0){
						...
						if(entities.players[a].assort.penalty>=12){
							...
							entities.players[a].life=max(entities.players[a].life-80,1)
		...
		switch(this.type){
			...
			case 464: case 468: case 472: case 473: case 474: case 475: case 484: case 485: case 490: case 493:
			case 495: case 496: case 499: case 500: case 501: case 508: case 509: case 512: case 514: case 515:
			case 518: case 519: case 520: case 521:
				delete this.past[0]
				this.past.splice(0,1)
				this.past.push([this.position.x,this.position.y])
				if(this.rules.physBall){
        ...
        for(let a=0,la=this.stun>0?2:this.rules.slow?2:this.rules.fast?6:4;a<la;a++){
			switch(this.type){
				...
				case 340: case 341: case 342: case 343: case 345: case 346: case 347: case 348: case 350: case 351:
				...
				case 457: case 458: case 462: case 463: case 464: case 468: case 472: case 473: case 474: case 475: case 484:
				case 485: case 490: case 493: case 495: case 496: case 499: case 500: case 501: case 508: case 512: case 518:
				case 520: case 521:
					...
					if(this.type==402&&this.hitting>0){
						this.hitting--
						this.position.x+=this.velocity.x/12
						...
						if(this.type==366){
							...
							this.rules.physBouncer&&
							!((this.type==416||this.type==468||this.type==472)&&this.active)&&
							!(this.type==484&&!this.active)
						){
							this.velocity.y+=0.1
						}
					}
					if(this.type==484&&!this.active){
						this.velocity.x=0
						this.velocity.y=0
					}
					if((this.type==135||this.type==169||this.type==311)&&this.bounces==0){
						this.position.x+=this.velocity.y/12*(0.5+min(this.timer/30,2))*lcos(this.time*6)*this.twistMult
						this.position.y-=this.velocity.x/12*(0.5+min(this.timer/30,2))*lcos(this.time*6)*this.twistMult
						if(a==3){
					...
					if((this.type==463||this.type==464)&&this.bounces==0){
						this.position.x+=this.velocity.y/20*(0.5+min(this.timer/30,2))*lcos(this.time*15)*this.twistMult*(this.type*2-927)
						this.position.y-=this.velocity.x/20*(0.5+min(this.timer/30,2))*lcos(this.time*15)*this.twistMult*(this.type*2-927)
						if(a==3){
							this.effectiveDirection=atan2(
								this.velocity.x+this.velocity.y/3*(0.5+min(this.timer/30,2))*lcos(this.time*6),
								this.velocity.y-this.velocity.x/3*(0.5+min(this.timer/30,2))*lcos(this.time*6)
					...
					if((this.type==353||this.type==508)&&this.active&&this.time>=15){
						this.active=false
						this.explode()
					}
					if((this.type==413||this.type==462)&&this.detTime>0&&a==0&&this.active){
						this.detTime--
						if(this.detTime<=0){
							this.active=false
							this.explode()
					...
					if(this.type==366&&a==3){
						this.travel+=abs(this.position.x-this.previous.position.x)
					}
				break
				case 8: case 107: case 244: case 267: case 282: case 292:
					...
					if(this.timer%(this.type==244||this.type==282?10:this.type==107?20:15)==0&&this.active&&a==0){
						...
						for(let a=0,la=entities.players.length;a<la;a++){
							...
							if(entities.players[a].life>0&&entities.players[a].fade>0&&((this.id==0?1:0)!=(entities.players[a].id==0?1:0)||this.id==-1||entities.players[a].id==-1||game.pvp&&this.id!=entities.players[a].id)){
				...
				case 433: case 481:
					...
					if(a==0){
						if(this.type==433||this.type==481){
							if(this.timer%4==0&&this.active){
								...
								this.shocks.push({fade:1,branches:[],dir:dir})
								let active=[{length:random(6,18),angle:dir+180+random(-5,5),origin:[lsin(dir)*60,lcos(dir)*60]}]
								active[0].end=[
									active[0].origin[0]+lsin(active[0].angle)*active[0].length,
									active[0].origin[1]+lcos(active[0].angle)*active[0].length
								]
								while(active.length>0&&this.shocks[this.shocks.length-1].branches.length<power){
									if(active[0].length<6){
										if(floor(random(0,2))==0){
											active.push(
												{length:random(3,7.5),angle:active[0].angle+random(20,40)*(floor(random(0,2))*2-1),origin:[
													active[0].end[0],
													active[0].end[1]
												]}
											)
											active[active.length-1].end=[
												active[active.length-1].origin[0]+lsin(active[active.length-1].angle)*active[active.length-1].length,
												active[active.length-1].origin[1]+lcos(active[active.length-1].angle)*active[active.length-1].length
											]
										}
									}else{
										if(floor(random(0,4))==0){
											active.push(
												{length:random(3,7.5),angle:active[0].angle+random(30,70)*(floor(random(0,2))*2-1),origin:[
													active[0].end[0],
													active[0].end[1]
												]}
											)
										...
										active.push(
											{length:random(6,18),angle:active[0].angle+random(20,40)*(floor(random(0,2))*2-1),origin:[
												active[0].end[0],
												active[0].end[1]
											]}
										)
									...
									this.shocks[this.shocks.length-1].branches.push(active[0])
									active.splice(0,1)
								}
								this.shocks[this.shocks.length-1].branches=this.shocks[this.shocks.length-1].branches.filter(branch=>dist(branch.end[0],branch.end[1],0,0)<60)
							}
							for(let a=0,la=this.shocks.length;a<la;a++){
					...
					if(this.type==103&&a==0){
						for(let b=0,lb=entities.projectiles.length;b<lb;b++){
							if(inBoxBox(this,entities.projectiles[b])&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
								entities.projectiles[b].active=false
				...
				case 437:
					if(a==1){
							...
							for(let b=0,lb=entities.projectiles.length;b<lb;b++){
								if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<this.width*0.35+this.height*0.35+entities.projectiles[b].width*0.35+entities.projectiles[b].height*0.35&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active&&!entities.projectiles[b].rules.passer){
									if(entities.projectiles[b].damage>this.base.damage){
										...
										//print(this.damage,this.time)
										if(entities.projectiles[b].damage<=0||this.type==437){
						...
						if(this.goal>=entities.players.length||this.goal>=0&&entities.players[this.goal].index!=
							this.index||this.goal<0){
							this.goal=-1
							for(let a=0,la=entities.players.length;a<la;a++){
								if(entities.players[a].index==this.index&&!entities.players[a].sidekick){
									this.goal=a
						...
						if(this.type==404&&this.bumpTime>0){
							...
							let dir=this.type==138?
								...
								this.type==404?
								(this.attack==-1?-90:this.attack==1?90:atan2(entities.players[this.goal].position.x+lsin((this.time+this.offset)*13)*12-this.position.x,entities.players[this.goal].position.y+lcos((this.time+this.offset)*13)*12-5-this.position.y)):
							...
							this.velocity.x+=lsin(dir)*(this.type==138?1:this.type==144?0.3:0.6)*(this.type==404&&this.attack!=0?2:1)
							this.velocity.y+=lcos(dir)*(this.type==138?1:this.type==144?0.3:0.6)*(this.type==404&&this.attack!=0?2:1)
						}
					...
					this.position.x+=this.velocity.x/4
					this.position.y+=this.velocity.y/4
					if(this.goal<entities.players.length){
						switch(this.type){
							case 111: case 144:
							...
							case 134: case 283: case 437:
								if(this.timer%25==0&&this.active&&a==0){
								...
								if(this.type==283&&a==0){
									for(let b=0,lb=entities.projectiles.length;b<lb;b++){
										if(inBoxBox({position:this.position,width:120,height:120},entities.projectiles[b])&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
											entities.projectiles[b].active=false
											if(entities.projectiles[b].rules.exploder){
												entities.projectiles[b].explode()
											}
				...
				case 435: case 438: case 448: case 509: case 514: case 519:
					if(this.rules.stickybomb&&this.type!=360&&/*(this.stop||this.timer>=this.detTick)*/this.stop&&this.active){
						for(let b=0,lb=entities.players.length;b<lb;b++){
							if(
								(entities.players[b].id!=this.id&&!(!game.pvp&&entities.players[b].id>0&&this.id>0))&&
								entities.players[b].rules.class&&(
									lsin(entities.players[b].direction.main)<0&&this.position.x<entities.players[b].position.x||
									lsin(entities.players[b].direction.main)>0&&this.position.x>entities.players[b].position.x
								)&&
								distPos(this,entities.players[b])<200
							){
								if(shotgun(entities.players[b].subWeaponAData.name)&&entities.players[b].subWeaponA.ammo>0){
									entities.players[b].manage[1]=true
								}else if(
									shotgun(entities.players[b].subWeaponBData.name)&&entities.players[b].subWeaponB.ammo>0||
									shotgun(entities.players[b].subWeaponCData.name)&&entities.players[b].subWeaponC.ammo>0
								){
									entities.players[b].swapSubWeapons()
									entities.players[b].manage[1]=true
								}
							}
						}
					...
					if(this.stop){
						...
						this.position.y+=this.velocity.y/4
						this.velocity.y+=0.1
						if(this.type==392&&a==la-1&&!this.launch){
							let R=0.25
							let k=0.5
							let eU=this.timer*k
							let r=R*eU
							let dr=k*R*eU
							let ddr=k*k*R*eU
							let theta=this.timer*12+this.tick*120
							let omega=PI/15
							let a=[
								((ddr-r*omega*omega)*lcos(theta)-(2*dr*omega)*lsin(theta)),
								((ddr-r*omega*omega)*lsin(theta)+(2*dr*omega)*lcos(theta))
							]
							this.velocity.x+=a[0]
							this.velocity.y+=a[1]
						}
						if(this.type==509&&a==la-1&&!this.launch){
							let k=8
							this.velocity.x+=(lsin(this.timer*12+this.tick*120)*min(1,this.timer/30)-lsin((this.timer-1)*12+this.tick*120)*min(1,(this.timer-1)/30))*k
							this.velocity.y+=(lcos(this.timer*12+this.tick*120)*min(1,this.timer/30)-lcos((this.timer-1)*12+this.tick*120)*min(1,(this.timer-1)/30))*k
						}
					}
					if((
						...
						this.type==375&&this.timer==150||
						(this.type==438||this.type==519)&&this.timer==90
					)&&this.active){
						this.active=false
						this.explode()
					}
					...
					if(
						...
						if(a==0&&id>game.gaming&&this.timer%5==0&&floor(random(0,1.5))==0){
							if(entities.players.some(player=>!this.onTeam(player)&&distPos(this,player)<50&&player.fade>0.5)){
								/*for(let a=0,la=entities.players.length;a<la;a++){
									if(entities.players[a].index==this.index){
										if(
											...
											distPos(this,entities.players[a])<1000
										){
											game.det[id]=2
										}
										break
							...
							let inputSet=this.id==0||id>game.gaming?[game.det[id]>0,false]:[
								inputs.release[game.gaming==1?1:game.gaming==2&&id==1?2:id-1][0]||game.det[id]>0,
								inputs.release[game.gaming==1?1:game.gaming==2&&id==1?2:id-1][1]
							]
							if(inputSet[0]){
								this.det=5
							}
							if(id>0&&id<=game.gaming&&this.timer>5&&this.timer<15&&!this.stop&&inputs.tap[game.gaming==1?1:game.gaming==2&&id==1?2:id-1][3]){
								this.autoDet=true
							}
							if(this.det>0||this.autoDet){
								if(this.timer>=this.detTick&&this.active&&!(this.type==372&&this.delay>0)){
									for(let a=0,la=entities.players.length;a<la;a++){
										if(entities.players[a].index==this.index){
											if(
												this.autoDet&&this.stop||!this.autoDet&&(
													lsin(entities.players[a].direction.main)<0&&this.position.x<entities.players[a].position.x||
													lsin(entities.players[a].direction.main)>0&&this.position.x>entities.players[a].position.x||
													abs(this.position.x-entities.players[a].position.x)<75&&
													abs(this.position.y-entities.players[a].position.y)<150+entities.players[a].height*0.5
				...
				case 168: case 171: case 184: case 200: case 211: case 295:
					if(a==1){
						...
						if(this.aggro){
							if(this.goal==-1||this.goal>=entities.players.length||entities.players[this.goal].index!=this.goalIndex||entities.players[this.goal].life<=0||entities.players[this.goal].fade<=0||entities.players[this.goal].id==this.id){
								this.goal=-1
								for(let a=0,la=entities.players.length;a<la;a++){
							...
							if(this.goal>=0){
								...
								let speed=(this.type==119||this.type==121||this.type==132||this.type==200?1:0.6)*2
								this.velocity.x+=lsin(dir)*speed
							...
							if(this.goal>=0){
								...
								let speed=(this.type==119||this.type==121||this.type==132||this.type==200?1:this.type==295?0.3:0.6)
								this.velocity.x+=lsin(dir)*speed
								this.velocity.y+=lcos(dir)*speed
							}
							this.velocity.x*=0.95
				...
				break
				case 145: case 315: case 515:
					if((this.type==315||this.type==515)&&this.timer%30==0&&a==0&&this.active){
						let minimum=300
						for(let a=0,la=entities.players.length;a<la;a++){
							if(entities.players[a].life>0&&entities.players[a].fade>0&&((this.id==0?1:0)!=(entities.players[a].id==0?1:0)||this.id==-1||entities.players[a].id==-1||game.pvp&&this.id!=entities.players[a].id)){
								minimum=min(minimum,dist(this.position.x,this.position.y,entities.players[a].position.x,entities.players[a].position.y))
					...
					if(a==1){
						if(this.aggro){
							...
							if(this.timer%5==0){
								let range=this.type==315||this.type==515?40:80
								let minimum=range
								for(let a=0,la=entities.players.length;a<la;a++){
									if(entities.players[a].life>0&&entities.players[a].fade>0&&((this.id==0?1:0)!=(entities.players[a].id==0?1:0)||this.id==-1||entities.players[a].id==-1||game.pvp&&this.id!=entities.players[a].id)){
										minimum=min(minimum,dist(this.position.x,this.position.y,entities.players[a].position.x,entities.players[a].position.y))
							...
							if(this.goal>=0){
								let dir=atan2(entities.projectiles[this.goal].position.x+lsin(this.time*(this.type==515?10:6)+this.offset)*this.orbit-this.position.x,entities.projectiles[this.goal].position.y+lcos(this.time*(this.type==515?10:6)+this.offset)*this.orbit-this.position.y+(this.type==315?-40:this.type==515?-30:0))
								this.velocity.x+=lsin(dir)*(this.type==515?0.8:0.6)
								this.velocity.y+=lcos(dir)*(this.type==515?0.8:0.6)
							}
							let mult=this.type==515?0.8:0.95
				...
				case 163:
					if(a==0){
						...
						let inputSet=this.id==0||((game.level==27||game.level==38||rules.teamMode)&&game.pvp?this.index+1:this.id)>game.gaming?[
					...
					if(a==1){
						if(this.aggro){
							...
							if(this.chase>=300){
								this.goal=-1
								this.aggro=false
							}else if(this.goal==-1||this.goal>=entities.players.length||entities.players[this.goal].index!=this.goalIndex||entities.players[this.goal].life<=0||entities.players[this.goal].fade<=0||entities.players[this.goal].id==this.id){
								this.goal=-1
								for(let a=0,la=entities.players.length;a<la;a++){
									if(entities.players[a].index==this.goalIndex&&entities.players[a].life>0&&entities.players[a].id!=this.id&&entities.players[a].fade>0){
										this.goal=a
							...
							if(this.timer%5==0&&this.chase<=0){
								let range=120
								let minimum=range
								for(let a=0,la=entities.players.length;a<la;a++){
									if(entities.players[a].life>0&&entities.players[a].fade>0&&((this.id==0?1:0)!=(entities.players[a].id==0?1:0)||this.id==-1||entities.players[a].id==-1||game.pvp&&this.id!=entities.players[a].id)){
				...
				break
				case 222: case 223: case 287: case 288: case 319: case 371: case 374: case 424: case 449: case 479:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					this.travel+=this.speed
					if(this.travel>(this.id==0?750:1500)){
				...
				case 236: case 266:
					...
					for(let b=0,lb=entities.projectiles.length;b<lb;b++){
						if(dist(this.position.x,this.position.y,entities.projectiles[b].position.x,entities.projectiles[b].position.y)<22&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
							entities.projectiles[b].active=false
							if(entities.projectiles[b].rules.exploder){
								entities.projectiles[b].explode()
							}
				...
				case 280:
					...
					if(a==0){
						...
						let inputSet=this.id==0||((game.level==27||game.level==38||rules.teamMode)&&game.pvp?this.index+1:this.id)>game.gaming?[false,false]:inputs.keys[game.gaming==1?1:game.gaming==2&&this.id==1?2:this.id-1]
						if(inputSet[0]){
				...
				case 352:
					...
					if(a==0&&this.time>15&&this.active){
						let id=((game.level==27||game.level==38||rules.teamMode)&&game.pvp?this.index+1:this.id)
				...
				break
				case 385:
				    this.position.x+=this.speed*lsin(this.direction)*(this.active?1:0.1)
				    this.position.y-=this.speed*lcos(this.direction)*(this.active?1:0.1)
					this.travel+=this.speed
					if(this.travel>(this.rules.fast||this.type==336?4500:1500)&&this.type!=335){
						this.active=false
					}
					if(this.fade<0.2&&!this.secondary){
						this.secondary=true
						this.explode()
					}
				break
				...
				case 427:
					if(a==0){
						...
						if(this.type==427&&a==0){
							this.scale=sin(this.time/this.base.time*180)*2
							this.width=this.maxWidth*this.scale
							this.height=this.maxHeight*this.scale
							for(let b=0,lb=entities.projectiles.length;b<lb;b++){
								if(inBoxBox(this,entities.projectiles[b])&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
									entities.projectiles[b].active=false
									if(entities.projectiles[b].rules.exploder){
				...
				case 483:
					if(a==0){
						...
						if(this.type==483&&a==0){
							this.scale=sin(this.timer/this.base.time*90)*2
							this.width=this.maxWidth*this.scale
							this.height=this.maxHeight*this.scale
							for(let b=0,lb=entities.projectiles.length;b<lb;b++){
								if(inBoxBox(this,entities.projectiles[b])&&!this.onTeam(entities.projectiles[b])&&entities.projectiles[b].active){
				...
				case 494:
				    ...
				    this.velocity.x+=this.speed*lsin(this.direction)*0.04
				    this.velocity.y-=this.speed*lcos(this.direction)*0.04
					this.position.x+=this.velocity.x
					this.position.y+=this.velocity.y
					this.velocity.x*=0.95
				...
				case 498: case 510:
					...
					if(a==0&&this.active){
						...
						}else if(this.id==0||((game.level==27||game.level==38||rules.teamMode)&&game.pvp?this.index+1:this.id)>game.gaming){
							if(this.goal==-1){
								this.goal=-1
								for(let a=0,la=entities.players.length;a<la;a++){
									if(!this.onTeam(entities.players[a])&&distPos(this,entities.players[a])<200&&entities.players[a].life>0){
										this.goal=entities.players[a]
									}
								}
								if(this.initialVelocity.x<0){
									this.velocity.x-=speed
								}else{
									this.velocity.x+=speed
								}
							}else{
								if(this.goal.life<=0||distPos(this,this.goal)>250){
									this.goal=-1
								}else{
									if(this.position.x>this.goal.position.x+25){
										this.velocity.x-=speed
									}
									if(this.position.x<this.goal.position.x-25){
										this.velocity.x+=speed
									}
									if(this.position.y>this.goal.position.y+25){
				...
				case 505:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)+this.lift
					this.travel+=this.speed
					if(this.travel>(this.rules.fast||this.type==336?4500:1500)&&this.type!=335){
						this.active=false
					}
		...
		if(this.stun>0){
			...
			!(this.type==65&&this.id==-1&&this.timer<5)&&
		...
		if(this.classification.drone&&this.timer%30==0){
			...
			if(
				this.check.length>=4&&
				dist(this.position.x,this.position.y,this.check[this.check.length-1][0],this.check[this.check.length-1][1])<rad&&
				dist(this.position.x,this.position.y,this.check[this.check.length-2][0],this.check[this.check.length-2][1])<rad&&
				dist(this.position.x,this.position.y,this.check[this.check.length-3][0],this.check[this.check.length-3][1])<rad&&
				dist(this.position.x,this.position.y,this.check[this.check.length-4][0],this.check[this.check.length-4][1])<rad
			){
				this.active=false
			}
			this.check.push([this.position.x,this.position.y])
		}
		if(this.time>0){
			this.time--
        }else{
			if(this.active){
				if(this.type==178||this.type==389||this.type==413||this.type==490||this.type==495||this.type==500||this.type==501){
					this.explode()
	...
	canHit(target){
		...
		(this.fade>0.5||this.forceDisplay)
	}
	hitPlayer(target){
		...
		switch(this.type){
			case 9: case 155: case 216: case 439: case 449: case 463: case 464: case 497:
			...
			default:
				if(this.rules.exploder&&this.type!=389){
					...
					if(this.rules.explodeHit){
						...
						this.speed=0
					}else if(this.type==344||this.type==518){
			...
			case 407:
				for(let d=0,ld=entities.players.length;d<ld;d++){
					...
					if(entities.players[d].id==0&&entities.players[d]!=target&&entities.players[d].explodable()&&entities.players[d].life>0&&e<60&&((this.id==0?1:0)!=(entities.players[d].id==0?1:0)||this.id==-1||entities.players[d].id==-1||game.pvp&&(this.id!=entities.players[d].id||!rules.teamMode))){
						...
						entities.players[d].generalizedTake(this)
					}
				}
			break
			case 408:
				for(let d=0,ld=entities.players.length;d<ld;d++){
					if(entities.players[d].index==this.index&&entities.players[d].life>0){
						if((entities.players[d].playerData.name=='PlayerSpyC2'||entities.players[d].playerData.name=='PlayerSpyW'&&entities.players[d].subWeaponCType==1006)){
							...
							entities.players[d].speedBuff=max(entities.players[d].speedBuff,60)
						}else if(entities.players[d].playerData.name=='PlayerSpyW'&&entities.players[d].subWeaponCType==1021){
							entities.players[d].visible=600
							entities.players.push(new player(entities.players[d].layer,entities.players[d].previous.position.x,entities.players[d].previous.position.y+entities.players[d].height/2-12,-1,0,[],false,findName('Decoy',types.player),game.index))
							game.index++
							entities.players[entities.players.length-1].decoy=true
							entities.players[entities.players.length-1].life=entities.players[d].life
							//entities.players[entities.players.length-1].copy=entities.players[d].index
							entities.players[entities.players.length-1].copy=entities.players[d]
							entities.players[entities.players.length-1].copyId=entities.players[d].id
							entities.players[entities.players.length-1].direction.goal=entities.players[d].direction.goal
		...
		if(!target.immune()){
			switch(this.type){
				...
				break*/
				case 521:
					target.chillTime=max(target.chillTime,480)
				break
			}
			switch(this.type){
				case 20:
				...
				break
				case 476:
					target.DOT.damage+=this.damage/240
					target.DOT.active=max(240,target.DOT.active+60)
				break
				case 492:
					target.DOT.damage+=this.damage/600
					target.DOT.active=max(30,target.DOT.active+15)
				break
			}
		}
		if(game.invis){
