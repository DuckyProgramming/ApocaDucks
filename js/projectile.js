class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index,args=[]){
		...
		switch(this.type){
			...
			case 437: case 438: case 447: case 448:
				this.partisan=true
    ...
    update(){
        ...
        for(let a=0,la=this.stun>0?2:this.rules.slow?2:this.rules.fast?6:4;a<la;a++){
			switch(this.type){
				...
				case 432: case 434: case 436: case 439: case 440: case 441: case 442: case 443: case 445:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
				...
				case 391: case 402: case 410: case 412: case 413: case 416: case 425: case 431: case 447:
