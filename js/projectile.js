class projectile{
    ...
    update(){
		...
		switch(this.type){
			...
			case 495: case 496: case 499: case 500: case 501: case 508: case 509: case 512:
				delete this.past[0]
        ...
        for(let a=0,la=this.stun>0?2:this.rules.slow?2:this.rules.fast?6:4;a<la;a++){
			switch(this.type){
				...
				case 435: case 438: case 448: case 509:
