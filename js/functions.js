...
function backed(){
    return game.level==25||game.level==26||game.level==54||game.level==55||game.level==61||game.level==65||game.level==67||game.level==68||game.level==69||game.level==71||
        ...
        game.level==98||game.level==99||game.level==102||game.level==104||game.level==105
}
...
function displayMain(layer,effective,keyStore){
    ...
    if(
        ...
        game.level==96||game.level==97||game.level==98||game.level==99||game.level==100||game.level==101||game.level==103||game.level==104||game.level==105
    ){
        image(
            graphics.overlay[0],
...
function generateLevel(info,layer){
    ...
    switch(game.level){
        ...
        break
        case 55: case 65: case 89: case 90: case 92: case 94:
                    ...
                    switch(level[a][b]){
                        case '>':
                            if(!reject.includes(a*lb+b)){
                                ...
                                if(game.level==30&&level[a][b-1]=='_'&&level[a][b+1]=='c'){
                                ...
                                }else if((game.level==25||game.level==26||game.level==30||game.level==36||game.level==56||game.level==73||game.level==88||game.level==104||game.level==105)&&level[a][b-1]=='m'){
                                    ...
                                    game.level==97||game.level==98&&g==0||game.level==99||game.level==102||game.level==103||game.level==104||game.level==105
                                )&&(
                                    level[a][b-1]=='.'||
                                    ...
                                    a<la-2&&level[a+1][b]=='.'&&level[a+2][b+1]=='.'&&(game.level==89||game.level==90||game.level==94)
                                )){
                        ...
                        case '<':
                            if(!reject.includes(a*lb+b)){
                                ...
                                if(game.level==30&&level[a][b-1]=='_'&&level[a][b+1]=='#'){
                                    ...
                                    level[a][b+1]=='>'&&game.level==42||
                                    a<la-1&&level[a+1][b+1]=='.'&&level[a+1][b]==']'&&level[a][b+1]!='<'&&(game.level==89||game.level==90||game.level==94)
                                )){
                                    if(level[a][b-1]=='#'||(game.level==42||(game.level==67||game.level==77||game.level==78||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99)&&(b>=lb/2+30||b<=lb/2-30)||game.level==68&&b>=30)&&level[a+1][b]=='#'){
                                        for(let e=0,le=extent+1;e<le;e++){
                                            level[a+e]=level[a+e].substr(0,b-e)+'['+level[a+e].substr(b-e+1)
                                            if(reject.includes((a+e)*lb+(b-e))){
                                                reject.splice(reject.indexOf((a+e)*lb+(b-e)),1)
                    ...
                    switch(level[a][b]){
                        case '[':
                            if(!reject.includes(a*lb+b)){
                                ...
                                reject.push(a*lb+b)
                                if((game.level==25||game.level==26||game.level==30||game.level==36||game.level==56||game.level==73||game.level==88||game.level==104||game.level==105)&&level[a][b-1]=='m'){
                                    ...
                                    game.level==99||game.level==102||game.level==103||game.level==104||game.level==105
                                )&&(
                                    level[a][b-1]=='.'||
                                    level[a][b-1]=='c'||
                                    ...
                                    if(level[a][b+1]=='#'||(game.level==67||game.level==68||game.level==77||game.level==78||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99)&&level[a+1][b]=='#'){
                                        for(let e=0,le=extent+1;e<le;e++){
                                            level[a-e]=level[a-e].substr(0,b+e)+'<'+level[a-e].substr(b+e+1)
                                            if(reject.includes((a-e)*lb+(b+e))){
                                                reject.splice(reject.indexOf((a-e)*lb+(b+e)),1)
                        ...
                        case ']':
                            if(!reject.includes(a*lb+b)){
                                ...
                                for(let e=1,le=min(a+1,b+1);e<le;e++){
                                    if(level[a-e][b-e]==']'&&level[a-e-1][b-e]!=']'){
                                        let valid=true
                                        for(let f=0,lf=(game.level==89||game.level==90||game.level==94?e+1:e);f<lf;f++){
                                            if(level[a-e][b-f]!='#'&&level[a-e][b-f]!='.'||reject.includes((a-e)*lb+(b-f))){
                                                valid=false
                                            }
                                        }
                                ...
                                if((game.level==25||game.level==26||game.level==30||game.level==36||game.level==56||game.level==73||game.level==88||game.level==104||game.level==105)&&level[a][b+1]=='m'){
                                    ...
                                    if(level[a][b-1]=='#'||(game.level==67||game.level==77||game.level==78||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99)&&level[a+1][b]=='#'){
                                        for(let e=0,le=extent+1;e<le;e++){
                                            level[a-e]=level[a-e].substr(0,b-e)+'>'+level[a-e].substr(b-e+1)
                                            if(reject.includes((a-e)*lb+(b-e))){
                                                reject.splice(reject.indexOf((a-e)*lb+(b-e)),1)
            ...
            switch(level[a][b]){
				case '#': case '.':
                    if(level[a][b]=='.'&&(game.level==19||game.level==31)){
                        ...
                        game.level==86||game.level==87||game.level==88||game.level==89||game.level==90||game.level==91||game.level==92||game.level==93||game.level==94||game.level==95||
                        game.level==96||game.level==97||game.level==98||game.level==99||game.level==102||game.level==104||game.level==105
                ...
                case '@':
                    switch(game.level){
                        ...
                        break
                        case 23: case 35: case 67: case 68: case 77: case 78: case 95: case 96: case 97: case 98: case 99:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0],game.tileset[1],2))
                        break
                        default:
                ...
                case '!':
                    ...
                    switch(game.level){
                        ...
                        break
                        case 67: case 77: case 78: case 95: case 96: case 97: case 98: case 99:
                ...
                case '$':
                    switch(game.level){
                        ...
                        break
                        case 68: case 69: case 96: case 97:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,69))
                        break
                        case 72: case 81:
                        ...
                        case 88: case 91:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,68))
                        break
                        case 89: case 90: case 94: case 104: case 105:
                ...
                case '|':
                    switch(game.level){
                        ...
                        case 92: case 95: case 96: case 97: case 98: case 99: case 102: case 104: case 105:
                            if(a<la-2&&level[a+1][b]=='a'&&level[a+2][b]=='a'&&(game.level==64||game.level==70||game.level==84)){
                                ...
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1.5)*game.tileset[1],game.tileset[0]*0.15,game.tileset[1]*3,7))
                            }else if((a>0&&level[a-1][b]=='m'||a>1&&level[a-2][b]=='m')&&game.level!=104&&game.level!=105){
                                ...
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1.5)*game.tileset[1],game.tileset[0]*0.15,game.tileset[1]*3,7))
                            }else if(a<la-1&&(level[a+1][b]=='>'||level[a+1][b]=='<'||level[a+1][b]=='-'||level[a+1][b]=='N'||level[a+1][b]=='1'||level[a+1][b]=='2'||level[a+1][b]=='3'||level[a+1][b]=='4'||level[a+1][b]=='5'||level[a+1][b]=='a'&&game.level==69||level[a+1][b]=='^'||level[a+1][b]=='!'||level[a+1][b]=='?'&&game.level==91)){
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1)*game.tileset[1],game.tileset[0]*0.15,game.tileset[1]*2,7))
                            }else{
                ...
                case '_':
                    switch(game.level){
                        ...
                        case 89: case 90: case 92: case 94: case 102:
                            if(level[a][b-1]=='['||level[a][b-1]=='>'){
                                entities.walls[0].splice(0,0,new wall(graphics.main,b*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0]*2,game.tileset[1]*0.4,24))
                            }else if(level[a][b+1]==']'||level[a][b+1]=='<'){
                                entities.walls[0].splice(0,0,new wall(graphics.main,game.tileset[0]+b*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0]*2,game.tileset[1]*0.4,24))
                        ...
                        case 88: case 91: case 104: case 105:
                            ...
                            if(level[a+1][b]==':'){
                                if(game.level==104||game.level==105){
                            ...
                            if(!reject.includes(a*lb+b)){
                                ...
                                for(let e=1,le=level[0].length-a;e<le;e++){
                                    if(level[a][b+e]=='<'){
                                        ...
                                        extent+=game.level==101||game.level==103?1:0.5
                                    }else if(level[a][b+e]=='='){
                                        reject.push(a*lb+b+e)
                                        extent++
                                    }else{
                    ...
                    switch(game.level){
                        ...
                        case 93:
                            if(b>lb/2){
                                ...
                                entities.walls[1].push(new wall(graphics.main,(b-2)*game.tileset[0],(a+1.5)*game.tileset[1],game.tileset[0]*6,game.tileset[1]*3,60))
                            }
                        break
                        case 104: case 105:
                ...
                case 'a':
                    switch(game.level){
                        ...
                        case 28:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,57))
                        break
                        case 62: case 64: case 70: case 71: case 72: case 74: case 81: case 84: case 93:
                ...
                case 'b':
                    switch(game.level){
                        ...
                        case 54:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,65))
                        break
                        case 67: case 68: case 75: case 77: case 78: case 86: case 87: case 95: case 96: case 97: case 98: case 99:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,70))
                        break
                        case 93:
                ...
                case 'c':
                    switch(game.level){
                        ...
                        case 85: case 88: case 91: case 92: case 95: case 100: case 101: case 103: case 105:
                ...
                case 'd':
                    switch(game.level){
                        ...
                        case 19: case 22: case 23: case 31: case 35: case 100: case 101: case 103:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a-0.5)*game.tileset[1],game.tileset[0],game.tileset[1]*2,17))
                        break
                        case 25: case 26: case 28: case 30: case 49: case 54: case 56: case 104: case 105:
                        ...
                        case 60:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,70))
                        break
                        case 67: case 77: case 78: case 95: case 97: case 99:
                            if(!game.classWeapon){
                ...
                case 'g':
                    switch(game.level){
                        ...
                        break
                        case 60: case 61: case 64: case 70: case 84: case 102:
                ...
                case ':':
                    switch(game.level){
                        ...
                        case 62: case 65: case 72: case 74: case 75: case 79: case 81: case 92: case 93:
    ...
    for(let a=0,la=clumper.length;a<la;a++){
        while(clumper[a].length>0){
            entities.walls[game.level==61||game.level==102?1:0].splice(0,0,clumper[a][0])
    ...
    let shifter=0
    if(game.level==23||game.level==26||game.level==28||game.level==32||game.level==33||game.level==63||game.level==101||game.level==103||game.level==105){
        shifter=floor(random(0,4))
    }else if(game.level==39||game.level==42){
        shifter=floor(random(0,6))
    }else if(game.level==43||game.level==49||game.level==84||game.level==85||game.level==89||game.level==94){
    ...
    if(!(game.level==81&&!game.firstGen)){
        for(let c=0,lc=game.players;c<lc;c++){
            ...
            let encode=teamMode()?'q':game.level==89||game.level==94?'12345'[(postC+shifter)%5]:game.level==43||game.level==49||game.level==84||game.level==85?'qwert'[(postC+shifter)%5]:game.level==39||game.level==42?'qwerty'[(postC+shifter)%5]:(game.level==23||game.level==26||game.level==28||game.level==32||game.level==33||game.level==63||game.level==101||game.level==105)&&postC<4?'qwer'[(postC+shifter)%4]:'qwerty'[postC%6]
            for(let a=0,la=level.length;a<la;a++){
                for(let b=0,lb=level[a].length;b<lb;b++){
                    if(game.attacker&&game.level!=13&&game.level!=14&&game.level!=48&&game.level!=57){
                        ...
                        if(
                            ...
                            game.level!=89&&game.level!=94&&int(level[a][b])==((game.level==48||game.level==57||game.level==80)&&c>=game.gaming&&lc>5?5:game.level==34||game.level==96||game.level==97?0:game.level==32?1:game.level==27?c%5:c)+1&&(!game.pvp||game.level==13||game.level==14||game.level==48||game.level==57)
                        ){
                            entities.players.push(new player(layer,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],c+1,0,[],true,type,game.index))
                            if(!game.classicWeapon&&c<game.gaming&&game.level!=13&&game.level!=14&&game.level!=48){
                                game.weaponTick[c]++
        ...
        case 99:
            if(game.level==81&&!game.firstGen){
                ...
                for(let c=0,lc=2;c<lc;c++){
                    for(let a=0,la=level.length;a<la;a++){
                        for(let b=0,lb=level[a].length;b<lb;b++){
                            if(level[a][b]==(game.level==77?'er':game.level==67||game.level==76||game.level==78||game.level==81||game.level==88||game.level==95||game.level==98||game.level==99?'qw':'qt')[c]){
    ...
    if(display.cycle>=types.mission[game.mission].wave.length){
        ...
        for(let a=0,la=types.mission[game.mission].wave[display.cycle].length;a<la;a++){
            let spy=types.mission[game.mission].wave[display.cycle][a][0]=='Spy'||
                ...
                types.mission[game.mission].wave[display.cycle][a][0]=='ShotgunSpy'||
                types.mission[game.mission].wave[display.cycle][a][0]=='HeavySpy'||
                types.mission[game.mission].wave[display.cycle][a][0]=='GrenadierSpy'||
            ...
            if(types.mission[game.mission].wave[display.cycle][a][0].includes('Boss')){
                if(supporting){
                    game.stack.splice(floor(random(0,game.stack.length)),0,[spy?-1:floor(random(0,6))+6,types.mission[game.mission].wave[display.cycle][a][0],0])
                }else{
                ...
                if(game.stack.length>0&&game.stack[0][1]!='Wait'){
                    if(game.level==42&&game.pvp){
                        ...
                        let key=game.level==89||game.level==94?'qwe'[game.spawnPoint]:
                            ...
                            game.level==34||game.level==47||game.level==54||game.level==58||game.level==59||game.level==63||game.level==66||game.level==68||game.level==69||game.level==87||game.level==96||game.level==97?'A':
                            game.level==79||game.level==82||game.level==83||game.level==85||game.level==86||game.level==101||game.level==103?'AB'[game.stack[0][0]%2]:
                                ...
                                if(level[a][b]==key){
                                    if((a>5||floor(random(0,2))==0&&types.player[findName(game.stack[0][1],types.player)].sizeBuff>=1.5)&&game.stack[0][0]>=6&&game.level==8||game.level==16){
                                        ...
                                        if(game.level==6||game.level==24||game.level==39&&game.pvp){
                                            ...
                                            entities.players[entities.players.length-1].position.y=0
                                            entities.players[entities.players.length-1].parachute=true
                                        }else if((game.level==30||game.level==40)&&a<=5||(game.level==35||game.level==79||game.level==82||game.level==103)&&floor(random(0,10))==0||game.level==102){
...
function initialGraphics(){
    if(
        ...
        menu.level==96||menu.level==97||menu.level==98||menu.level==99||menu.level==100||menu.level==101||menu.level==103||game.level==104||game.level==105
    ){
