...
function updateRules(){
    ...
    rules.grad=game.level==15||game.level==18||game.level==30||game.level==36||game.level==37||game.level==38||game.level==40||game.level==41||game.level==43||game.level==44||
        ...
        game.level==123||game.level==125||game.level==128||game.level==131||game.level==134||game.level==135||game.level==136||game.level==137
        ?1:
        ...
        game.level==129||game.level==130||game.level==132||game.level==133||game.level==138
        ?2:0
    ...
    rules.overlay=game.level==19||game.level==22||game.level==23||game.level==24||game.level==25||game.level==26||game.level==27||game.level==28||game.level==29||game.level==30||
        ...
        game.level==130||game.level==131||game.level==132||game.level==133||game.level==134||game.level==135||game.level==136||game.level==137||game.level==138||game.level==140
    ...
    rules.key={
        info:game.level==61||game.level==64||game.level==67||game.level==68||game.level==70||game.level==74||game.level==76||game.level==77||game.level==78||game.level==84||
            ...
            game.level==123||game.level==124||game.level==133||game.level==134||game.level==135||game.level==137||game.level==138?
                250:
            game.level==71?
                150:
                180,
        wallInfo:game.level==61||game.level==64||game.level==67||game.level==68||game.level==70||game.level==74||game.level==77||game.level==78||game.level==84||game.level==86||
            ...
            game.level==124||game.level==133||game.level==134||game.level==135||game.level==137||game.level==138?
                250:
                game.level==71?
                150:
                180,
        ...
        spawnTimeMult:(game.level==7?3:1)*
            ...
            (game.level==33||game.level==87||game.level==138?1.25:1)*
            (game.level==34?0.925:1)*
            (game.level==30&&game.spawnIndex<20?0.4:1)*
            //(game.level==40?0.875:1)*
            (game.level==41||game.level==55?1.125:1)*
...
function getKey(spawn){
    return game.level==89||game.level==94?'qwe'[game.spawnPoint]:
        ...
        game.level==138?'ABCD'[floor(random(0,4))]:
        ...
        game.level==100||game.level==140?'AB'[spawn==11?1:0]:
        '123456ABCDEF'[spawn]
}
...
function generateLevel(info,layer){
    ...
    switch(game.level){
        ...
        case 61: case 102: case 123:
            game.edge=[level[0].length*44,level.length*36]
        break
        case 62: case 72: case 81: case 136:
        ...
        case 131:
            ...
            game.sectors=[
                ...
                //[game.tileset[0]*84.25,game.tileset[1]*18.5,game.tileset[0]*27.5,game.tileset[1]*3],
                [game.tileset[0]*84.25,game.tileset[1]*15,game.tileset[0]*27.5,game.tileset[1]*10],
                ...
                //[game.tileset[0]*60.5,game.tileset[1]*18.5,game.tileset[0]*20,game.tileset[1]*3],
                ...
                //[game.tileset[0]*51.5,game.tileset[1]*32.5,game.tileset[0]*45,game.tileset[1]*5],
                ...
                //[game.tileset[0]*28,game.tileset[1]*33.5,game.tileset[0]*2,game.tileset[1]*3],
                //[game.tileset[0]*20,game.tileset[1]*32.5,game.tileset[0]*14,game.tileset[1]*5],
                //[game.tileset[0]*28,game.tileset[1]*31,game.tileset[0]*2,game.tileset[1]*2],

                //[game.tileset[0]*42.5,game.tileset[1]*27.5,game.tileset[0]*21,game.tileset[1]*5],
                [game.tileset[0]*37.5,game.tileset[1]*27.5,game.tileset[0]*31,game.tileset[1]*5],
                ...
                [game.tileset[0]*60.5,game.tileset[1]*12.5,game.tileset[0]*20,game.tileset[1]*5],
                //[game.tileset[0]*70.5,game.tileset[1]*15.5,game.tileset[0]*20,game.tileset[1]*3],
            ]
        break
        case 132:
            game.edge=[level[0].length*42,level.length*38]
        ...
        case 138:
            ...
            game.sectors=[
                ...
                [game.tileset[0]*35,game.tileset[1]*21.5,game.tileset[0]*12,game.tileset[1]*3],
                [game.tileset[0]*23.5,game.tileset[1]*17,game.tileset[0]*35,game.tileset[1]*6],
                [game.tileset[0]*94,game.tileset[1]*49,game.tileset[0]*130,game.tileset[1]*6],

                [game.tileset[0]*179.5,game.tileset[1]*50.5,game.tileset[0]*41,game.tileset[1]*7],
                [game.tileset[0]*157.5,game.tileset[1]*36,game.tileset[0]*85,game.tileset[1]*10],
                [game.tileset[0]*106,game.tileset[1]*40,game.tileset[0]*18,game.tileset[1]*12],
                [game.tileset[0]*179.5,game.tileset[1]*43.5,game.tileset[0]*41,game.tileset[1]*7],
                [game.tileset[0]*157.5,game.tileset[1]*26,game.tileset[0]*85,game.tileset[1]*10],
        ...
        case 140:
            ...
            game.sectors=[
                ...
                [game.tileset[0]*29.5,game.tileset[1]*45,game.tileset[0]*27,game.tileset[1]*6],
                [game.tileset[0]*46.5,game.tileset[1]*44.5,game.tileset[0]*7,game.tileset[1]*5],
                [game.tileset[0]*85.5,game.tileset[1]*52,game.tileset[0]*25,game.tileset[1]*10],
                [game.tileset[0]*77.5,game.tileset[1]*44.5,game.tileset[0]*41,game.tileset[1]*5],
                ...
                [game.tileset[0]*118.5,game.tileset[1]*45,game.tileset[0]*40,game.tileset[1]*6],
                [game.tileset[0]*27,game.tileset[1]*34.5,game.tileset[0]*24,game.tileset[1]*5],
                [game.tileset[0]*44.25,game.tileset[1]*34.5,game.tileset[0]*10.5,game.tileset[1]*5],
                [game.tileset[0]*51.75,game.tileset[1]*29.5,game.tileset[0]*11.5,game.tileset[1]*5],
                [game.tileset[0]*64.75,game.tileset[1]*29.5,game.tileset[0]*14.5,game.tileset[1]*5],

                [game.tileset[0]*37,game.tileset[1]*29.5,game.tileset[0]*18,game.tileset[1]*5],
                [game.tileset[0]*67.5,game.tileset[1]*24.5,game.tileset[0]*47,game.tileset[1]*5],
                [game.tileset[0]*87.25,game.tileset[1]*29.5,game.tileset[0]*4.5,game.tileset[1]*5],
                [game.tileset[0]*92.5,game.tileset[1]*34.5,game.tileset[0]*57,game.tileset[1]*5],
                [game.tileset[0]*107.25,game.tileset[1]*29.5,game.tileset[0]*3.5,game.tileset[1]*5],

                [game.tileset[0]*118,game.tileset[1]*29.5,game.tileset[0]*18,game.tileset[1]*5],
                [game.tileset[0]*126.5,game.tileset[1]*34.5,game.tileset[0]*11,game.tileset[1]*5],
                [game.tileset[0]*136,game.tileset[1]*34.5,game.tileset[0]*8,game.tileset[1]*5],
                [game.tileset[0]*54.75,game.tileset[1]*34.5,game.tileset[0]*10.5,game.tileset[1]*5],
                [game.tileset[0]*93.5,game.tileset[1]*29.5,game.tileset[0]*8,game.tileset[1]*5],
                
                [game.tileset[0]*101.5,game.tileset[1]*29.5,game.tileset[0]*8,game.tileset[1]*5],
                [game.tileset[0]*58,game.tileset[1]*52,game.tileset[0]*30,game.tileset[1]*10],
                [game.tileset[0]*101,game.tileset[1]*24.5,game.tileset[0]*20,game.tileset[1]*5],
                [game.tileset[0]*95.25,game.tileset[1]*39.5,game.tileset[0]*11.5,game.tileset[1]*5],
                [game.tileset[0]*41.5,game.tileset[1]*39.5,game.tileset[0]*16,game.tileset[1]*5],
            ]
    ...
    switch(game.level){
        ...
        break
        case 22: case 23: case 35: case 100: case 101: case 103: case 140:
        ...
        break
        case 64: case 70: case 84: case 124: case 138:
    ...
    let reject=[]
    let clumper=[[],[]]
    if(game.level==58||game.level==63||game.level==64||game.level==66||game.level==70||game.level==84||game.level==124||game.level==138){
        for(let a=0,la=level.length;a<la;a++){
            for(let b=0,lb=level[a].length;b<lb;b++){
    ...
    let diag=[
        ...
        game.level==47||game.level==49||game.level==52||game.level==54||game.level==55||game.level==59||game.level==60||game.level==61||game.level==65||game.level==69||
        game.level==75||game.level==76||game.level==77||game.level==79||game.level==82||game.level==83||game.level==85||game.level==86||game.level==87||game.level==88||
        game.level==89||game.level==90||game.level==91||game.level==92||game.level==94||game.level==95||game.level==96||game.level==97||game.level==99||game.level==102||
        game.level==103||game.level==104||game.level==105||game.level==107||game.level==110||game.level==111||game.level==113||game.level==119||game.level==120||game.level==122||
        game.level==123||game.level==125||game.level==126||game.level==127||game.level==131||game.level==132||game.level==133||game.level==134||game.level==135||game.level==136,
        ...
        game.level==134||game.level==135||game.level==136,
                        ...
                        case '>':
                            if(!reject.includes(a*lb+b)){
                                ...
                                if(game.level==30&&level[a][b-1]=='_'&&level[a][b+1]=='c'){
                                    ...
                                    diag[0]||
                                    (game.level==67||game.level==68||game.level==78||game.level==98)&&g==0
                                )&&(
                                    level[a][b-1]=='.'||
            ...
            switch(level[a][b]){
				case '#': case '.':
                    if(level[a][b]=='.'&&(game.level==19||game.level==31)){
                        ...
                        game.level==132||game.level==133||game.level==133||game.level==134||game.level==135||game.level==136
                ...
                case '@':
                    switch(game.level){
                        ...
                        break
                        case 136:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0],game.tileset[1],4))
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]*0.25+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.5,game.tileset[1],43))
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]*1.75+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.5,game.tileset[1],43))
                        break
                        default:
                ...
                case '!':
                    ...
                    switch(game.level){
                        ...
                        case 125: case 126: case 127: case 128: case 129: case 130: case 131: case 133: case 137: case 138:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,16))
                            entities.walls[1][entities.walls[1].length-1].weapon=weaponize(cluster)
                        break
                        ...
                        break
                        case 100: case 101: case 102: case 103: case 140:
                        ...
                        break
                        case 136:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]*10.5+b*game.tileset[0],game.tileset[1]/2+(a+0.1)*game.tileset[1],game.tileset[0]*21,game.tileset[1]*0.8,3))
                        break
                        default:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a+0.1)*game.tileset[1],game.tileset[0],game.tileset[1]*0.8,3))
                        break
                ...
                case '$':
                    switch(game.level){
                        ...
                        break
                        case 64: case 70: case 84: case 108: case 109: case 112: case 124: case 128: case 129: case 138:
                ...
                case '|':
                    switch(game.level){
                        ...
                        case 126: case 127: case 128: case 131: case 134: case 135: case 136: case 137: case 138:
                            if(a<la-2&&level[a+1][b]=='a'&&level[a+2][b]=='a'&&(game.level==64||game.level==70||game.level==84||game.level==124||game.level==138)){
                            ...
                            }else if(a<la-1&&level[a+1][b]=='a'&&(game.level==64||game.level==70||game.level==84||game.level==124||game.level==138)){
                        ...
                        /*case 140:
                            if(a>0&&(level[a-1][b]==']'||level[a-1][b]=='[')){
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],a*game.tileset[1],game.tileset[0]*0.15,game.tileset[1]*2,7))
                            }else if(a<la-1&&(level[a+1][b]=='>'&&level[a+1][b+1]!='='||level[a+1][b]=='<')){
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1)*game.tileset[1],game.tileset[0]*0.15,game.tileset[1]*2,7))
                            }else{
                                clumper[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.15,game.tileset[1],7))
                            }
                ...
                case '_':
                    switch(game.level){
                        ...
                        break
                        case 62: case 64: case 70: case 72: case 81: case 84: case 124: case 138:
                            if(level[a][b-1]=='['||level[a][b-1]=='>'){
                        ...
                        break
                        case 136:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1)*game.tileset[1],game.tileset[0]*0.2,game.tileset[1]*2,74))
                        break
                        default:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0],game.tileset[1]*0.4,24))
                        break
                ...
                case '-':
                    switch(game.level){
                        ...
                        break
                        case 70: case 138:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a+0.35)*game.tileset[1],game.tileset[0],game.tileset[1]*0.3,11))
                        break
                        case 82: case 83: case 85:
                        ...
                        break
                        case 100: case 101: case 103: case 140:
                ...
                case '&':
                    switch(game.level){
                        ...
                        break
                        case 140:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1)*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,12))
                        break
                        default:
                ...
                case '`':
                    switch(game.level){
                        ...
                        break
                        /*case 136:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]*0.8+a*game.tileset[1],game.tileset[0],game.tileset[1],13))
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]*0.15+a*game.tileset[1],game.tileset[0],game.tileset[1]*0.3,1))
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]*1.65+a*game.tileset[1],game.tileset[0],game.tileset[1]*0.7,1))
                        break*/
                        default:
                        ...
                        default:
                            if(!reject.includes(a*lb+b)){
                                ...
                                switch(game.level){
                                    ...
                                    case 111: case 113: case 119: case 121: case 130: case 136:
                                        if(level[a][b-1]=='>'){
                                            clumper[1].push(new wall(graphics.main,game.tileset[0]/2+(b+extent/2-0.5)*game.tileset[0],(a+0.15)*game.tileset[1],game.tileset[0]*(2+extent),game.tileset[1]*0.3,37))
                                        }else if(level[a][b-1]=='['){
                                            clumper[1].push(new wall(graphics.main,game.tileset[0]/2+(b+extent/2-0.25)*game.tileset[0],(a+0.15)*game.tileset[1],game.tileset[0]*(1.5+extent),game.tileset[1]*0.3,37))
                                    ...
                                    case 49: case 131:
                                        ...
                                        for(let c=0,lc=1+extent;c<lc;c++){
                                            if(level[a+1][b+c]==':'){
                                                clumper[0].push(new wall(graphics.main,game.tileset[0]/2+(b+c)*game.tileset[0],game.tileset[1]*0.7+a*game.tileset[1],game.tileset[0]*0.25,game.tileset[1]*0.6,38))
                                            }else if(level[a+1][b+c]==';'){
                                                clumper[0].push(new wall(graphics.main,game.tileset[0]/2+(b+c)*game.tileset[0],game.tileset[1]*0.7+a*game.tileset[1],game.tileset[0]*0.25,game.tileset[1]*0.6,56))
                                            }else if(level[a+1][b+c]=='|'){
                                    ...
                                    break
                                    default:
                                        if(level[a][b-1]=='>'&&(game.level==22||game.level==100||game.level==101||game.level==103||game.level==140)){
                ...
                case '~':
                    switch(game.level){
                        ...
                        case 75: case 104: case 105: case 114: case 118: case 121: case 122: case 125: case 132: case 137:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,16))
                        ...
                        case 59:
                            ...
                            entities.walls[1][entities.walls[1].length-1].weapon=weaponize(cluster)
                        break
                        case 64: case 68: case 70: case 84: case 96: case 97: case 98: case 99: case 124: case 138:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,61))
                        break
                ...
                case '/':
                    switch(game.level){
                        ...
                        case 126:
                            if(b>lb/2){
                                entities.walls[0].push(new wall(gwraphics.main,(b+2.5)*game.tileset[0],(a+1)*game.tileset[1],game.tileset[0]*5,game.tileset[1]*2,59))
                            }else{
                        ...
                        break
                        case 137:
                            entities.walls[1].push(new wall(graphics.main,(b+2.5)*game.tileset[0],(a+1)*game.tileset[1],game.tileset[0]*5,game.tileset[1]*2,59))
                        break
                        default:
                ...
                case 'a':
                    switch(game.level){
                        ...
                        case 118: case 119: case 120: case 122: case 123: case 128: case 131: case 140:
                        ...
                        case 28:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,57))
                        break
                        case 62: case 64: case 70: case 71: case 72: case 74: case 81: case 84: case 93: case 107: case 138:
                        case 111: case 124: case 137:
                        ...
                        break
                        case 136:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a-1)*game.tileset[1],game.tileset[0],game.tileset[1]*3,18))
                        break
                ...
                case 'b':
                    switch(game.level){
                        ...
                        break
                        case 22: case 35: case 100: case 101: case 103: case 140:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.15,game.tileset[1],7))
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a+0.25)*game.tileset[1],game.tileset[0],game.tileset[1]*0.5,11))
                        break
                        case 23:
                        ...
                        break
                        case 136:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]*0.85+b*game.tileset[0],-game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.3,game.tileset[1],18))
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]*0.15+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.3,game.tileset[1],18))
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]*0.65+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.7,game.tileset[1],1))
                        break
                        default:
                ...
                case 'c':
                    switch(game.level){
                        ...
                        case 111: case 119: case 120: case 126: case 131: case 132: case 134: case 135: case 136: case 140:
                ...
                case 'f':
                    switch(game.level){
                        ...
                        case 127: case 128: case 129: case 130: case 131: case 132: case 137: case 138: case 140:
                            if(!duel.trigger){
                                entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,57))
                            }
                        break
                ...
                case 'g':
                    switch(game.level){
                        ...
                        break
                        case 60: case 61: case 64: case 70: case 84: case 102: case 122: case 123: case 124: case 138:
                        ...
                        case 97:
                            ...
                            entities.walls[0].push(new wall(graphics.main,(b+0.5)*game.tileset[0],(a+1.5)*game.tileset[1],game.tileset[0]*3,game.tileset[1]*3,59))
                        break
                        case 100: case 101: case 103: case 104: case 105: case 107: case 111: case 114: case 140:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,70))
                        break
                        case 110: case 127:
                            entities.walls[2].push(new wall(graphics.main,b*game.tileset[0],a*game.tileset[1],0,0,3))
                    ...
                    switch(game.level){
                        ...
                        case 136:
                            if(game.classicRespawn){
                                entities.walls[1].push(new wall(graphics.main,game.tileset[0]+b*game.tileset[0],game.tileset[1]*2+a*game.tileset[1],game.tileset[1]*8,game.tileset[1]*4,31))
                            }
                        break
                        case 140:
                            ...
                            last(entities.walls[0]).vv2=true
                        break
                        default:
                ...
                case ':':
                    switch(game.level){
                        ...
                        case 118: case 119: case 122: case 125: case 128: case 137:
                        ...
                        break
                        default:
                            if(game.level==22||a>10&&a<la-10&&(game.level==23||game.level==35)||game.level==37||game.level==43||game.level==47||game.level==85||game.level==100||game.level==101||game.level==103||game.level==140){
                ...
                case 'z':
                    switch(game.level){
                        ...
                        break
                        case 140:
                            clumper[1].push(new wall(graphics.main,(b+1.5)*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0]*5,game.tileset[1]*0.4,37))
                        break
                    }
                break
                case 'x':
                ...
                case ';':
                    switch(game.level){
                        case 22: case 23: case 100: case 101: case 103: case 140:
                        ...
                        case 88:
                            ...
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],-game.tileset[1]*0.5+a*game.tileset[1],game.tileset[1]*8,game.tileset[1]*4,33))
                        break
                        case 89: case 90: case 94: case 105: case 110: case 127: case 133:
                            if(game.pvp){
                                if(b>=lb/2){
                                    entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],(a+1.5)*game.tileset[1],game.tileset[0]*0.2,game.tileset[1]*3,74))
                                    entities.walls[1].push(new wall(graphics.main,game.tileset[0]*5.5+b*game.tileset[0],game.tileset[1]+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,75))
                        ...
                        break
                        case 137:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]*0.2+b*game.tileset[0],(a+0.5)*game.tileset[1],game.tileset[1]*0.4,game.tileset[1],20))
                        break
                    }
                break
                case 'r':
    ...
    switch(game.level){
        ...
        case 140:
            set=[
                ...
                [77,27,[-90,90,90,90],[0,1,3,4]],
                [77,37,[-90,90,90,90],[0,1,2,3]],
                [77,57,[-90,90,90,90],[0,2,3,4]],
                [33,42.5,[180,0,90,90],[1,2,3,4]],
                [121,42.5,[-90,-90,90,-90],[0,1,2,4]],
                [93,42.5,[-90,180,0,90,0],[0,1,2,3,4]],
                [53,42.5,[0,90,90,90,90],[0,1,2,3,4]],
            ]
            for(let a=0,la=set.length;a<la;a++){
    ...
    switch(game.level){
        ...
        break
        case 136:
            graphics.gradient=[new p5.LinearGradient(92,graphics.main[0].height)]
            graphics.gradient[0].colors(
                0.0,color(-75,-100,-25),
                1.0,color(35,25,55)
            )
                ...
                for(let b=0,lb=level[a].length;b<lb;b++){
                    if(game.attacker&&game.level!=13&&game.level!=14&&game.level!=48&&game.level!=57){
                        ...
                        if(level[a][b]==encode&&game.pvp){
                            ...
                            if((game.level==8||game.level==17||game.level==136)&&a<5){
    ...
    [`formBoundary`,`checkPrimary`,`checkRedundancy`,`checkOverlay`,`checkGap`].forEach(fun=>entities.walls.forEach(set=>set.forEach(item=>item[fun]())))
    switch(game.level){
    ...
    if(rules.backed){
        /*if(game.pane){
            ...
            run.fore=[entities.walls[2],entities.projectiles,entities.players,entities.walls[1],entities.walls[0]]
        }*/
        run.fore=game.pane?
            [entities.walls[2],entities.projectiles,entities.players,entities.walls[1]]:
            [entities.walls[2],entities.projectiles,entities.players,entities.walls[1],entities.walls[0]]
    ...
    switch(game.level){
        ...
        case 120: case 124: case 125: case 126: case 127: case 129: case 130: case 137:
            ticker=0
            for(let a=0,la=entities.walls[1].length;a<la;a++){
                if(entities.walls[1][a].type==31||entities.walls[1][a].type==33||entities.walls[1][a].type==36||entities.walls[1][a].type==42){
        ...
        case 99: case 132: case 133: case 134: case 135:
            if(game.level==81&&!game.firstGen){
                ...
                for(let a=0,la=game.players;a<la;a++){
                    ...
                    entities.players[a].position.x=entities.players[a].base.position.x
                    entities.players[a].position.y=entities.players[a].base.position.y
...
function newWave(){
    if(display.cycle>=types.mission[game.mission].wave.length){
        ...
        if(game.level!=37){
            ...
            if(game.level!=6&&game.level!=7&&game.level!=8&&game.level!=17&&game.level!=136){
        ...
        if(game.noEnemy){
            ...
            for(let g=0,lg=10;g<lg;g++){
                            ...
                            for(let b=0,lb=level[a].length;b<lb;b++){
                                if(level[a][b]==key){
                                    if((a>5||floor(random(0,2))==0&&types.player[findName(game.stack[0][1],types.player)].sizeBuff>=1.5)&&game.stack[0][0]>=6&&(game.level==8||game.level==136)||game.level==16){
                                        ...
                                        if(game.level==6||game.level==24||game.level==39&&game.pvp||game.level==136){
                                            ...
                                            entities.players[entities.players.length-1].position.y=0
                                            entities.players[entities.players.length-1].parachute=true
                                        }else if((game.level==30||game.level==40)&&a<=5||(game.level==35||game.level==79||game.level==82||game.level==103||game.level==131)&&floor(random(0,10))==0||game.level==102/*||game.level==131&&floor(random(0,5))==0*/){
                ...
                game.sendTime=time!=undefined?time:game.attacker||game.level==29&&game.initial||game.level==37?0:
                    ...
                    (game.level==100||game.level==140?constrain(0.7+0.025*total,1,1.5):1)*
...
function setupLists(){
    ...
    listing[4]=[
        [
            ...
            [`PlayerKnife`,`PlayerElectricChair`,`PlayerClusterBombC`,`PlayerCritKnife`,`PlayerHealKnife`,`PlayerTeleportKnife`],
