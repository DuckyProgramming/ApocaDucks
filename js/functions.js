...
function teamMode(){
    return menu.level==44||menu.level==65||menu.level==67||menu.level==76||menu.level==77||menu.level==78||menu.level==44||menu.level==65||menu.level==67||menu.level==76||menu.level==77||menu.level==78||menu.level==81||menu.level==88||menu.level==89&&game.pvp||menu.level==94&&game.pvp||menu.level==95||menu.level==98||menu.level==99
}
function backed(){
    return game.level==25||game.level==26||game.level==54||game.level==55||game.level==61||game.level==65||game.level==67||game.level==68||game.level==69||game.level==71||game.level==77||game.level==78||game.level==88||game.level==89||game.level==90||game.level==91||game.level==92||game.level==94||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99||game.level==102
}
...
function displayMain(layer,effective,keyStore){
    ...
    if(
        ...
        game.level==96||game.level==97||game.level==98||game.level==99||game.level==100||game.level==101
    ){
        image(
            graphics.overlay[0],
...
function generateLevel(info,layer){
    ...
    for(let g=0,lg=
        ...
        game.level==91||game.level==92||game.level==94||game.level==95||game.level==96||game.level==97||game.level==98||game.level==99?
        2:1
    ;g<lg;g++){
        for(let a=0,la=level.length;a<la;a++){
            for(let b=0,lb=level[a].length;b<lb;b++){
                        ...
                        case '>':
                            if(!reject.includes(a*lb+b)){
                                ...
                                if(game.level==30&&level[a][b-1]=='_'&&level[a][b+1]=='c'){
                                    ...
                                    game.level==97||game.level==98&&g==0||game.level==99||game.level==102
                                )&&(
                                    level[a][b-1]=='.'||
            ...
            switch(level[a][b]){
				case '#': case '.':
                    if(level[a][b]=='.'&&(game.level==19||game.level==31)){
                        ...
                        game.level==86||game.level==87||game.level==88||game.level==89||game.level==90||game.level==91||game.level==92||game.level==93||game.level==94||game.level==95||
                        game.level==96||game.level==97||game.level==98||game.level==99||game.level==102
                ...
                case '|':
                    switch(game.level){
                        ...
                        case 92: case 95: case 96: case 97: case 98: case 99: case 102:
                ...
                case 'a':
                    switch(game.level){
                        ...
                        case 56: case 59: case 60: case 61: case 79: case 92: case 100: case 101: case 102:
                ...
                case 'b':
                    switch(game.level){
                        ...
                        break
                        case 22: case 35: case 100: case 101:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[0]*0.15,game.tileset[1],7))
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a+0.25)*game.tileset[1],game.tileset[0],game.tileset[1]*0.5,11))
                        break
                        case 23:
                ...
                case 'c':
                    switch(game.level){
                        ...
                        case 85: case 88: case 91: case 92: case 95: case 100: case 101:
                ...
                case 'd':
                    switch(game.level){
                        ...
                        break
                        case 19: case 22: case 23: case 31: case 35: case 100: case 101:
                            entities.walls[0].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+(a-0.5)*game.tileset[1],game.tileset[0],game.tileset[1]*2,17))
                        break
                ...
                case 'g':
                    switch(game.level){
                        ...
                        break
                        case 59: case 67: case 68: case 69: case 77: case 78: case 79: case 96: case 98:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,68))
                        break
                ...
                case ':':
                    switch(game.level){
                        ...
                        break
                        default:
                            if(game.level==22||a>10&&a<la-10&&(game.level==23||game.level==35)||game.level==37||game.level==43||game.level==47||game.level==85||game.level==100||game.level==101){
                ...
                case ';':
                    switch(game.level){
                        case 22: case 23: case 100: case 101:
    ...
    let shifter=0
    if(game.level==23||game.level==26||game.level==28||game.level==32||game.level==33||game.level==63||game.level==101){
    ...
    if(!(game.level==81&&!game.firstGen)){
        for(let c=0,lc=game.players;c<lc;c++){
            ...
            let encode=teamMode()?'q':game.level==89||game.level==94?'12345'[(postC+shifter)%5]:game.level==43||game.level==49||game.level==84||game.level==85?'qwert'[(postC+shifter)%5]:game.level==39||game.level==42?'qwerty'[(postC+shifter)%5]:(game.level==23||game.level==26||game.level==28||game.level==32||game.level==33||game.level==63||game.level==101)&&postC<4?'qwer'[(postC+shifter)%4]:'qwerty'[postC%6]
            for(let a=0,la=level.length;a<la;a++){
                for(let b=0,lb=level[a].length;b<lb;b++){
        ...
        case 23: case 35: case 101:
            ...
            for(let a=0,la=entities.walls[1].length;a<la;a++){
                if(entities.walls[1][a].type==35){
                    entities.walls[1][a].pos=game.level==101?[1,2,0][ticker]:ticker
                    ticker++
                }
            }
                ...
                if(game.stack.length>0&&game.stack[0][1]!='Wait'){
                    if(game.level==42&&game.pvp){
                        ...
                        let key=game.level==89||game.level==94?'qwe'[game.spawnPoint]:
                            ...
                            game.level==34||game.level==54||game.level==58||game.level==59||game.level==63||game.level==66||game.level==68||game.level==69||game.level==87||game.level==96||game.level==97?'A':
                            game.level==79||game.level==82||game.level==83||game.level==85||game.level==86||game.level==101?'AB'[game.stack[0][0]%2]:
                                ...
                                if(level[a][b]==key){
                                    if((a>5||floor(random(0,2))==0&&types.player[findName(game.stack[0][1],types.player)].sizeBuff>=1.5)&&game.stack[0][0]>=6&&game.level==8||game.level==16){
                                        ...
                                        if(game.level==6||game.level==24||game.level==39&&game.pvp){
                                            ...
                                            entities.players[entities.players.length-1].position.y=0
                                            entities.players[entities.players.length-1].parachute=true
                                        }else if((game.level==30||game.level==40)&&a<=5||(game.level==35||game.level==79||game.level==82)&&floor(random(0,10))==0||game.level==102){
...
function initialGraphics(){
    if(
        ...
        menu.level==96||menu.level==97||menu.level==98||menu.level==99||menu.level==100||menu.level==101
    ){
