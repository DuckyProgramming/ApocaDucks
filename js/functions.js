//basic
function dm(){
    return game.level==36||game.level==41||game.level==45||game.level==50||game.level==51||game.level==52||game.level==53||game.level==56||game.level==60||game.level==61||game.level==62||game.level==64||game.level==71||game.level==72||game.level==73||game.level==74||game.level==75
}
function backed(){
...
function generateLevel(info,layer){
    ...
    let reject=[]
    let clumper=[[],[]]
    if(game.level==58||game.level==63||game.level==64||game.level==66||game.level==70){
        for(let a=0,la=level.length;a<la;a++){
            for(let b=0,lb=level[a].length;b<lb;b++){
                    ...
                    switch(level[a][b]){
                        case '>':
                            if(!reject.includes(a*lb+b)){
                                ...
                                if(game.level==30&&level[a][b-1]=='_'&&level[a][b+1]=='c'){
                                ...
                                }else if((game.level==25||game.level==26||game.level==30||game.level==36||game.level==56||game.level==73)&&level[a][b-1]=='m'){
                                    ...
                                    game.level==68&&g==0||game.level==69||game.level==75
                                )&&(
                                    level[a][b-1]=='.'||
                    ...
                    switch(level[a][b]){
                        case '[':
                            if(!reject.includes(a*lb+b)){
                                ...
                                reject.push(a*lb+b)
                                if((game.level==25||game.level==26||game.level==30||game.level==36||game.level==56||game.level==73)&&level[a][b-1]=='m'){
            ...
            switch(level[a][b]){
				case '#': case '.':
                    if(level[a][b]=='.'&&(game.level==19||game.level==31)){
                        ...
                        game.level==68||game.level==69||game.level==75
                ...
                case '|':
                    switch(game.level){
                        ...
                        case 67: case 68: case 69: case 70: case 72: case 73: case 74: case 75:
                            if(a<la-2&&level[a+1][b]=='a'&&level[a+2][b]=='a'&&(game.level==64||game.level==70)){
                            ...
                            }else if(a<la-1&&level[a+1][b]=='a'&&(game.level==64||game.level==70)){
                ...
                case '_':
                    switch(game.level){
                        ...
                        case 55: case 58: case 59: case 60: case 61: case 63: case 65: case 66: case 73: case 74:
                            if(level[a][b-1]=='['||level[a][b-1]=='>'){
                                entities.walls[0].splice(0,0,new wall(graphics.main,b*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0]*2,game.tileset[1]*0.4,24))
                            }else if(level[a][b+1]==']'||level[a][b+1]=='<'){
                                entities.walls[0].splice(0,0,new wall(graphics.main,game.tileset[0]+b*game.tileset[0],(a+0.2)*game.tileset[1],game.tileset[0]*2,game.tileset[1]*0.4,24))
                        ...
                        break
                        case 62: case 64: case 70: case 72:
                            if(level[a][b-1]=='['||level[a][b-1]=='>'){
                        ...
                        default:
                            if(!reject.includes(a*lb+b)){
                                ...
                                switch(game.level){
                                    ...
                                    break
                                    case 37: case 38: case 41: case 47: case 55: case 65: case 71:
                                        if(level[a][b-1]=='>'){
                                            clumper[1].push(new wall(graphics.main,game.tileset[0]/2+(b+extent/2-0.5)*game.tileset[0],(a+0.15)*game.tileset[1],game.tileset[0]*(2+extent),game.tileset[1]*0.3,37))
                                        }else if(level[a][b-1]=='['){
                                            clumper[1].push(new wall(graphics.main,game.tileset[0]/2+(b+extent/2-0.25)*game.tileset[0],(a+0.15)*game.tileset[1],game.tileset[0]*(1.5+extent),game.tileset[1]*0.3,37))
                ...
                case 'a':
                    switch(game.level){
                        ...
                        break
                        case 62: case 64: case 70: case 71: case 72: case 74:
                ...
                case 'g':
                    switch(game.level){
                        ...
                        case 59: case 67: case 68: case 69:
                            entities.walls[1].push(new wall(graphics.main,game.tileset[0]/2+b*game.tileset[0],game.tileset[1]/2+a*game.tileset[1],game.tileset[1]*0.6,game.tileset[1]*0.6,68))
                        break
                        case 60: case 61: case 64: case 70:
                ...
                case ':':
                    switch(game.level){
                        ...
                        case 62: case 65: case 72: case 74: case 75:
    ...
    switch(game.level){
        ...
        break
        case 36: case 51: case 52: case 62: case 64: case 71: case 72: case 74: case 75:
            ticker=0
            for(let a=0,la=entities.walls[1].length;a<la;a++){
                if(entities.walls[1][a].type==31||entities.walls[1][a].type==33||entities.walls[1][a].type==36||entities.walls[1][a].type==42){
            ...
            for(let g=0,lg=10;g<lg;g++){
                if(game.stack.length>0&&game.stack[0][1]!='Wait'){
                    if(game.level==42&&game.pvp){
                        ...
                        let key=game.level==70?'ABC'[floor(random(0,3))]:
                            game.level==55?'AB'[floor(random(0,1.25))]:
                            game.level==34||game.level==54||game.level==58||game.level==59||game.level==63||game.level==66||game.level==68||game.level==69?'A':
