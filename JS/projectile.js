class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index,args=[]){
		...
		switch(this.type){
			...
			case 78: case 86: case 101: case 187: case 213:
				this.speed=5
				this.time=time
			break
			case 3: case 153:
			...
			case 233: case 235: case 240: case 243: case 245: case 246: case 247: case 248: case 250:
				...
				this.velocity={x:this.speed*lsin(this.direction),y:this.speed*lcos(this.direction)-(this.type==68||this.type==132||this.type==134||this.type==135||this.type==136||this.type==169||this.type==170||this.type==206||this.type==210||this.type==233||this.type==240?0:4)}
				this.goal=-1
				if(this.type==135||this.type==136||this.type==169||this.type==170){
					...
					this.type==182||this.type==183||this.type==210||this.type==227
				){
					...
					this.type==209||this.type==216||this.type==220||this.type==221||this.type==243||
					this.type==245||this.type==246||this.type==247||this.type==250
				){
					this.stop=false
			...
			case 7: case 23: case 40: case 46: case 76: case 77:
				...
				this.time=5
			break
			case 15: case 74: case 75: case 222:
			...
			case 80: case 85: case 215:
				...
				this.time=time
			break
			case 89: case 103: case 193: case 194: case 195:
				this.speed=0
				this.time=time
				this.width*=60
				this.height*=60
				this.shocks=[]
			break
			case 91: case 92: case 93: case 96: case 108: case 208: case 237: case 238: case 239:
			...
			break
			case 125: case 126: case 127: case 130: case 154: case 185: case 236:
				this.speed=2
				this.time=time
				this.width*=8
				this.height*=8
			...
			case 167:
				...
				this.time=time
			break
			case 173: case 196: case 197: case 199: case 234:
				this.speed=3
				this.time=time
				this.width*=4
				this.height*=4
				...
				if(lsin(this.direction)>0){
					...
					for(let a=0,la=entities.walls.length;a<la;a++){
						for(let b=0,lb=entities.walls[a].length;b<lb;b++){
							...
							if(c.standard&&c.position.x-c.width/2>this.position.x&&this.position.y>c.position.y-c.height/2&&this.position.y<c.position.y+c.height/2&&c.type!=17&&c.type!=18&&c.type!=20&&c.type!=21){
								this.extent=min(c.position.x-c.width/2-this.position.x,this.extent)
							}
						}
					}
					for(let b=0,lb=entities.players.length;b<lb;b++){
						let c=entities.players[b]
						if(
							((this.id==0?1:0)!=(c.id==0?1:0)||this.id==-1||game.pvp&&this.id!=c.id)&&
							this.position.y>c.position.y-c.height/2&&this.position.y<c.position.y+c.height/2&&
							c.position.x>this.position.x&&c.position.x-c.width/2<this.position.x+this.extent
						){
							this.extent=min(c.position.x-c.width/2-this.position.x,this.extent)
						}
					}
					for(let b=0,lb=entities.players.length;b<lb;b++){
						...
						if(
							((this.id==0?1:0)!=(c.id==0?1:0)||this.id==-1||game.pvp&&this.id!=c.id)&&
							this.position.y>c.position.y-c.height/2&&this.position.y<c.position.y+c.height/2&&
							c.position.x-c.width/2-this.position.x==this.extent
						){
					...
					for(let a=0,la=entities.walls.length;a<la;a++){
						for(let b=0,lb=entities.walls[a].length;b<lb;b++){
							let c=entities.walls[a][b]
							if(c.standard&&c.position.x+c.width/2<this.position.x&&this.position.y>c.position.y-c.height/2&&this.position.y<c.position.y+c.height/2&&c.type!=17&&c.type!=18&&c.type!=20&&c.type!=21){
								this.extent=max(c.position.x+c.width/2-this.position.x,this.extent)
							}
						}
					}
					for(let b=0,lb=entities.players.length;b<lb;b++){
    ...
    display(layer,offsetX=0,offsetY=0){
        ...
        switch(this.type){
			...
			case 191:
				...
				layer.strokeWeight(2)
				layer.line(0,0,this.extent,0)
				layer.stroke(120-this.crit*120,this.crit*200,this.crit*220,this.fade)
				layer.strokeWeight(1)
				layer.line(0,0,this.extent,0)
			break
			case 192:
			...
			case 223:
				...
				regStar(layer,0,0,6,20*(1-this.time/this.base.time),20*(1-this.time/this.base.time),this.spin)
			break
			case 224:
				layer.rotate(-this.direction)
				layer.fill(240-this.crit*200,240,40+this.crit*200,this.fade)
		...
		switch(this.type){
			case 2: case 26: case 31: case 32: case 41: case 48: case 80:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					...
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<120&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 3:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<240&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 27:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<240&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)&&!(this.id==-1&&entities.players[b].id>0)){
						entities.players[b].takeDamage(this.damage*(1-c/240)*0.8*constrain(1.2-this.timer/this.base.time*6,0.2,1))
						entities.players[b].die.killer=this.index
						entities.players[b].collect.time=450
						if(game.invis){
			...
			break
			case 30: case 166: case 211: case 228:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<100&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 55:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<180&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 65:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<200&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)&&!(this.id==-1&&entities.players[b].id>0)){
			...
			case 83:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<200&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 86: case 229:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<90&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 110:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<75&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
			...
			case 113: case 235:
				for(let b=0,lb=entities.players.length;b<lb;b++){
					let c=dist(this.position.x,this.position.y,entities.players[b].position.x,entities.players[b].position.y)
					if(entities.players[b].explodable()&&entities.players[b].life>0&&c<150&&((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp)){
    ...
    update(){
		...
		}else if(this.type==190||this.type===191||this.type===214){
			if(!this.active){
				this.fade=0
			}
		}else{
		...
		switch(this.type){
			...
			case 240: case 243: case 244: case 245: case 246: case 247: case 248: case 250:
				this.past.splice(0,1)
				this.past.push([this.position.x,this.position.y])
				if(this.type==60){
					this.velocity.y*=0.97
				}else if(this.type!=68&&this.type!=135&&this.type!=136&&this.type!=240){
        ...
        for(let a=0,la=(this.type==125||this.type==126||this.type==127||this.type==130||this.type==173||this.type==174||this.type==185||this.type==192||this.type==196||this.type==197||this.type==198||this.type==199||this.type==234||this.type==236)?2:(this.type==4||this.type==14||this.type==39||this.type==50||this.type==57||this.type==88||this.type==94||this.type==167||this.type==175||this.type==186||this.type==203)?6:4;a<la;a++){
			switch(this.type){
				...
				case 217: case 218: case 219: case 222: case 223: case 225: case 231: case 232: case 249:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
				break
				case 3: case 153:
				...
				case 135: case 136: case 147: case 166: case 169: case 170: case 176: case 226: case 235: case 240:
					...
					if(this.type!=68&&this.type!=135&&this.type!=136&&this.type!=169&&this.type!=170&&this.type!=240){
						this.velocity.y+=0.1
					}
				...
				case 8: case 107: case 244:
					...
					this.position.y+=this.velocity.y/4
					this.velocity.y+=0.1
					if(this.timer%(this.type==244?10:this.type==107?20:15)==0&&this.active&&a==0){
						let minimum=300
						for(let a=0,la=entities.players.length;a<la;a++){
				...
				break
				case 91: case 92: case 93: case 108: case 204: case 208: case 237: case 238: case 239:
					this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					this.velocity.x=this.speed*lsin(this.direction)
				    this.velocity.y=-this.speed*lcos(this.direction)
				...
				case 158: case 159: case 160: case 161: case 162: case 164: case 165: case 233: case 248:
					if(a==1){
				...
				case 209: case 216: case 220: case 221: case 243: case 250:
					if(!this.stop){
						if(a==2){
							this.midpoint.position.x=this.position.x
							this.midpoint.position.y=this.position.y
				...
				case 168: case 171: case 184: case 200: case 211:
					if(a==1){
						if(this.aggro){
							...
							if(this.time%5==0&&this.type!=184&&this.type!=200){
							...
							if(this.goal>=0){
								...
								this.velocity.x+=lsin(dir)*(this.type==119||this.type==121||this.type==132||this.type==200?1:0.6)
								this.velocity.y+=lcos(dir)*(this.type==119||this.type==121||this.type==132||this.type==200?1:0.6)
							}
				...
				break
				case 120: case 177: case 178: case 179: case 180: case 182: case 183: case 210: case 227:
					if(a==2){
						this.midpoint.position.x=this.position.x
						this.midpoint.position.y=this.position.y
					}
				...
				break
				case 133: case 148: case 149: case 230: case 242:
				    this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					if(a==0){
				...
				case 173:
					this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					if(this.time%30==0&&a==0&&this.active){
				...
				case 196:
					...
					if(this.time%30==0&&a==0&&this.active){
						entities.projectiles.push(new projectile(this.layer,this.position.x,this.position.y,1,this.direction,this.id,this.base.damage/2,15,this.crit,this.index))
					}else if(this.time%30==15&&a==0&&this.active){
						let minimum=300
						for(let a=0,la=entities.players.length;a<la;a++){
							if(entities.players[a].life>0&&((this.id==0?1:0)!=(entities.players[a].id==0?1:0)||this.id==-1||game.pvp&&this.id!=entities.players[a].id)){
								minimum=min(minimum,dist(this.position.x,this.position.y,entities.players[a].position.x,entities.players[a].position.y))
				...
				case 198:
					this.position.x+=this.speed*lsin(this.direction)
				    this.position.y-=this.speed*lcos(this.direction)
					if(this.time%40==0&&a==0&&this.active){
						entities.projectiles.push(new projectile(this.layer,this.position.x,this.position.y,1,this.direction,this.id,this.base.damage/2,15,this.crit,this.index))
					}
				break
				case 199:
			...
			if(this.active&&this.type!=85&&this.type!=190&&this.type!=191){
				for(let b=0,lb=entities.players.length;b<lb;b++){
				    if(inBoxBox(this,entities.players[b])&&(((this.id==0?1:0)!=(entities.players[b].id==0?1:0)||this.id==-1||game.pvp&&this.id!=entities.players[b].id)||(this.type==9||this.type==10||this.type==11||this.type==38||this.type==63||this.type==72||this.type==82||this.type==155||this.type==194||this.type==216&&entities.players[b].life<entities.players[b].base.life*2)&&!entities.players[b].playerData.name.includes('Medic'))&&
						...
						!((this.type==91||this.type==92||this.type==93||this.type==96||this.type==108||this.type==192||this.type==203||this.type==204||this.type==207||this.type==208||this.type==237||this.type==238||this.type==239)&&this.hit.includes(entities.players[b].index))&&
						!(this.type==98&&this.timer<15)&&
						!(this.type==100&&this.timer<3)&&
						!((this.type==113||this.type==114||this.type==115||this.type==116||this.type==117||this.type==146||this.type==181||this.type==201||this.type==209||this.type==216||this.type==220||this.type==243||this.type==245||this.type==246||this.type==247)&&this.timer<150)&&
						this.type!=156&&this.type!=205&&this.type!=206&&this.type!=221&&this.type!=228&&this.type!=250
					){
						if(
							...
							this.type==237||this.type==238||this.type==239
						){
							...
							this.type!=193&&this.type!=194&&this.type!=195&&this.type!=215
						){
				        	this.active=false
						}
						...
						if((this.type==9||this.type==155||this.type==216)&&(this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp){
						...
						}else if(this.type==194&&(this.id==0?1:0)==(entities.players[b].id==0?1:0)&&!game.pvp){
							entities.players[b].life=min(entities.players[b].life+this.damage*(min(4,entities.players[b].base.life/100))*0.2,entities.players[b].base.life*2)
							...
							entities.players[b].gasTime=max(1800,entities.players[b].gasTime+900)
							entities.players[b].gasser=this.index
						}else{
				        	entities.players[b].takeDamage(this.damage)
						}
						if(entities.players[b].weaponType!=370&&entities.players[b].weaponType!=381&&entities.players[b].weaponType!=432&&entities.players[b].weaponType!=434){
							if(this.type==12){
							...
							}else if(this.type==102||this.type==115||this.type==151||this.type==167||this.type==175||this.type==189||this.type==193||this.type==202||this.type==220){
								if(entities.players[b].chillTime==0){
									entities.players[b].color.skin.head=[200,250,250]
									entities.players[b].color.skin.body=[190,240,240]
									entities.players[b].color.skin.legs=[175,225,225]
