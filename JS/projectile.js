class projectile{
    constructor(layer,x,y,type,direction,id,damage,time,crit,index){
		...
		this.exploder=this.type==2||this.type==16||this.type==21||this.type==22||this.type==26||
			...
			this.type==98||this.type==101||this.type==104
		switch(this.type){
			...
			case 94: case 99: case 100: case 105:
			...
			case 69: case 70: case 73: case 83: case 95: case 97: case 98: case 102: case 104:
    ...
    update(){
		...
		if(
			...
			this.type==100||this.type==102||this.type==105
		){
			...
			this.type==88||this.type==98||this.type==101||this.type==104
		){
        ...
        for(let a=0,la=(this.type==4||this.type==14||this.type==39||this.type==50||this.type==57||this.type==88||this.type==94)?6:4;a<la;a++){
			switch(this.type){
				...
				case 65: case 68: case 73: case 83: case 97: case 98: case 102: case 104:
					if(a==2){
