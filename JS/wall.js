    ...
    update(){
        ...
        switch(this.type){
            ...
            case 6:
                ...
                if(this.position.x>game.edge[1]+50){
                    this.remove=true
                }
            break
                ...
                for(let b=0,lb=this.collide[a].length;b<lb;b++){
                    ...
                    if(a==0&&this.type!=5&&this.type!=8&&this.type!=9&&this.type!=10&&this.type!=11&&this.type!=12&&this.type!=14&&this.type!=16&&(
                        ...
                        switch(this.type){
                            ...
                            break
                            case 16:
                                if(!game.weapon[c.id-1].includes(this.weapon)&&(game.weapon[c.id-1].length<3||game.level==14&&game.weapon[c.id-1].length<4)){
